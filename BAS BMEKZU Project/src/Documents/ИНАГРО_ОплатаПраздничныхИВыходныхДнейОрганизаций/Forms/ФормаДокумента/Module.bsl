...
Функция ЗаполнитьРаботавшими() 
	...
	|		ПО (ВЫБОР
	|				КОГДА СотрудникиПоПраздникам.ГрафикРаботы.УчетНормыВремениПоОтдельномуГрафику
	|					ТОГДА ОбщиеГрафикиРаботыСумма.ГрафикРаботы = СотрудникиПоПраздникам.ГрафикРаботы.ГрафикРаботыНормыВремени
	|				ИНАЧЕ ОбщиеГрафикиРаботыСумма.ГрафикРаботы = СотрудникиПоПраздникам.ГрафикРаботы
	|			КОНЕЦ)
