...
Процедура ТранспортноеСредствоПриИзменении(Элемент)
	...
	Для каждого СтрокаТабличнойЧасти Из Объект.Товары Цикл
		...
		ОбновитьВОсновномТопливе(Объект.ТранспортноеСредство, ДанныеСтрокиТаблицы); 
...
Процедура ТоварыНоменклатураПриИзменении(Элемент)
	...
	ДанныеСтрокиТаблицы = Новый Структура(
	"Номенклатура, Количество, ЕдиницаИзмерения,
	|КоличествоВОсновномТопливе, КоэффициентВОсновноеТопливо,
...
Процедура ТоварыНоменклатураПриИзмененииНаСервере(СтрокаТабличнойЧасти, Знач ДанныеОбъекта)
	...
	Документы.ИНАГРО_СливТоплива.ЗаполнитьСчетаУчетаВСтрокеТабличнойЧасти(
...
Процедура ПодготовитьФормуНаСервере()
	...
	Объект.СкладОтправитель = Константы.ИНАГРО_СкладУчетаТопливаВБаках.Получить();
