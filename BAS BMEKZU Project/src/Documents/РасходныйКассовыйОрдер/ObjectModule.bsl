...
//КонецПроцедуры	
	...
	Процедура ДвиженияПоРегистрам(РежимПроведения, Отказ, Заголовок, СтруктураШапкиДокумента)
		...
		ИначеЕсли     ВидОперации = Перечисления.ВидыОперацийРКО.ИНАГРО_ВыплатаПаевПоВедомостям 
			...
			ИначеЕсли  ВидОперации = Перечисления.ВидыОперацийРКО.ИНАГРО_ВыплатаПаяПайщику 
						И ТипЗнч(ИНАГРО_ВедомостьВыплатПайщикам) = Тип("ДокументСсылка.ИНАГРО_ВедомостьВыплатПайщикам") Тогда 			
			...
			ИначеЕсли ВидОперации = Перечисления.ВидыОперацийРКО.ИНАГРО_ВыплатаПаяПайщику И ТипЗнч(ИНАГРО_ВедомостьВыплатПайщикам) = Тип("ДокументСсылка.ИНАГРО_НачислениеДругихВыплат") Тогда 			
				...
				|ГДЕ
				|	НачислениеДругихВыплатТЧ.Ссылка = &Ссылка
				|	И НачислениеДругихВыплатТЧ.Контрагент = &Контрагент
				|	И НачислениеДругихВыплатТЧ.ДоговорКонтрагента = &ДоговорКонтрагента
				|
				|СГРУППИРОВАТЬ ПО
			...
			Иначе	
				...
				Если НЕ (ВидОперации = Перечисления.ВидыОперацийРКО.ИНАГРО_ДругиеВыплаты 
					ИЛИ ВидОперации = Перечисления.ВидыОперацийРКО.ИНАГРО_ВыплатаПаяПайщику И ТипЗнч(ИНАГРО_ВедомостьВыплатПайщикам) = Тип("ДокументСсылка.ИНАГРО_НачислениеДругихВыплат")) Тогда 			
