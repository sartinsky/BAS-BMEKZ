...
Процедура ДобавитьКомандыПечати(КомандыПечати) Экспорт
	...
	КомандаПечати.ЗаголовокФормы= НСтр("ru='Реестр документов ""Складская квитанция (простая)""';uk='Реєстр документів ""Складська квитанція (проста)""'");
...
Процедура Печать(МассивОбъектов, ПараметрыПечати, КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода) Экспорт
	...
	Если УправлениеПечатью.НужноПечататьМакет(КоллекцияПечатныхФорм, "ПФ_XML_Бланк") Тогда
		...
		ПечатьБланка(МассивОбъектов, ОбъектыПечати, ПараметрыВывода), , "Документ.ИНАГРО_СкладскаяКвитанцияПростая.ПФ_XML_Бланк", ,Истина);
...
Функция ПечатьБланка(МассивОбъектов, ПараметрыПечати, ПараметрыВывода)
	...
	Для каждого Ссылка Из МассивОбъектов Цикл
		...
		ТабДокумент.ИмяПараметровПечати = "ИНАГРО_СкладскаяКвитанцияПростая_Бланк";
