...
&НаКлиенте
Процедура ОтборТипЖурналаИспользованиеПриИзменении(Элемент)
	
	ОтборыСписковКлиентСервер.УстановитьБыстрыйОтбор(ЭтотОбъект, "ТипЖурнала");

КонецПроцедуры

&НаКлиенте
Процедура ОтборТипЖурналаПриИзменении(Элемент)
	
	ОтборТипЖурналаИспользование = ЗначениеЗаполнено(ОтборТипЖурнала);
...
Процедура Создать(Команда)
	...
	ОткрытьФорму("Документ.ИНАГРО_ЛабораторныйАнализ.ФормаОбъекта", СтруктураПараметров, ЭтаФорма);
...
Функция ПолучитьСтруктуруПараметровФормы()
	...
	Если ТекущиеДанные <> Неопределено Тогда
		ЗначенияЗаполнения.Вставить("ТипЖурнала", ТекущиеДанные.ТипЖурнала); 	
	Иначе		
		Если ОтборТипЖурналаИспользование И ЗначениеЗаполнено(ОтборТипЖурнала) Тогда
			ЗначенияЗаполнения.Вставить("ТипЖурнала", ОтборТипЖурнала);
		КонецЕсли;		
	КонецЕсли;
