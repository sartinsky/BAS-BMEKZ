...
Процедура ДобавитьКомандыПечати(КомандыПечати) Экспорт
	...
	КомандаПечати.Представление = НСтр("ru='Анализ муки и манной крупы (Форма 45)';uk='Аналіз борошна та манних круп (Форма 45)'");
   	КомандаПечати.Обработчик    = "УправлениеПечатьюБПКлиент.ВыполнитьКомандуПечати";
    КомандаПечати.СписокФорм    = "ФормаСписка,ФормаВыбора,ФормаДокумента";
	...
	КомандаПечати.Представление = НСтр("ru='Анализ муки и манной крупы (Форма 45) (2021)';uk='Аналіз борошна та манних круп (Форма 45) (2021)'");
   	КомандаПечати.Обработчик    = "УправлениеПечатьюБПКлиент.ВыполнитьКомандуПечати";
    КомандаПечати.СписокФорм    = "ФормаСписка,ФормаВыбора,ФормаДокумента";
...
Процедура Печать(МассивОбъектов, ПараметрыПечати, КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода) Экспорт
    ...
    ИначеЕсли УправлениеПечатью.НужноПечататьМакет(КоллекцияПечатныхФорм, "АнализМукиИМаннойКрупы") Тогда
        ...
        УправлениеПечатью.ВывестиТабличныйДокументВКоллекцию(КоллекцияПечатныхФорм, "АнализМукиИМаннойКрупы", НСтр("ru='Анализ муки и манной крупы';uk='Аналіз муки та манних круп'"), 
	...
	ИначеЕсли УправлениеПечатью.НужноПечататьМакет(КоллекцияПечатныхФорм, "АнализМукиИМаннойКрупы2021") Тогда
        ...
        УправлениеПечатью.ВывестиТабличныйДокументВКоллекцию(КоллекцияПечатныхФорм, "АнализМукиИМаннойКрупы2021", НСтр("ru='Анализ муки и манной крупы (2021)';uk='Аналіз муки та манних круп (2021)'"), 
