...
Процедура СписокПередНачаломИзменения(Элемент, Отказ)
	...
	КлючеваяОперация = "ОткрытиеФормыСМС_ДисконтированиеФинансовойПомощи";
...
&НаКлиенте
Процедура СоздатьДисконтированиеВыдачаПомощи(Команда)

	СтруктураПараметров = ПолучитьСтруктуруПараметровФормы(
		ПредопределенноеЗначение("Перечисление.СМС_ВидыОперацииДокументаДисконтирования.Выдача"));
	ОткрытьФорму("Документ.СМС_ДисконтированиеФинансовойПомощи.ФормаОбъекта", СтруктураПараметров, ЭтаФорма);

КонецПроцедуры

&НаКлиенте
Процедура СоздатьДисконтированиеПолучениеПомощи(Команда)
	
	СтруктураПараметров = ПолучитьСтруктуруПараметровФормы(
		ПредопределенноеЗначение("Перечисление.СМС_ВидыОперацииДокументаДисконтирования.Получение"));
	ОткрытьФорму("Документ.СМС_ДисконтированиеФинансовойПомощи.ФормаОбъекта", СтруктураПараметров, ЭтаФорма);
...
Процедура ИзменитьВидОперации(Команда)
	...
	ОткрытьФорму("Документ.СМС_ДисконтированиеФинансовойПомощи.Форма.ФормаДокумента", ПараметрыФормы, ЭтаФорма);
