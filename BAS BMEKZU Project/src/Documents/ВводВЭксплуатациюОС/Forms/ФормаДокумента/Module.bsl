...
Процедура ОбновитьПоДокументуБАСервер(ИНАГРО_ДокументОперативногоУчета)
	...
	Если НайденнаяСтрока <> Неопределено Тогда
		...
		Если ТипЗнч(Объект.ИНАГРО_ДокументОперативногоУчета) = Тип("ДокументСсылка.ИНАГРО_ПеремещениеБиологическихАктивов") Тогда		
			Объект.Склад 							= НайденнаяСтрока.Склад;
			Объект.ИНАГРО_СкладНовый 				= НайденнаяСтрока.СкладНовый;
			Объект.ИНАГРО_БиологическийАктивНовый 	= НайденнаяСтрока.НоменклатураНовая;
			Объект.СтоимостьБУ 						= НайденнаяСтрока.Сумма;
		ИначеЕсли ТипЗнч(Объект.ИНАГРО_ДокументОперативногоУчета) = Тип("ДокументСсылка.ИНАГРО_ОприходованиеБиологическихАктивов") Тогда	 		
			Объект.Склад = ОбъектБА.Склад;
		КонецЕсли;
	КонецЕсли;
