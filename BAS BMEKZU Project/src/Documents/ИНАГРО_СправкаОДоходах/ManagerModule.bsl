...
Процедура Печать(МассивОбъектов, ПараметрыПечати, КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода) Экспорт
	...
	ИначеЕсли МассивОбъектов[0].ВидСправки = Перечисления.ВидыСправокОДоходах.Соцстрах2023 Тогда
		...
		Если УправлениеПечатью.НужноПечататьМакет(КоллекцияПечатныхФорм, "МакетСоцстрах2023") Тогда
			УправлениеПечатью.ВывестиТабличныйДокументВКоллекцию(КоллекцияПечатныхФорм, "МакетСоцстрах2023", НСтр("ru='Справка о доходах';uk='Довідка про доходи'"),
			ПечатьСоцстрах2023(МассивОбъектов, ОбъектыПечати, ПараметрыВывода),,"Документ.ИНАГРО_СправкаОДоходах.ПФ_MXL_МакетСоцстрах2023",,Истина);
		КонецЕсли;	
	...
	Для Каждого Ссылка Из МассивОбъектов Цикл
		...
		НаимОрганизации = Ссылка.Организация.НаименованиеПолное;
			Если Ссылка.Сотрудник.ИНАГРО_ДоговорПодряда Тогда
				ТекстРаботает = НСтр("ru='работал';uk='працював'",КодЯзыкаПечать)+ОкончаниеРаботал+" в  "+ НаимОрганизации +
...
Функция ПечатьСоцСтрах2023(МассивОбъектов, ОбъектыПечати, ПараметрыВывода)
	...
	ТабДокумент = Новый ТабличныйДокумент;
	ТабДокумент.ИмяПараметровПечати = "ПАРАМЕТРЫ_ПЕЧАТИ_СПРАВКА_О_ДОХОДАХ_СОЦСТРАХ_2023";
	...
	Для Каждого Ссылка Из МассивОбъектов Цикл
		...
		// запоминаем области макета
		Макет = УправлениеПечатью.МакетПечатнойФормы("Документ.ИНАГРО_СправкаОДоходах.ПФ_MXL_МакетСоцстрах2023");
