...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, СтандартнаяОбработка)
	...
	Если НЕ ЗначениеЗаполнено(ДатаВыдачи) Тогда
		ПечатьДоВостребования = ХранилищеОбщихНастроек.Загрузить("ИНАГРО_СкладскаяКвитанцияДвойная_ПечатьДоВостребования", "Элеватор");
	КонецЕсли;
	
	ПечатьВесаКВыдаче = ХранилищеОбщихНастроек.Загрузить("ИНАГРО_СкладскаяКвитанцияДвойная_ПечатьВесаКВыдаче", "Элеватор");	
...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	ХранилищеОбщихНастроек.Сохранить("ИНАГРО_СкладскаяКвитанцияДвойная_ПечатьДоВостребования", "Элеватор", ПечатьДоВостребования);
	ХранилищеОбщихНастроек.Сохранить("ИНАГРО_СкладскаяКвитанцияДвойная_ПечатьВесаКВыдаче", "Элеватор", ПечатьВесаКВыдаче);
...
Функция СформироватьТаблицуУслуг()
	...
	Номенклатура_СкладскаяКвитанцияДвойная = ИНАГРО_Элеватор.ПолучитьПредопределеннуюНоменклатуру("СкладскаяКвитанцияДвойная");
	...
	ТекущаяЦена                            = ИНАГРО_Элеватор.ПолучитьЦенуУслугиЭлеватора(Организация, Дата, Владелец, ДоговорКонтрагента, ВидКультурыДляРасчетаСтоимостиУслуги, Урожай,	Номенклатура_СкладскаяКвитанцияДвойная);
	...
	Если ТекущаяЦена <> 0 И НЕ СобственноеПодразделение Тогда 													 
		...
		НоваяСтрока.Номенклатура       = Номенклатура_СкладскаяКвитанцияДвойная;
