...
Процедура УправлениеПоследовательностьюВводаВеса()	
	...
	Если НЕ ЗначениеЗаполнено(Объект.Ссылка) Тогда
		...
		Если КонтролироватьПоследовательностьВводаВеса Тогда
			...
			ДоступностьКнопкиF5          = (Объект.ВесБруттоВывоз = 0  И Объект.ВесБрутто1Вывоз = 0 И Объект.ВесТарыВывоз <> 0)
			                           ИЛИ (Объект.ВесБруттоВывоз = 0  И Объект.ВесБрутто1Вывоз = 0 И Объект.ВесТарыВывоз <> 0    И Объект.ВесТары1Вывоз <> 0);
			ДоступностьКнопкиF6          =  Объект.ВесБруттоВывоз = 0  И Объект.ВесБрутто1Вывоз = 0 И Объект.ВесТары1Вывоз = 0;
			ДоступностьКнопкиF7          =  Объект.ВесБруттоВывоз <> 0 И Объект.ВесТарыВывоз <> 0   И Объект.ВесТары1Вывоз <> 0;
			ДоступностьКнопкиF8          =  Объект.ВесБруттоВывоз = 0  И Объект.ВесБрутто1Вывоз = 0 И Объект.ВесТарыВывоз <> 0;
			...
			ДоступностьКнопкиF9          =  Объект.ВесБрутто1 = 0 И Объект.ВесТары = 0  И Объект.ВесТары1 = 0;
			...
			ДоступностьКнопкиF11         =  Объект.ВесБрутто <> 0 И Объект.ВесТары = 0  И Объект.ВесТары1 = 0;
			...
			НедоступностьВсехКнопокВвоз  = (Объект.ВесБрутто <> 0 И Объект.ВесТары <> 0 И Объект.ВесБрутто1 <> 0 И Объект.ВесТары1 <> 0)
			                           ИЛИ (Объект.ВесБрутто <> 0 И Объект.ВесТары <> 0 И Объект.ВесТары1Вывоз = 0);
