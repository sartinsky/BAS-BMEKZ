...
Функция ПечатьУдостоверение(МассивОбъектов, ОбъектыПечати)
	...
	Для Каждого Ссылка Из МассивОбъектов Цикл
		...
		Пока Выборка.Следующий() Цикл
			...
			ОбластьПечати.Параметры.ФИОРуководителя = ФизическиеЛицаКлиентСервер.ИмяФамилияВФорматеДСТУ(ОбщегоНазначенияБПВызовСервера.ДанныеФизЛица(Выборка.Организация,ОтветственныеЛица.Руководитель,Выборка.ДатаДок));
