...
Процедура СформироватьДанныеЭлектронногоДокументаПоДокументу1С_НаСервере(ПредставлениеЭлектронногоДокументаXML, ПредставлениеЭлектронногоДокументаPDF)
	...
	Иначе
		...
		ПредставлениеЭлектронногоДокументаPDF = "";
		СообщениеОбОшибке = "";
		//Если Документы.скEDI_ЗапросНаПолучениеВедомостейЕРНН.СформироватьЭлектронныйДокумент(Объект.Ссылка, Истина, ПредставлениеЭлектронногоДокументаXML, ПредставлениеЭлектронногоДокументаPDF, ИмяФайла) Тогда
		Если Документы.скEDI_ЗапросНаПолучениеВедомостейЕРНН.СформироватьЭлектронныйДокумент(Объект, Истина, ПредставлениеЭлектронногоДокументаXML, ПредставлениеЭлектронногоДокументаPDF, ИмяФайла, СообщениеОбОшибке) Тогда
			мПредставлениеЭлектронногоДокументаPDF = ПредставлениеЭлектронногоДокументаPDF;
			мПредставлениеЭлектронногоДокументаXML = ПредставлениеЭлектронногоДокументаXML;
...
Функция ПолучитьСписокПодписантовДляЭлектронногоДокументаНаСервере(ВыполняемыеОперации, ОшибкаПолученияПодписей)
	Возврат Документы.скEDI_ЗапросНаПолучениеВедомостейЕРНН.ПолучитьСписокПодписантовДляЭлектронногоДокумента(ВыполняемыеОперации, Объект.Ссылка, ОшибкаПолученияПодписей);
КонецФункции
...
Функция ОбработатьЭлектронныйДокументНаСервере(ВыполняемыеОперации, ТаблицаНеобходимыхПодписей, ТаблицаНеобходимыхПодписейШифрования)
	...
	//Возврат Документы.скEDI_ЗапросНаПолучениеВедомостейЕРНН.ОбработатьЭлектронныйДокумент_Ссылка(Объект.Ссылка, ВыполняемыеОперации, ТаблицаНеобходимыхПодписей, ТаблицаНеобходимыхПодписейШифрования);
	Возврат Документы.скEDI_ЗапросНаПолучениеВедомостейЕРНН.ОбработатьЭлектронныйДокумент_Ссылка(Объект.Ссылка, ВыполняемыеОперации, ТаблицаНастроекПодписей, ТаблицаНастроекПодписейШифрования);
КонецФункции
...
Процедура ИнициализироватьПодписьИОтправкуЭлектронныхДокументовВДФС(Отправлять)
	...
	//Подписанты = Документы.скEDI_ЗапросНаПолучениеВедомостейЕРНН.ПолучитьСписокПодписантовДляЭлектронногоДокумента(ВыполняемыеОперации, Объект.Ссылка, ОшибкаПолученияПодписей);
...
Процедура ВыполнитьОперацииСЭлектроннымДокументом(ПараметрыОпераций, ДополнительныеПараметрыОпераций = Неопределено) Экспорт
	Если ПараметрыОпераций <> Неопределено Тогда
		Если ПараметрыОпераций.ВерсияМассиваДанныхПоДокументам = ВерсияМассиваДанныхПоДокументам Тогда
			//Результат = Документы.скEDI_ЗапросНаПолучениеВедомостейЕРНН.ОбработатьЭлектронныйДокумент_Ссылка(Объект.Ссылка, ПараметрыОпераций.ВыполняемыеОперации, ПараметрыОпераций.ТаблицаНеобходимыхПодписей, ПараметрыОпераций.ТаблицаНеобходимыхПодписейШифрования);
