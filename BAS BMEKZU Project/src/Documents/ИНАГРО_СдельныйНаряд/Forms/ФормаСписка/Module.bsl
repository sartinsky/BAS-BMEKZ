...
&НаКлиенте
Процедура СоздатьСдельныйНарядСписком(Команда)
	
	СтруктураПараметров = ПолучитьСтруктуруПараметровФормы(
		ПредопределенноеЗначение("Перечисление.ИНАГРО_ВидыОперацийСдельныйНаряд.СдельныйНарядСписком"));
	ОткрытьФорму("Документ.ИНАГРО_СдельныйНаряд.ФормаОбъекта", СтруктураПараметров, ЭтаФорма);
...
Процедура СоздатьСдельныйНаряд(Команда)
	...
	СтруктураПараметров = ПолучитьСтруктуруПараметровФормы(
		ПредопределенноеЗначение("Перечисление.ИНАГРО_ВидыОперацийСдельныйНаряд.СдельныйНаряд"));
	ОткрытьФорму("Документ.ИНАГРО_СдельныйНаряд.ФормаОбъекта", СтруктураПараметров, ЭтаФорма);

КонецПроцедуры

&НаКлиенте
Процедура СоздатьСдельныйНарядНаПолевыеРаботы(Команда)
	
	СтруктураПараметров = ПолучитьСтруктуруПараметровФормы(
		ПредопределенноеЗначение("Перечисление.ИНАГРО_ВидыОперацийСдельныйНаряд.СдельныйНарядНаПолевыеРаботы"));
	ОткрытьФорму("Документ.ИНАГРО_СдельныйНаряд.ФормаОбъекта", СтруктураПараметров, ЭтаФорма);

КонецПроцедуры

&НаКлиенте
Процедура СоздатьСдельныйНарядНаПолевыеРаботыБригады(Команда)
	
	СтруктураПараметров = ПолучитьСтруктуруПараметровФормы(
		ПредопределенноеЗначение("Перечисление.ИНАГРО_ВидыОперацийСдельныйНаряд.СдельныйНарядНаПолевыеРаботыБригады"));
	ОткрытьФорму("Документ.ИНАГРО_СдельныйНаряд.ФормаОбъекта", СтруктураПараметров, ЭтаФорма);
