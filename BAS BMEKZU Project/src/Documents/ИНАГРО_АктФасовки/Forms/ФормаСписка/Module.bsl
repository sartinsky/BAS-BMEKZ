...
Процедура ИзменитьВидОперации(Команда)
	...
	ОткрытьФорму("Документ.ИНАГРО_АктФасовки.Форма.ФормаДокумента", ПараметрыФормы, ЭтаФорма);
...
Процедура СоздатьДавальческоеСырье(Команда)
	...
	ОткрытьФорму("Документ.ИНАГРО_АктФасовки.ФормаОбъекта", СтруктураПараметров, ЭтаФорма);
