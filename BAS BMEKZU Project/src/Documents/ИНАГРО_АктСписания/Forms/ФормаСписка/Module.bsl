...
Процедура ИзменитьВидОперации(Команда)
	...
	ОткрытьФорму("Документ.ИНАГРО_АктСписания.Форма.ФормаДокумента", ПараметрыФормы, ЭтаФорма);
...
Процедура СоздатьДавальческоеСырье(Команда)
	...
	ОткрытьФорму("Документ.ИНАГРО_АктСписания.ФормаОбъекта", СтруктураПараметров, ЭтаФорма);
