...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ОбщегоНазначения.РазделениеВключено() И ИспользуетсяВерсионирование Тогда
		...
		Элементы.КоллизииАвторДругойВерсии.Заголовок = НСтр("ru='Версия получена из приложения';uk='Версія отримана з прикладної програми'");
...
Функция КоличествоНезаполненныхРеквизитов()
	...
	Возврат РегистрыСведений.РезультатыОбменаДанными.КоличествоПроблем(УзлыОбмена, ПараметрыПоиска);
...
Процедура ОбновитьОтборПоПричине(Обновлять = Истина)
	...
	ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбораДинамическогоСписка(
		НепроведенныеДокументы, "Причина", СтрокаПоиска,ВидСравненияКомпоновкиДанных.НачинаетсяС,, СтрокаПоискаЗадана);
	
	ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбораДинамическогоСписка(
		НезаполненныеРеквизиты, "Причина", СтрокаПоиска,ВидСравненияКомпоновкиДанных.НачинаетсяС,, СтрокаПоискаЗадана);
		
	Если ИспользуетсяВерсионирование Тогда
	
		ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбораДинамическогоСписка(
			НепринятыеПоДате, "ПричинаЗапрета", СтрокаПоиска,ВидСравненияКомпоновкиДанных.НачинаетсяС,, СтрокаПоискаЗадана);
...
Процедура УстановитьУсловноеОформление()
	...
	Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru='Удалена';uk='Вилучена'"));
