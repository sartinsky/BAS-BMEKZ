...
Процедура ПриОткрытии(Отказ)
	...
	ШаблонПользовательскийСайт = НСтр("ru='сайта поддержки пользователей системы';uk='сайта підтримки користувачів системи'");
	...
	Если Не ПустаяСтрока(РасположениеКомплектаПравил.ПутьКФайлуКомплектаПравилВКаталогеШаблонов)
		И ОбщегоНазначенияКлиентСервер.ЭтоWindowsКлиент() Тогда
...
#Если ВебКлиент Тогда
	...
	ВызватьИсключение НСтр("ru='Операция в веб-клиенте не предусмотрена';uk='Операція у веб-клієнті не передбачена'");
