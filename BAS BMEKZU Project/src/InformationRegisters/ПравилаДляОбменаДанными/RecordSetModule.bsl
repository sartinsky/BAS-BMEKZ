...
Процедура ПроверитьСуществованиеФайлаВнешнейОбработки(ИмяПроверяемогоФайла, ЭтоФайловаяБаза, Отказ)
	...
	РасположениеКаталога = ? (ЭтоФайловаяБаза, НСтр("ru='на клиенте';uk='на клієнті'"), НСтр("ru='на сервере';uk='на сервері'"));
	
	Если Не КаталогПроверки.Существует() Тогда
		
		СтрокаСообщения = НСтр("ru='Каталог ""%1"" не найден %2.';uk='Каталог ""%1"" не знайдений %2.'");
	...
	ИначеЕсли Не ФайлНаДиске.Существует() Тогда 
		...
		СтрокаСообщения = НСтр("ru='Файл внешней обработки ""%1"" не найден %2.';uk='Файл зовнішньої обробки ""%1"" не знайдений %2.'");
