...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ОбщегоНазначенияКлиентСервер.ЭтоМобильныйКлиент() Тогда // Временное решение для работы в мобильном клиенте, будет удалено в следующих версиях
		...
		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ВариантВерсионированияГруппа", "Заголовок", НСтр("ru='Сохранять версии';uk='Зберігати версії'"));
...
Процедура ЗаполнитьТипыОбъектовВДеревеЗначений()
	...
	Для Каждого Тип Из МассивТипов Цикл
		...
		ИначеЕсли ПланыСчетов.ТипВсеСсылки().СодержитТип(Тип) Тогда
			...
			ПредставлениеГруппы = НСтр("ru='Планы счетов';uk='Плани рахунків'");
		...
		ИначеЕсли ПланыВидовХарактеристик.ТипВсеСсылки().СодержитТип(Тип) Тогда
			...
			ПредставлениеГруппы = НСтр("ru='Планы видов характеристик';uk='Плани видів характеристик'");
...
Процедура ПриЗавершенииОперацииПоискаУстаревшихВерсий(Результат, ДополнительныеПараметры) Экспорт
	...
	Если Результат.Статус = "Ошибка" Тогда
		ЖурналРегистрацииКлиент.ДобавитьСообщениеДляЖурналаРегистрации(НСтр("ru='Поиск устаревших версий объектов';uk='Пошук застарілих версій об''єктів'",ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
...
Функция ВыполнитьПоискУстаревшихВерсий()
	...
	ПараметрыВыполнения.НаименованиеФоновогоЗадания = НСтр("ru='Поиск устаревших версий объектов';uk='Пошук застарілих версій об''єктів'");
