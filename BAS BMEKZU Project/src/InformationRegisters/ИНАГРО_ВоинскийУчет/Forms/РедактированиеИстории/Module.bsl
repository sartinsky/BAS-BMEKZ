...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Пользователи.РолиДоступны("ИНАГРО_ДобавлениеИзменениеЗарплата") ИЛИ Пользователи.РолиДоступны("ИНАГРО_ДобавлениеИзменениеКадры")  Тогда
...
Процедура КомандаОК(Команда)
	РедактированиеПериодическихСведенийКлиент.ОповеститьОЗавершении(ЭтаФорма, "ИНАГРО_ВоинскийУчет", ОбъектВладелец);
КонецПроцедуры
