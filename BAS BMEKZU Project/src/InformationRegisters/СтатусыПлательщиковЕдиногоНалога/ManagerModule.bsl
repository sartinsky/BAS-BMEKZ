Процедура АктуализироватьДанные(НаборЗаписейУчетнойПолитики) Экспорт
	...
	Пока ВыборкаОрганизация.Следующий() Цикл
		...
		ТекущийСтатусПлательщика = Неопределено;
		ДатаПоследнегоИзменения = Неопределено;
		ТекущаяГруппаЕН = Неопределено;
		...
		Пока Выборка.Следующий() Цикл
			...
			Если ТекущийСтатусПлательщика <> Выборка.ПлательщикЕдиногоНалога ИЛИ ТекущаяГруппаЕН <> Выборка.ГруппаПлательщикаЕдиногоНалога Тогда
				
				ТекущийСтатусПлательщика = Выборка.ПлательщикЕдиногоНалога;
				ТекущаяГруппаЕН = Выборка.ГруппаПлательщикаЕдиногоНалога;
				
				НоваяЗапись = НаборЗаписей.Добавить();
				НоваяЗапись.Период = ДатаВыборки;
				НоваяЗапись.Организация = ВыборкаОрганизация.Организация;
				НоваяЗапись.ПлательщикЕдиногоНалога = ТекущийСтатусПлательщика;
				НоваяЗапись.ГруппаПлательщикаЕдиногоНалога = ТекущаяГруппаЕН;
