...
Функция ТаблицаФормОтчета() Экспорт
	...
	НоваяФорма.ОписаниеОтчета     =  НСтр("ru='Приложение к НП(С)БУ №25 (с изменениями, внесенными приказами Минфином Украины №48 от 08.02.14, №226 от 31.05.19)';uk='Додаток до НП(С)БО №25 (зі змінами, внесеними наказами Мінфіну України №48 від 08.02.14, №226 від 31.05.19)'");
