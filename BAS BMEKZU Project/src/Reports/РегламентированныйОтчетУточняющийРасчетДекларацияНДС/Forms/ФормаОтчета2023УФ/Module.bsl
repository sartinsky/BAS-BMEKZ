...
Процедура УстановитьФлаги()
	...
	Если  НЕ  СтруктураРеквизитовФормы.мЗаполнятьПриложение5 = Истина 
		ИЛИ НЕ СтруктураРеквизитовФормы.ЗаполнятьПриложение5 Тогда
