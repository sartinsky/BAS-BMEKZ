...
Процедура  РассчитатьСуммыРасходовПоСтрахованию()
	...
	ЗапросРасходыПоСтрахованию.УстановитьПараметр("Организация", СтруктураРеквизитовФормы.Организация);
	ЗапросРасходыПоСтрахованию.УстановитьПараметр("Начало", НачалоГода(СтруктураРеквизитовФормы.мДатаНачалаПериодаОтчета));
	ЗапросРасходыПоСтрахованию.УстановитьПараметр("Конец", СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета);
		...
		|	ГДЕ
		|		Начисления.Регистратор ССЫЛКА Документ.ИНАГРО_НачислениеЕдиновременныхПособийЗаСчетФСС
		...
		|		СУММА(Начисления.Результат) КАК Результат,
		|    	СУММА(Начисления.ОплаченоДнейЧасов) КАК КоличествоДней
		|	ИЗ
		|		РегистрРасчета.ИНАГРО_Начисления КАК Начисления
		|	ГДЕ
	...
	СтруктураДанныхУведомление.Вставить("S213", S213);
	СтруктураДанныхУведомление.Вставить("S214", S214);
	СтруктураДанныхУведомление.Вставить("S223", S223);
	СтруктураДанныхУведомление.Вставить("S224", S224);
	СтруктураДанныхУведомление.Вставить("S233", S233);
	СтруктураДанныхУведомление.Вставить("S234", S234);
	СтруктураДанныхУведомление.Вставить("S243", S243);
	СтруктураДанныхУведомление.Вставить("S244", S244);
