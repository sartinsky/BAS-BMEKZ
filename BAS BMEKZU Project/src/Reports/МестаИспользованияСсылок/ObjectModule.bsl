...
Функция ЗаголовокПоНаборуСсылок(Знач НаборСсылок)
	...
	Если ТипЗнч(НаборСсылок) = Тип("СписокЗначений") Тогда
		...
		Если ВсегоСсылок = 1 Тогда
			Возврат СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru='Места использования %1';uk='Місця використання %1'"), ОбщегоНазначения.ПредметСтрокой(НаборСсылок[0].Значение));
		ИначеЕсли ВсегоСсылок > 1 Тогда
			...
			Если ОдинаковыйТип Тогда
				Возврат СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
					НСтр("ru='Места использования элементов ""%1"" (%2)';uk='Місця використання елементів ""%1"" (%2)'"), 
					НаборСсылок[0].Значение.Метаданные().Представление(),
					ВсегоСсылок);
			Иначе		
				Возврат СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
					НСтр("ru='Места использования элементов (%1)';uk='Місця використання елементів (%1)'"), 
					ВсегоСсылок);
			КонецЕсли;
		КонецЕсли;
	...
	Возврат НСтр("ru='Места использования элементов';uk='Місця використання елементів'");
