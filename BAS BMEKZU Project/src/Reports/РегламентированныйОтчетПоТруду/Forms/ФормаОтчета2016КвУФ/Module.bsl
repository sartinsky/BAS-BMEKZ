...
Процедура СформироватьМассивыРазличныхКатегорийРаботников()
	...
	ЗапросПоГПХ.УстановитьПараметр("парамНачало", НачалоГода(СтруктураРеквизитовФормы.мДатаНачалаПериодаОтчета));
...
Процедура РаспределениеРаботниковПоРазмеруЗП()
	...
	Если РегламентированнаяОтчетностьПереопределяемый.ИДКонфигурации() = "УПП" 
		...
		РазмерыТарифныхСтавок = "ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.РазмерТарифныхСтавок.СрезПоследних(&ДатаНач, ) КАК РазмерТарифныхСтавок
...
Процедура РасчетКоличестваИФОПКатегорийРаботников()	
	...
	ТаблЧисленностиССЧЖ = ИНАГРО_ПроведениеРасчетов.ПолучитьСреднююЧисленность(СтруктураРеквизитовФормы.мДатаНачалаПериодаОтчета, СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета, "ССЧ", "КВАРТАЛСНАЧАЛАГОДА", СтруктураРеквизитовФормы.Организация, "ЖШТАТ"); 
	СтруктураДанныхОтчетПоТруду["П7010_1"] = ТаблЧисленностиССЧЖ[0].Средняя;
	
	ТаблЧисленностиСовм = ИНАГРО_ПроведениеРасчетов.ПолучитьСреднююЧисленность(СтруктураРеквизитовФормы.мДатаНачалаПериодаОтчета, СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета, "ССЧ", "КВАРТАЛСНАЧАЛАГОДА", СтруктураРеквизитовФормы.Организация, "СОВМ"); 
	СтруктураДанныхОтчетПоТруду["П7030_1"] = ТаблЧисленностиСовм[0].Средняя;
	
	ТаблЧисленностиССЧГПХ = ИНАГРО_ПроведениеРасчетов.ПолучитьСреднююЧисленность(СтруктураРеквизитовФормы.мДатаНачалаПериодаОтчета, СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета, "ССЧ", "КВАРТАЛСНАЧАЛАГОДА", СтруктураРеквизитовФормы.Организация, "ГПХ"); 
