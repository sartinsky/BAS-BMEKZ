...
Функция ПолучитьТекстЗаголовка(ПараметрыОтчета, ОрганизацияВНачале = Истина) Экспорт 
	...
	Возврат НСтр("ru='Ожидаемый и подтвержденный НДС приобретений ';uk='Очікуваний та підтверджений ПДВ придбань '") + БухгалтерскиеОтчетыКлиентСервер.ПолучитьПредставлениеПериода(?(ПараметрыОтчета.СНачалаГода,НачалоГода(ПараметрыОтчета.НачалоПериода),ПараметрыОтчета.НачалоПериода),
...
Процедура ЗаполнитьПараметрыРасшифровкиОтчета(Адрес, Расшифровка, ПараметрыРасшифровки) Экспорт
	...
	Для Каждого ЗначениеРасшифровки Из Данные_Расшифровки Цикл
		Если ЗначениеРасшифровки.Ключ = "ДляОперацийОблагаемыхНДС" Или ЗначениеРасшифровки.Ключ = "ВозвратнаяТара" Или ЗначениеРасшифровки.Ключ = "Амортизируется"
			Или ЗначениеРасшифровки.Ключ = "ДляХозяйственнойДеятельности" Тогда
			Продолжить;
		КонецЕсли;
	...
	СписокПунктовМеню.Добавить("ОжидаемыйИПодтвержденныйНДСПриобретений", "Ожидаемый и подтвержденный НДС приобретений");
	
	НастройкиРасшифровки = Новый Структура();
	НастройкиРасшифровки.Вставить("ОжидаемыйИПодтвержденныйНДСПриобретений", ПользовательскиеНастройки);
