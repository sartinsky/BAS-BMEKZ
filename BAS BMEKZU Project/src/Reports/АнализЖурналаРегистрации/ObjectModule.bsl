...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Если ВариантОтчета = "ДиаграммаГанта" Тогда
		...
		Если Не ЗначениеЗаполнено(ПериодДень.Дата) Тогда
			ОбщегоНазначенияКлиентСервер.СообщитьПользователю(
				НСтр("ru='Не заполнено значение поля День.';uk='Не заповнено значення поля День.'"), , );
			Отказ = Истина;
			Возврат;
		КонецЕсли;
	...
	ИначеЕсли ВариантОтчета = "АктивностьПользователя" Тогда
		...
		Если Не ЗначениеЗаполнено(Пользователь) Тогда
			ОбщегоНазначенияКлиентСервер.СообщитьПользователю(
				НСтр("ru='Не заполнено значение поля Пользователь.';uk='Не заповнено значення поля Користувач.'"), , );
			Отказ = Истина;
			Возврат;
		КонецЕсли;
	...
	ИначеЕсли ВариантОтчета = "АнализАктивностиПользователей" Тогда
		...
		Если Не ЗначениеЗаполнено(ПользователиИГруппы) Тогда
			ОбщегоНазначенияКлиентСервер.СообщитьПользователю(
				НСтр("ru='Не заполнено значение поля Пользователи.';uk='Не заповнено значення поля Користувачі.'"), , );
			Отказ = Истина;
			Возврат;
		КонецЕсли;
