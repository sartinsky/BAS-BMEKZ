...
Процедура ОбработкаВыбораВПолеТабличногоДокумента(Элемент, Область, СтандартнаяОбработка)
	...
	Если ИмяЯчейки = "H02" Тогда
		...
		ТабличныйДокумент.Области["H05"].Значение = "";
		ТабличныйДокумент.Области["H05G1"].Значение = 0;
		ТабличныйДокумент.Области["H06"].Значение = "";
		ТабличныйДокумент.Области["H07"].Значение = "";
	...
	Если ИмяЯчейки = "H04G1" Тогда
		...
		Если НЕ ЗначениеЗаполнено(ТабличныйДокумент.Области["H04"].Значение)  Тогда
			СтандартнаяОбработка = Ложь;
			Возврат;
		КонецЕсли;
	...
	Если ИмяЯчейки = "H05" Тогда
		...
		Если ЗначениеЗаполнено(ТабличныйДокумент.Области[ИмяЯчейки].Значение) Тогда
			ТабличныйДокумент.Области[ИмяЯчейки].Значение	= "";
			ТабличныйДокумент.Области["H05G1"].Значение	= "";
		Иначе
			ТабличныйДокумент.Области[ИмяЯчейки].Значение	= "X";
		КонецЕсли;
	...
	Если ИмяЯчейки = "H05G1" Тогда
		
		Если НЕ ЗначениеЗаполнено(ТабличныйДокумент.Области["H05"].Значение)  Тогда
			СтандартнаяОбработка = Ложь;
			Возврат;
		КонецЕсли;
		
	КонецЕсли;	
	Если ИмяЯчейки = "H06" Тогда
...
Функция ЗаполнитьТаблицуСоСхемамиВыгрузки()
	...
	Для Сч = 1 По КоличествоСтраниц Цикл
		...
		Если СтруктураРеквизитовФормы.Организация.ЮридическоеФизическоеЛицо = Перечисления.ЮридическоеФизическоеЛицо.ЮридическоеЛицо Тогда
			НовСтрока.ИмяСхемы = "J1300106"; 
		Иначе	
			НовСтрока.ИмяСхемы = "F1300106"; 
		КонецЕсли;
