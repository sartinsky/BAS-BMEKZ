...
Функция ПолучитьТекстЗаголовка(ПараметрыОтчета, ОрганизацияВНачале = Истина) Экспорт 
	...
	Возврат НСтр("ru='Проверка суммы обязательств по НДС ';uk= 'Перевірка суми зобов'язань по ПДВ '") + БухгалтерскиеОтчетыКлиентСервер.ПолучитьПредставлениеПериода(?(ПараметрыОтчета.СНачалаГода,НачалоГода(ПараметрыОтчета.НачалоПериода),ПараметрыОтчета.НачалоПериода),
...
Процедура ЗаполнитьПараметрыРасшифровкиОтчета(Адрес, Расшифровка, ПараметрыРасшифровки) Экспорт
	...
	Для Каждого ЗначениеРасшифровки Из Данные_Расшифровки Цикл
		Если ЗначениеРасшифровки.Ключ = "ЗаТару" Или ЗначениеРасшифровки.Ключ = "СложныйНалоговыйУчет" Тогда
			Продолжить;
		КонецЕсли;
	...
	СписокПунктовМеню.Добавить("ПроверкаСуммыОбязательствПоНДС", "Проверка суммы обязательств по НДС");
	
	НастройкиРасшифровки = Новый Структура();
	НастройкиРасшифровки.Вставить("ПроверкаСуммыОбязательствПоНДС", ПользовательскиеНастройки);
