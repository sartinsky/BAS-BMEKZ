...
&НаКлиенте
Перем ОбработчикПослеФормированияНаКлиенте Экспорт; // Для хранения данных обработчика.
&НаКлиенте
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
    ...
    ЗаполнитьДополнительныеПараметры();//++ InAgro Степаненко 
...
Процедура ПриОбновленииСоставаПользовательскихНастроекНаСервере(СтандартнаяОбработка)
    ...
    Если ЭтаФорма.КлючТекущегоВарианта = "Вариант1" Тогда
        ЭтаФорма.Элементы.Граммы.Видимость = Ложь;
        Элементы.ПодробныеХарактеристики.Видимость = Ложь;
        Элементы.ЦентнероПроцент.Видимость = Истина;
        
    ИначеЕсли ЭтаФорма.КлючТекущегоВарианта = "Вариант2" Тогда
        Элементы.Граммы.Видимость = Ложь;
        Элементы.ПодробныеХарактеристики.Видимость = Ложь;
        Элементы.ЦентнероПроцент.Видимость = Ложь;
    Иначе
        Элементы.ЦентнероПроцент.Видимость = Истина;
        Элементы.ПодробныеХарактеристики.Видимость = Истина;
        Если ЦентнероПроцент Тогда
            Элементы.Граммы.Видимость = Ложь;
        Иначе
            Элементы.Граммы.Видимость = Истина;
...
//++ InAgro Степаненко 
&НаКлиенте
Процедура ЦентнероПроцентПриИзменении(Элемент)
    ...
    Если Не ЭтаФорма.КлючТекущегоВарианта = "Основной" Тогда
        Элементы.Граммы.Видимость = Ложь;
        Элементы.ПодробныеХарактеристики.Видимость = Ложь;
    КонецЕсли;
    ЗаполнитьДополнительныеПараметры();
...
&НаКлиенте
Процедура ПодробныеХарактеристикиПриИзменении(Элемент)
    ЗаполнитьДополнительныеПараметры();
КонецПроцедуры

&НаКлиенте
Процедура ГраммыПриИзменении(Элемент)
    ЗаполнитьДополнительныеПараметры();
КонецПроцедуры
// -- InAgro Степаненко 
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
// Вызов сервера
Процедура ЗаполнитьДополнительныеПараметры()
    Отчет.КомпоновщикНастроек.ПользовательскиеНастройки.ДополнительныеСвойства.Вставить("ДополнительныеПараметры",Новый Структура("ЦентнероПроцент,Граммы,ПодробныеХарактеристики",ЦентнероПроцент,Граммы,ПодробныеХарактеристики));    
КонецПроцедуры  
