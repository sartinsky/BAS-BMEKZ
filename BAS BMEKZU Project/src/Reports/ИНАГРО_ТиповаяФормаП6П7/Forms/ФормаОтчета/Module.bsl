...
Процедура ПериодПриИзмененииНаСервере()
	...
	Отчет.КомпоновщикНастроек.Настройки.ПараметрыДанных.Элементы.Найти("КонПериода").Значение = Отчет.КонецПериода;
...
Процедура ПриЗагрузкеПользовательскихНастроекНаСервере(Настройки)
	...
	Если Настройки.ДополнительныеСвойства.Свойство("НачалоПериода") Тогда	
		...
		Отчет.КомпоновщикНастроек.Настройки.ПараметрыДанных.Элементы.Найти("КонПериода").Значение = Настройки.ДополнительныеСвойства.КонецПериода;
		Отчет.КомпоновщикНастроек.Настройки.ПараметрыДанных.Элементы.Найти("КонПериода").Использование = Истина;	
