...
Функция ПодготовитьПараметрыОтчетаНаСервере()
	...
	ПараметрыОтчета.Вставить("ПоказательЗадолженность"            , Отчет.ПоказательЗадолженность);
	ПараметрыОтчета.Вставить("ПоказательПросроченнаяЗадолженность", Отчет.ПоказательПросроченнаяЗадолженность);
...
Процедура ОбновитьТекстЗаголовка(Форма)
	...
	Название = ?(ЗначениеЗаполнено(Форма.ПредставлениеТекущегоВарианта), Форма.ПредставлениеТекущегоВарианта, НСтр("ru='Динамика задолженности поставщикам';uk='Динаміка заборгованості постачальникам'"));
