...
Функция ДатыЗапретаПодготовленные(ПараметрыДанных)
	...
	Для Каждого Строка Из Таблица Цикл
		...
		ИначеЕсли ЗначениеЗаполнено(Строка.Раздел) Тогда
			Строка.ОбъектПредставление = НСтр("ru='Для всех объектов, кроме указанных';uk='Для всіх об''єктів, крім зазначених'");
		Иначе
			Строка.ОбъектПредставление = НСтр("ru='Для всех разделов и объектов, кроме указанных';uk='Для всіх розділів та об''єктів, крім зазначених'");
		КонецЕсли;
		
		Если ЗначениеЗаполнено(Строка.Раздел) Тогда
			Строка.РазделПредставление = Строка(Строка.Раздел);
		Иначе
			Строка.РазделПредставление = "<" + НСтр("ru='Общая дата';uk='Загальна дата'") + ">";
		КонецЕсли;
		
		Если Строка.АдресатНастройки = Перечисления.ВидыНазначенияДатЗапрета.ДляВсехИнформационныхБаз Тогда
			Строка.АдресатНастройкиПредставление = НСтр("ru='Для всех информационных баз, кроме указанных';uk='Для всіх інформаційних баз, крім зазначених'");
		Иначе
			Строка.АдресатНастройкиПредставление = Строка(ТипЗнч(Строка.АдресатНастройки)) + ":"
				+ ?(ЗначениеЗаполнено(Строка.АдресатНастройки),
					...
					НСтр("ru='Все информационные базы';uk='Всі інформаційні бази'"));
		КонецЕсли;
		
		Если Строка.ВладелецНастройки = Перечисления.ВидыНазначенияДатЗапрета.ДляВсехИнформационныхБаз Тогда
			Строка.ВладелецНастройкиПредставление = НСтр("ru='Для всех информационных баз, кроме указанных';uk='Для всіх інформаційних баз, крім зазначених'");
		Иначе
