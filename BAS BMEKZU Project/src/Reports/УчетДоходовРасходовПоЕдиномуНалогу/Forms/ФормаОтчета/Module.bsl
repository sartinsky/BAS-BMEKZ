...
Процедура ОбновитьТекстЗаголовка(Форма)
	...
	Отчет 			= Форма.Отчет;
	ЗаголовокОтчета = НСтр("ru='Типовая форма учета доходов и расходов ФЛП на едином налоге ';uk='Типова форма обліку доходів та витрат ФОП на єдиному податку '") + БухгалтерскиеОтчетыКлиентСервер.ПолучитьПредставлениеПериода(Отчет.НачалоПериода, Отчет.КонецПериода);
