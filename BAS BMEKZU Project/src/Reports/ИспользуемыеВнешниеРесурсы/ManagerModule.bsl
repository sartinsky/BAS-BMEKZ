...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	НастройкиВарианта.Наименование = НСтр("ru='Внешние ресурсы, используемые программой и дополнительными модулями';uk='Зовнішні ресурси, які використовуються програмою та додатковими модулями'");
	НастройкиВарианта.Описание = 
		НСтр("ru='Интернет-ресурсы, внешние компоненты, COM-классы и прочее.
                   ...
                   |;uk='Інтернет-ресурси, зовнішні компоненти, COM-класи та інше.
                   |Параметри оточення, які допоможуть адміністратору
                   |виконати настройку комп''ютера і провести аудит безпеки.'");
