...
Процедура ПриЗагрузкеВариантаНаСервере(Настройки)
	...
	Если ТипЗнч(ЭтаФорма.НастройкиОтчета) <> Тип("Структура") Тогда
		РассылкаОтчетовБП.ПриСозданииНаСервере(ЭтаФорма);	
	КонецЕсли;	
...
Процедура ОбновитьТекстЗаголовка(Форма)
	...
	Название = ?(ЗначениеЗаполнено(Форма.ПредставлениеТекущегоВарианта), Форма.ПредставлениеТекущегоВарианта, НСтр("ru='Остатки денежных средств';uk='Залишки коштів'"));
