...
Функция ПолучитьТекстЗаголовка(ПараметрыОтчета, ОрганизацияВНачале = Истина) Экспорт 
	...
	Возврат НСтр("ru='Поступления денежных средств';uk='Надходження коштів'") + БухгалтерскиеОтчетыКлиентСервер.ПолучитьПредставлениеПериода(ПараметрыОтчета.НачалоПериода, ПараметрыОтчета.КонецПериода);
...
Процедура ПередКомпоновкойМакета(ПараметрыОтчета, Схема, КомпоновщикНастроек) Экспорт
	...
	СписокВидовПоступлений = Новый СписокЗначений;
	СписокВидовПоступлений.Добавить("РозничнаяВыручка",НСтр("ru='Розничная выручка';uk='Роздрібний виторг'"));
	ПараметрыОтчета.СхемаКомпоновкиДанных.НаборыДанных.ОсновнойНабор.Поля.Найти("ВидДвижения").УстановитьДоступныеЗначения(СписокВидовПоступлений);
