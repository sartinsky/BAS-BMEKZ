...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	ПараметрДанных.Значение = ПериодНастройкаПользовательская.Значение.ДатаОкончания;
	ПараметрДанных.Использование = Истина;
	...
	Если ПериодСравненияНастройкаПользовательская <> Неопределено
		...
		ПараметрДанных.Значение = (ПериодСравненияНастройкаПользовательская.Значение.ДатаНачала - Дата(1,1,1)) * 1000;
		ПараметрДанных.Использование = Истина;
		
		ПараметрДанных = КомпоновщикНастроек.Настройки.ПараметрыДанных.Элементы.Найти("КонецПериодаСравненияЧисло");
		ПараметрДанных.Значение = (ПериодСравненияНастройкаПользовательская.Значение.ДатаОкончания - Дата(1,1,1)) * 1000;
		ПараметрДанных.Использование = Истина;
