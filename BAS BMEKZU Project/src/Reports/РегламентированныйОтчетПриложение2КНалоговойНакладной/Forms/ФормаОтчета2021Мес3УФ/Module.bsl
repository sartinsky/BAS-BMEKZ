...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СтруктураРеквизитовФормы.мСоставПоказателей = "СоставПоказателей2021Мес3УФ";
...
Процедура Заполнить(ПараметрыЗаполненияЗвит1С)
	...
	Для каждого СтрокаТЧ Из ДанныеТаблицы Цикл
		...
		Если РежимУточненияПоказателей <> 2 Тогда
			СтрокаМногострочки.RG6 = ?(СтрокаМногострочки.RG6 < 0, -Окр(-СтрокаМногострочки.RG6,2), Окр(СтрокаМногострочки.RG6,2)) ;
			СтрокаМногострочки.RG7 = ?(СтрокаМногострочки.RG7 < 0, -Окр(-СтрокаМногострочки.RG7,2), Окр(СтрокаМногострочки.RG7,2)) ;
		КонецЕсли;
	...
	Для каждого СтрокаМногострочки Из ДанныеМногострочки Цикл
		...
		Если РежимУточненияПоказателей = 1 Тогда
			...
			ИначеЕсли  ЗначениеЗаполнено(СтрокаМногострочки.RG7)
				...
				Если Окр(СтрокаМногострочки.RG7 * СтрокаМногострочки.RG8, 2) <> СтрокаМногострочки.RG010 Тогда
					СтрокаМногострочки.RG8 = СтрокаМногострочки.RG010 / СтрокаМногострочки.RG7;
				КонецЕсли;
