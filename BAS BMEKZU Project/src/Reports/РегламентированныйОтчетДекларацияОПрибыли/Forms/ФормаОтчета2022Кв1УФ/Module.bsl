...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СтруктураРеквизитовФормы.мСоставПоказателей = "СоставПоказателей2022Кв1УФ";
...
Процедура ЗаполнитьПоказателиПрошогоПериода(ПараметрыЗаполненияЗвит1С)
	...
	Иначе
		...
		Если ЮрЛицо Тогда  //с 2022
			ИмяСхемы = "J0100121";  // Декларация о прибыли 
			Если ЗначениеЗаполнено(СтруктураДанныхДекларация.H091) Тогда
				// сельхозники
				ИмяСхемы = "J0100521"; 
			КонецЕсли;
		Иначе
			ИмяСхемы = "F0100721";  // Декларация о прибыли 
		КонецЕсли;	
		...
		Если ЮрЛицо Тогда
			ИмяСхемы = "J0111421";  // Декларация о прибыли 
			Если ЗначениеЗаполнено(СтруктураДанныхДекларация.H091) Тогда
				// сельхозники
				ИмяСхемы = "J0151421"; 
			КонецЕсли;
