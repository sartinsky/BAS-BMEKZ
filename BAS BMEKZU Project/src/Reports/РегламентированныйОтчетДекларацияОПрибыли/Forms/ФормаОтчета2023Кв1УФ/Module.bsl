...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СтруктураРеквизитовФормы.мСоставПоказателей = "СоставПоказателей2023Кв1УФ";
...
Процедура Расчет(Форма, ИмяСтраницыПанели = "", ОбластьИмя = "")
	...
	R004G3 =  ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R002G3", Форма, "ПриложениеВП"))
											...
											+ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0031G3", Форма, "ПриложениеВП"))
											+ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0032G3", Форма, "ПриложениеВП"));
	...
	R004G3 =   ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R002G3", Форма, "Декларация"))
										  ...
										  + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0031G3", Форма, "Декларация"))
										  + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0032G3", Форма, "Декларация"));
	...
	R044G6 =  ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R002G3", Форма, "ПриложениеДИЯ")) 
										 + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R006G3", Форма, "ПриложениеДИЯ")) 	
										 + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R010G3", Форма, "ПриложениеДИЯ")) 	
										 + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R013G3", Форма, "ПриложениеДИЯ")) 	
										 + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R015G3", Форма, "ПриложениеДИЯ")) 	
										 + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R017G3", Форма, "ПриложениеДИЯ")) 
										 + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R019G3", Форма, "ПриложениеДИЯ")) 
										 + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R020G3", Форма, "ПриложениеДИЯ")) 
										 + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R021G3", Форма, "ПриложениеДИЯ")) 
										 + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R023G3", Форма, "ПриложениеДИЯ")) 
										 + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R025G3", Форма, "ПриложениеДИЯ")) 
										 + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R027G3", Форма, "ПриложениеДИЯ")) 
										 + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R029G3", Форма, "ПриложениеДИЯ")) 
										 + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R030G3", Форма, "ПриложениеДИЯ")) 
										 + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R031G3", Форма, "ПриложениеДИЯ")) 
										 + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R032G3", Форма, "ПриложениеДИЯ")) 
										 + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R033G3", Форма, "ПриложениеДИЯ")) 
										 + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R034G3", Форма, "ПриложениеДИЯ")) 
										 + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R035G3", Форма, "ПриложениеДИЯ")) 
										 + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R036G3", Форма, "ПриложениеДИЯ")) 
										 + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R037G3", Форма, "ПриложениеДИЯ")) 
										 + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R038G3", Форма, "ПриложениеДИЯ")) 
										 + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R039G3", Форма, "ПриложениеДИЯ"));
...
Процедура ПриОткрытии(Отказ)
	...
	Если Найти(Заголовок, СтруктураРеквизитовФормы.СтрПериодОтчета) = 0 Тогда
		Заголовок = Заголовок + " за " + СтруктураРеквизитовФормы.СтрПериодОтчета + " (форма 2023) ";
	КонецЕсли;
...
Процедура Заполнить(ПараметрыЗаполненияЗвит1С)
	...
	Если РегламентированнаяОтчетностьПереопределяемый.ИДКонфигурации() = "БП" 
		ИЛИ РегламентированнаяОтчетностьПереопределяемый.ИДКонфигурации() = "БСП"  //ИН-АГРО
...
Процедура ЗаполнитьПриложениеРИ_АМ_ТЦ(НомерПериода = 0)
   ...
   // Списание    = Кт оборот 10,11,12,286 - не в корр с 10,11,12,13,286 при условии, что на конец приода нет остатка по этим счетам учета (по Дт)
	...
	Если ИДКонф = "ЕРП" И ИДКонERP25 <> "КУП" Тогда
		...
		Пока ВыборкаКонтрагент.Следующий() Цикл
			...
			Пока Выборка.Следующий() Цикл
				...
				Если ЗначениеЗаполнено(Выборка.ДатаКонтракта) Тогда
					ДобавленнаяСтрока[ПрефиксИмениКолонки+"G3D"] = Выборка.ДатаКонтракта;
				КонецЕсли;
				ДобавленнаяСтрока[ПрефиксИмениКолонки+"G4S"] = Выборка.НомерКонтракта;
				ДобавленнаяСтрока[ПрефиксИмениКолонки+"G5S"] = Выборка.КодНаименованияОперации;	
				ДобавленнаяСтрока[ПрефиксИмениКолонки+"G6S"] = Выборка.ПредметСделкиСтрока;
				ДобавленнаяСтрока[ПрефиксИмениКолонки+"G7S"] = Выборка.КодПредмета;
				ДобавленнаяСтрока[ПрефиксИмениКолонки+"G8S"] = Выборка.КодУКТВЭД;
				ДобавленнаяСтрока[ПрефиксИмениКолонки+"G9S"] = Выборка.КодУКВЭП;
				ДобавленнаяСтрока[ПрефиксИмениКолонки+"G10D"] = Выборка.ДатаОперацииС;
				ДобавленнаяСтрока[ПрефиксИмениКолонки+"G11D"] = Выборка.ДатаОперацииПо;
				Если НомерПриложения > 0 Тогда
					ДобавленнаяСтрока[ПрефиксИмениКолонки+"G12S"] = НомерПриложения;
					ДобавленнаяСтрока[ПрефиксИмениКолонки+"G13"] = КонтрагентНомСтр;
				КонецЕсли;
				ДобавленнаяСтрока[ПрефиксИмениКолонки+"G15"] = Выборка.СуммаКорректировкиДоходов;//+
				Если Выборка.СуммаКорректировкиДоходов <> 0 Тогда
					ДобавленнаяСтрока[ПрефиксИмениКолонки+"G14"] = Выборка.ЗначениеПоказателяРентабельности;
				КонецЕсли;
				ДобавленнаяСтрока[ПрефиксИмениКолонки+"G17"] = -Выборка.СуммаКорректировкиРасходов;//-;
	...
	Пока Выборка.Следующий() Цикл
		...
		Иначе			
			Попытка		
				...
				ИначеЕсли Выборка.Статья = СтНД.НП15_РИ_Затраты_СебестЗеленыйТарифОплачен		Тогда ЗаполнитьКорректировкуРИ("R04225G3", "-", Выборка.Сумма, Выборка.Статья)
				КонецЕсли;
			Исключение	
			КонецПопытки;
	...
	Если ТекущиеДанные.Следующий() Тогда
		...
		Если ИмяЯчейки = "R0316G3" Тогда
			...
			Если ФлДвухПериодов и НомерПериода = 2 Тогда
				...
				Если СуммаДляСравнения <= МинЗП * 25 Тогда
...
Процедура ЗаполнитьУбытокПрошлогоГода(ПараметрыЗаполненияЗвит1С)
	...
	Иначе
		...
		Если ГодПериода = 2021 Тогда 
			...
			ИмяСхемы2 = "J0100520"; 
		ИначеЕсли ГодПериода = 2022 Тогда 
			ИмяСхемы1 = ИмяСхемы1 + "22";
			ИмяСхемы2 = "J0100522"; 
		Иначе  //2023
			ИмяСхемы1 = ИмяСхемы1 + "23";
			// сельхозники
			ИмяСхемы2 = "J0100523"; 
		КонецЕсли;
...
Процедура ЗаполнитьПоказателиПрошогоПериода(ПараметрыЗаполненияЗвит1С)
	...
	Иначе
		...
		Если ГодПериода = 2022 Тогда 
			Если ЮрЛицо Тогда  //с 1-го полугодия 2022
				ИмяСхемы = "J0100122";  // Декларация о прибыли 
		...
		Если ЮрЛицо Тогда
			...
			Если ГодПериода = 2021 Тогда 
				ИмяСхемы = ?(ЗначениеЗаполнено(СтруктураДанныхДекларация.H091), "J0151420","J0111420"); 
			ИначеЕсли ГодПериода = 2022 Тогда 
				ИмяСхемы = ?(ЗначениеЗаполнено(СтруктураДанныхДекларация.H091), "J0151422","J0111422"); 
			Иначе  //2023
				ИмяСхемы = ?(ЗначениеЗаполнено(СтруктураДанныхДекларация.H091), "J0151423","J0111423"); 
			КонецЕсли;
...
Функция ЗаполнитьТаблицуСоСхемамиВыгрузки()
	...
	Если ЮрЛицо Тогда
		...
		НовСтрока.ИмяСхемы = ?(ПроизводительСХ, "J0100523", "J0100123");  
		...
		НовСтрока = тбСхемыXML.Добавить();
		НовСтрока.ИмяСхемы = ?(ПроизводительСХ, "J0151823", "J0111823");  
		...
		НовСтрока = тбСхемыXML.Добавить();
		НовСтрока.ИмяСхемы = ?(ПроизводительСХ, "J0150323", "J0110323");  
		...
		НовСтрока = тбСхемыXML.Добавить();
		НовСтрока.ИмяСхемы = ?(ПроизводительСХ, "J0152823", "J0112823");  
		...
		НовСтрока = тбСхемыXML.Добавить();
		НовСтрока.ИмяСхемы = ?(ПроизводительСХ, "J0150623", "J0110623");  
		...
		НовСтрока = тбСхемыXML.Добавить();
		НовСтрока.ИмяСхемы = ?(ПроизводительСХ, "J0151323", "J0111323");  
		...
		НовСтрока = тбСхемыXML.Добавить(); 
		НовСтрока.ИмяСхемы = ?(ПроизводительСХ, "J0151423", "J0111423");  
		...
		Для  Инд = 1 ПО ТаблицаСтраницыРаздела1.Количество() Цикл
			...
			НовСтрока = тбСхемыXML.Добавить();
			НовСтрока.ИмяСхемы = ?(ПроизводительСХ, "J0151523", "J0111523");  
		...
		НовСтрока = тбСхемыXML.Добавить();
		НовСтрока.ИмяСхемы = ?(ПроизводительСХ, "J0151623", "J0111623");  
		...
		Если НЕ ЗначениеЗаполнено(ПолучитьПоказательНаСервере("HZU", ЭтаФорма, "Декларация")) Тогда
			НовСтрока = тбСхемыXML.Добавить();
			НовСтрока.ИмяСхемы = ?(ПроизводительСХ, "J0151723", "J0111723");  
		...
		НовСтрока = тбСхемыXML.Добавить();
		НовСтрока.ИмяСхемы = ?(ПроизводительСХ, "J0152023", "J0112023");  
		...
		Для  Инд = 1 ПО ТаблицаСтраницыРаздела2.Количество() Цикл
			...
			НовСтрока = тбСхемыXML.Добавить();
			НовСтрока.ИмяСхемы = ?(ПроизводительСХ, "J0154423", "J0114423");  
		...
		НовСтрока = тбСхемыXML.Добавить();
		НовСтрока.ИмяСхемы = ?(ПроизводительСХ, "J0154823", "J0114823");  
		...
		НовСтрока = тбСхемыXML.Добавить();
		НовСтрока.ИмяСхемы = ?(ПроизводительСХ, "J0154923", "J0114923");  
		...
		НовСтрока = тбСхемыXML.Добавить();
		НовСтрока.ИмяСхемы = ?(ПроизводительСХ, "J0155023", "J0115023");  
		...
		Пока Выборка.Следующий() Цикл
			...
			Если Выборка.ПлательщикЕдиногоНалога = ИСТИНА И 
				...
				Если ЗначениеЗаполнено(Выборка.ДатаИзмененияСхемыНалогообложенияВСерединеМесяца) Тогда
					ДатаНачалаЕН = Макс(Выборка.ДатаИзмененияСхемыНалогообложенияВСерединеМесяца, СтруктураРеквизитовФормы.мДатаНачалаПериодаОтчета);
				Иначе
					//с начала месяца
					ДатаНачалаЕН = Макс(Выборка.Период, СтруктураРеквизитовФормы.мДатаНачалаПериодаОтчета);
				КонецЕсли;
			КонецЕсли;
