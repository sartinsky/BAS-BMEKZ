...
Перем мОбъектОтчета;     
&НаСервере
Перем ФлПерехода, ФлДвухПериодов;     
Перем ДатаНачала1, ДатаОкончания1;     
Перем ДатаНачала2, ДатаОкончания2;   
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СтруктураРеквизитовФормы.мСоставПоказателей = "СоставПоказателей2023Кв2УФ";
	...
	СтруктураРеквизитовФормы.мИдГруппыMZ1 = "MZT1R";
	СтруктураРеквизитовФормы.мИдГруппыMZ2 = "MZT2R";
	...
	СтруктураДанныхПриложениеМПЗ = Новый Структура;
	СтруктураДанныхПриложениеМЗЗ = Новый Структура;
	СтруктураДанныхПриложениеДИЯ = Новый Структура;
	СтруктураДанныхПриложениеОВ = Новый Структура;
	...
	мСтруктураМногострочныхРазделов.Вставить(СтруктураРеквизитовФормы.мИдГруппыMZ1, СтруктураРеквизитовФормы.мИдГруппыMZ1);
	мСтруктураМногострочныхРазделов.Вставить(СтруктураРеквизитовФормы.мИдГруппыMZ2, СтруктураРеквизитовФормы.мИдГруппыMZ2);
	...
	мСтруктураИсхКолвоСтрокРазделов.Вставить(СтруктураРеквизитовФормы.мИдГруппыMZ1, КолИсхСтрокИдГруппы1);
	мСтруктураИсхКолвоСтрокРазделов.Вставить(СтруктураРеквизитовФормы.мИдГруппыMZ2, КолИсхСтрокИдГруппы1);
	...
	// Версия формы
	СтруктураРеквизитовФормы.мВерсияФормы = "01/04/2023";
	...
	СтруктураРеквизитовФормы.МинЗП		              = ЗаполнитьМинЗП();;
...
Процедура СформироватьСтруктуруРеквизитовФормы()
	...
	СтруктураРеквизитовФормы.Вставить("мИдГруппыMZ1");
	СтруктураРеквизитовФормы.Вставить("мИдГруппыMZ2");
	...
	СтруктураРеквизитовФормы.Вставить("КоеффициентМПЗ",	0.04); //2022-2023 0,04, потом 0,05 
	СтруктураРеквизитовФормы.Вставить("КорректироватьПлощади", Ложь);  
	СтруктураРеквизитовФормы.Вставить("ДатаНачалаНаЕдиномНалоге");
	СтруктураРеквизитовФормы.Вставить("ДатаОкончанияНаЕдиномНалоге");
	...
	СтруктураРеквизитовФормы.Вставить("МинЗП"); 
	СтруктураРеквизитовФормы.Вставить("H091"); 
...
Процедура ФормироватьСтруктуруСтраницОтчета() 
	...
	СтрокаУровня1 = мДеревоСтраницОтчета.ПолучитьЭлементы().Добавить();
	СтрокаУровня1.ИмяСтраницы              = "ПриложениеМПЗ";
	СтрокаУровня1.Представление            = НСтр("ru='Приложение МПЗ';uk='Додаток МПЗ'");
	СтрокаУровня1.ИмяОбластиТабличногоПоля = "ОбластьПечатиПоВысоте|ОбластьПечатиПоШирине";
	СтрокаУровня1.ОриентацияСтраницы       = ОриентацияСтраницы.Портрет;
	СтрокаУровня1.ВыводНаПечать            = 1;
	СтрокаУровня1.ПоказатьСтраницу         = 1;
	...
	СтрокаУровня1 = мДеревоСтраницОтчета.ПолучитьЭлементы().Добавить();
	СтрокаУровня1.ИмяСтраницы              = "ПриложениеМЗЗ";
	СтрокаУровня1.Представление            = НСтр("ru='Приложение МПЗ-З';uk='Додаток МПЗ-З'");
	СтрокаУровня1.ИмяОбластиТабличногоПоля = "ОбластьПечатиПоВысоте|ОбластьПечатиПоШирине";
	СтрокаУровня1.ОриентацияСтраницы       = ОриентацияСтраницы.Портрет;
	СтрокаУровня1.ВыводНаПечать            = 1;
	СтрокаУровня1.ПоказатьСтраницу         = 1;
	...
	СтрокаУровня1 = мДеревоСтраницОтчета.ПолучитьЭлементы().Добавить();
	СтрокаУровня1.ИмяСтраницы              = "ПриложениеДИЯ";
	СтрокаУровня1.Представление            = НСтр("ru='Приложение ДІЯ';uk='Додаток ДІЯ'");
	СтрокаУровня1.ИмяОбластиТабличногоПоля = "ОбластьПечатиПоВысоте|ОбластьПечатиПоШирине";
	СтрокаУровня1.ОриентацияСтраницы       = ОриентацияСтраницы.Портрет;
	СтрокаУровня1.ВыводНаПечать            = 1;
	СтрокаУровня1.ПоказатьСтраницу         = 1;
	...
	СтрокаУровня1 = мДеревоСтраницОтчета.ПолучитьЭлементы().Добавить();
	СтрокаУровня1.ИмяСтраницы              = "ПриложениеОВ";
	СтрокаУровня1.Представление            = НСтр("ru='Приложение ОВ';uk='Додаток ОВ'");
	СтрокаУровня1.ИмяОбластиТабличногоПоля = "ОбластьПечатиПоВысоте|ОбластьПечатиПоШирине";
	СтрокаУровня1.ОриентацияСтраницы       = ОриентацияСтраницы.Портрет;
	СтрокаУровня1.ВыводНаПечать            = 1;
	СтрокаУровня1.ПоказатьСтраницу         = 1;
...
Процедура ФормироватьСтруктуруСвойствСтраниц() Экспорт
	...
	НовСтр = СтрокаУровня1.МногострочностьВРазделе.Добавить();
	НовСтр.ИдГруппы = СтруктураРеквизитовФормы.мИдГруппыMZ1;
	НовСтр.Область = "МногострочнаяЧасть_1";
	НовСтр.ВысотаСтроки =1;

	НовСтр = СтрокаУровня1.МногострочностьВРазделе.Добавить();
	НовСтр.ИдГруппы = СтруктураРеквизитовФормы.мИдГруппыMZ2;
	НовСтр.Область = "МногострочнаяЧасть_2";
	НовСтр.ВысотаСтроки =1;
...
Процедура РазделыОтчетаПриАктивизацииСтроки(Элемент) Экспорт
	...
	Если    Элемент.ТекущиеДанные.КолонкаРазделыОтчетаСокрНаим = "Декларация"
		...
		ИЛИ Элемент.ТекущиеДанные.КолонкаРазделыОтчетаСокрНаим = "ПриложениеМЗЗ" Тогда
...
Процедура СохранитьДанныеРаздела(НаимРаздела, ОчищатьРазделЕслиЕстьМногострочность, ИзменитьПризнакАктивностиСтраницы = Истина)
	...
	//
	Если    НаимРаздела = "ПриложениеПН"  Тогда       //многостраничные разделы с многострочками
	...
	ИначеЕсли    НаимРаздела = "ПриложениеКИК" Тогда //многостраничные разделы без многострочек
...
Процедура ВывестиМакетВТаблДокНаСервере(ИмяТекРаздела, НомерСтраницыРазделаОтчета)
	...
	Если  НЕ(  ИмяТекРаздела = "ПриложениеПН" или ИмяТекРаздела = "ПриложениеКИК") Тогда
...
Процедура ЗаполнитьПоказателиЗначениямиПоУмолчанию(НаимРаздела)
	...
	Если    НаимРаздела = "ПриложениеПН" или НаимРаздела = "ПриложениеКИК" Тогда
...
Функция ОпределитьТабличноеПолеПоИдМногострочногоРазделаНаКлиенте(ИдГруппы) Экспорт
	...
	ИдГрупп.Вставить("мИдГруппыMZ1", СтруктураРеквизитовФормы.мИдГруппыMZ1);
	ИдГрупп.Вставить("мИдГруппыMZ2", СтруктураРеквизитовФормы.мИдГруппыMZ2);
...
Функция ОпределитьТабличноеПолеПоИдМногострочногоРаздела(ИдГруппы, ИдГрупп) Экспорт
	...
	ИначеЕсли  ИдГруппы = ИдГрупп.мИдГруппыMZ1   
		   ИЛИ ИдГруппы = ИдГрупп.мИдГруппыMZ2 Тогда
		
		ТекТабличноеПоле = "ПриложениеМЗЗ";
...
Процедура ЗаполнитьШапкуПодписиПриложенияПН(Форма, НаимРаздела)
	...
	Если НЕ НаимРаздела = "ПриложениеМПЗ" И  НЕ НаимРаздела = "ПриложениеМЗЗ" И  НЕ НаимРаздела = "ПриложениеДИЯ" Тогда 
...
Процедура ЗаполнитьСведенияОбОрганизации(Форма)
	...
	Если МесяцОтчета = 3 Тогда
		ЗаполнитьПоказательНаВсехЗакладках("H1KV", "X", Форма, "|ПриложениеТЦ|ПриложениеМПЗ|ПриложениеМЗЗ|ПриложениеДИЯ|");
	ИначеЕсли МесяцОтчета = 6 Тогда
		ЗаполнитьПоказательНаВсехЗакладках("HHY",  "X", Форма, "|ПриложениеТЦ|ПриложениеМПЗ|ПриложениеМЗЗ|ПриложениеДИЯ|");
	ИначеЕсли МесяцОтчета = 9 Тогда
		ЗаполнитьПоказательНаВсехЗакладках("H3KV", "X", Форма, "|ПриложениеТЦ|ПриложениеМПЗ|ПриложениеМЗЗ|ПриложениеДИЯ|");
	ИначеЕсли МесяцОтчета = 12 Тогда
		ЗаполнитьПоказательНаВсехЗакладках("HY",   "X", Форма, "|ПриложениеТЦ|ПриложениеМПЗ|ПриложениеМЗЗ|ПриложениеДИЯ|");
	КонецЕсли;
	...
	ЗаполнитьПоказательНаСервере("R0064G1",  Ставка,  Форма, "Декларация");
	ЗаполнитьПоказательНаСервере("R006G1",  Ставка,  Форма, "ПриложениеВП");
	ЗаполнитьПоказательНаСервере("R0064G1",  Ставка,  Форма, "ПриложениеВП");
	...
	ЗаполнитьПоказательНаСервере("H091", Форма.СтруктураРеквизитовФормы.H091, Форма, "Декларация");
...
Процедура ЗаполнитьПоказательНаВсехЗакладках(ИмяПоказателя, Значение, Форма, СписокИсключений = "")
	...
	Если Найти(СписокИсключений, "|ПриложениеКИК|") = 0 Тогда
		...
		КонецЕсли;	
	КонецЕсли;
 	Если Найти(СписокИсключений, "|ПриложениеМПЗ|") = 0 Тогда
		ЗаполнитьПоказательНаСервере(ИмяПоказателя, Значение, Форма, "ПриложениеМПЗ");
	КонецЕсли;
	Если Найти(СписокИсключений, "|ПриложениеМЗЗ|") = 0 Тогда
		ЗаполнитьПоказательНаСервере(ИмяПоказателя, Значение, Форма, "ПриложениеМЗЗ");
	КонецЕсли;
 	Если Найти(СписокИсключений, "|ПриложениеДИЯ|") = 0 Тогда
		ЗаполнитьПоказательНаСервере(ИмяПоказателя, Значение, Форма, "ПриложениеДИЯ");
	КонецЕсли;
 	Если Найти(СписокИсключений, "|ПриложениеОВ|") = 0 Тогда
		ЗаполнитьПоказательНаСервере(ИмяПоказателя, Значение, Форма, "ПриложениеОВ");
	КонецЕсли;
...
Функция ОпределитьИдМногострочногоРазделаПоАктивнойСтранице(ИмяЛиста = Неопределено, ТекущаяСтраница, ИдГрупп)
	...
	ИначеЕсли ИмяТекущейСтраницыПанели = "ПриложениеМЗЗ" Тогда
		ИмяГруппы.Добавить(ИдГрупп.мИдГруппыMZ1);
		ИмяГруппы.Добавить(ИдГрупп.мИдГруппыMZ2);
	КонецЕсли;
...
Процедура ВосстановитьСохраненныеДанные()
	...
	КонецЕсли;	
	Если НЕ СписокСохранения.Свойство("КоеффициентМПЗ", СтруктураРеквизитовФормы.КоеффициентМПЗ) Тогда
		СтруктураРеквизитовФормы.КоеффициентМПЗ = 0.04;	 //2022-2023 0,04, потом 0,05
	КонецЕсли;	
	СписокСохранения.Свойство("КорректироватьПлощади", 		 СтруктураРеквизитовФормы.КорректироватьПлощади);  // ИНАГРО ++
	СписокСохранения.Свойство("ДатаНачалаНаЕдиномНалоге",    СтруктураРеквизитовФормы.ДатаНачалаНаЕдиномНалоге);
	СписокСохранения.Свойство("ДатаОкончанияНаЕдиномНалоге", СтруктураРеквизитовФормы.ДатаОкончанияНаЕдиномНалоге);
...
Функция Сохранить(Автосохранение = Ложь, НаимТекРаздела) Экспорт	
	...
	СписокСохранения.Вставить("КоеффициентМПЗ",  				СтруктураРеквизитовФормы.КоеффициентМПЗ); 
	СписокСохранения.Вставить("КорректироватьПлощади",  		СтруктураРеквизитовФормы.КорректироватьПлощади);  // ИНАГРО ++
  	СписокСохранения.Вставить("ДатаНачалаНаЕдиномНалоге", 		СтруктураРеквизитовФормы.ДатаНачалаНаЕдиномНалоге);
	СписокСохранения.Вставить("ДатаОкончанияНаЕдиномНалоге", 	СтруктураРеквизитовФормы.ДатаОкончанияНаЕдиномНалоге);
...
Процедура ЗаполнитьПустыеСтруктурыДанных()
	...
	Для Каждого Раздел Из мСвойстваРазделовДекларации.ПолучитьЭлементы() Цикл
		...
		Если Раздел.ИмяСтраницы = "ПриложениеПН" Тогда  
			...
			КонецЦикла;
		ИначеЕсли Раздел.ИмяСтраницы = "ПриложениеКИК" Тогда   
...
Процедура Расчет(Форма, ИмяСтраницыПанели = "", ОбластьИмя = "")
	...
	Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = ИмяСтраницыПанели Тогда
		...
		ИдГрупп.Вставить("мИдГруппыMZ1", Форма.СтруктураРеквизитовФормы.мИдГруппыMZ1);
		ИдГрупп.Вставить("мИдГруппыMZ2", Форма.СтруктураРеквизитовФормы.мИдГруппыMZ2);
	...
	R01G17 = ОкруглитьЧислоПоФормату(Форма, ТекСтруктура.Итог("TCT1RXXXXG17"));
	 R01G18 = ОкруглитьЧислоПоФормату(Форма, ТекСтруктура.Итог("TCT1RXXXXG18"));
	R01G19 = ОкруглитьЧислоПоФормату(Форма, ТекСтруктура.Итог("TCT1RXXXXG19"));
	ЗаполнитьПоказательНаСервере("R01G17", R01G17, Форма, "ПриложениеТЦ");
	ЗаполнитьПоказательНаСервере("R01G19", R01G19, Форма, "ПриложениеТЦ");
	...
	R02G17 = ОкруглитьЧислоПоФормату(Форма, ТекСтруктура.Итог("TCT2RXXXXG17"));
	 R02G18 = ОкруглитьЧислоПоФормату(Форма, ТекСтруктура.Итог("TCT2RXXXXG18"));
	R02G19 = ОкруглитьЧислоПоФормату(Форма, ТекСтруктура.Итог("TCT2RXXXXG19"));
	ЗаполнитьПоказательНаСервере("R02G17", R02G17, Форма, "ПриложениеТЦ");
	ЗаполнитьПоказательНаСервере("R02G19", R02G19, Форма, "ПриложениеТЦ");
	
	//////////////////////////////////////////////////////////////////////////////////////////
	// ЦП
	ЗаполнитьПоказательНаСервере("R0112G3", R02G17, Форма, "ПриложениеЦП");
	ЗаполнитьПоказательНаСервере("R0212G3", R02G19, Форма, "ПриложениеЦП");
	...
	ЗаполнитьПоказательНаСервере("R0313G3", ПолучитьПоказательНаСервере("R01G17", Форма, "ПриложениеТЦ"), Форма, "ПриложениеРИ");
	ЗаполнитьПоказательНаСервере("R0314G3", ПолучитьПоказательНаСервере("R01G19", Форма, "ПриложениеТЦ"), Форма, "ПриложениеРИ");
	...
	R001G3 = ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0111G3", Форма, "ПриложениеРИ"))
										  ...
										  + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R031102G3", Форма, "ПриложениеРИ"))  
										  ...
										  + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R03115G3", Форма, "ПриложениеРИ")) 
										  ...
										  + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R04122G3", Форма, "ПриложениеРИ")) 
										  + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R04123G3", Форма, "ПриложениеРИ"))
										  + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R04142G3", Форма, "ПриложениеРИ"))
										  + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R04143G3", Форма, "ПриложениеРИ"))
										  + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R04124G3", Форма, "ПриложениеРИ"));
	...
	R002G3 = ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0121G3", Форма, "ПриложениеРИ"))
										  ...
										  + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0326G3", Форма, "ПриложениеРИ"))  										  
										  ...
										  + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R04222G3", Форма, "ПриложениеРИ")) 
										  + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R04223G3", Форма, "ПриложениеРИ")) 
										  + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R04224G3", Форма, "ПриложениеРИ")) 
										  + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R04225G3", Форма, "ПриложениеРИ")) 
										  + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R04231G3", Форма, "ПриложениеРИ")) 
										  + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R04232G3", Форма, "ПриложениеРИ")) 
										  + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R04226G3", Форма, "ПриложениеРИ")) 
										  + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R04227G3", Форма, "ПриложениеРИ")) 
										  + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R04228G3", Форма, "ПриложениеРИ")); 
	...
	коэфОВ_пункт = ?(Год(Форма.СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета)=2023,0.33,1);
	коэфОВ_аванс = ?(Год(Форма.СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета)=2023,0.66,1);

	R0010G4 = ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0010G3", Форма, "ПриложениеОВ")) * 3 * Форма.СтруктураРеквизитовФормы.МинЗП * коэфОВ_пункт;
	ЗаполнитьПоказательНаСервере("R0010G4", R0010G4, Форма, "ПриложениеОВ");
	R0011G4 = ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0011G3", Форма, "ПриложениеОВ")) * Форма.СтруктураРеквизитовФормы.МинЗП * коэфОВ_пункт;
	ЗаполнитьПоказательНаСервере("R0011G4", R0011G4, Форма, "ПриложениеОВ"); 
	R026G4 = R026G4 + R0010G4 + R0011G4;
	
	R0020G4 = ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0020G3", Форма, "ПриложениеОВ")) * 3 * Форма.СтруктураРеквизитовФормы.МинЗП * коэфОВ_пункт;
	ЗаполнитьПоказательНаСервере("R0020G4", R0020G4, Форма, "ПриложениеОВ");
	R0021G4 = ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0021G3", Форма, "ПриложениеОВ")) * Форма.СтруктураРеквизитовФормы.МинЗП * коэфОВ_пункт;
	ЗаполнитьПоказательНаСервере("R0021G4", R0021G4, Форма, "ПриложениеОВ");   
	R026G4 = R026G4 + R0020G4 + R0021G4;
	
	R0030G4 = ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0030G3", Форма, "ПриложениеОВ")) * 3 * Форма.СтруктураРеквизитовФормы.МинЗП * коэфОВ_пункт;
	ЗаполнитьПоказательНаСервере("R0030G4", R0030G4, Форма, "ПриложениеОВ");
	R0031G4 = ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0031G3", Форма, "ПриложениеОВ")) * Форма.СтруктураРеквизитовФормы.МинЗП * коэфОВ_пункт;
	ЗаполнитьПоказательНаСервере("R0031G4", R0031G4, Форма, "ПриложениеОВ");  
	R026G4 = R026G4 + R0030G4 + R0031G4;
	
	R0040G4 = ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0040G3", Форма, "ПриложениеОВ")) * 3 * Форма.СтруктураРеквизитовФормы.МинЗП * коэфОВ_пункт;
	ЗаполнитьПоказательНаСервере("R0040G4", R0040G4, Форма, "ПриложениеОВ");
	R0041G4 = ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0041G3", Форма, "ПриложениеОВ")) * Форма.СтруктураРеквизитовФормы.МинЗП * коэфОВ_пункт;
	ЗаполнитьПоказательНаСервере("R0041G4", R0041G4, Форма, "ПриложениеОВ");  
	R026G4 = R026G4 + R0040G4 + R0041G4;
	
	R0050G4 = ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0050G3", Форма, "ПриложениеОВ")) * 3 * Форма.СтруктураРеквизитовФормы.МинЗП * коэфОВ_пункт;
	ЗаполнитьПоказательНаСервере("R0050G4", R0050G4, Форма, "ПриложениеОВ");
	R0051G4 = ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0051G3", Форма, "ПриложениеОВ")) * Форма.СтруктураРеквизитовФормы.МинЗП * коэфОВ_пункт;
	ЗаполнитьПоказательНаСервере("R0051G4", R0051G4, Форма, "ПриложениеОВ");  
	R026G4 = R026G4 + R0050G4 + R0051G4;
	
	R0060G4 = ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0060G3", Форма, "ПриложениеОВ")) * 3 * Форма.СтруктураРеквизитовФормы.МинЗП * коэфОВ_пункт;
	ЗаполнитьПоказательНаСервере("R0060G4", R0060G4, Форма, "ПриложениеОВ");
	R0061G4 = ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0061G3", Форма, "ПриложениеОВ")) * Форма.СтруктураРеквизитовФормы.МинЗП * коэфОВ_пункт;
	ЗаполнитьПоказательНаСервере("R0061G4", R0061G4, Форма, "ПриложениеОВ");  
	R026G4 = R026G4 + R0060G4 + R0061G4;
	
	R0070G4 = ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0070G3", Форма, "ПриложениеОВ")) * 3 * Форма.СтруктураРеквизитовФормы.МинЗП * коэфОВ_аванс;
	ЗаполнитьПоказательНаСервере("R0070G4", R0070G4, Форма, "ПриложениеОВ");
	R0071G4 = ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0071G3", Форма, "ПриложениеОВ")) * Форма.СтруктураРеквизитовФормы.МинЗП * коэфОВ_аванс;
	ЗаполнитьПоказательНаСервере("R0071G4", R0071G4, Форма, "ПриложениеОВ");  
	R026G4 = R026G4 + R0070G4 + R0071G4;
	
	R0080G4 = ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0080G3", Форма, "ПриложениеОВ")) * 3 * Форма.СтруктураРеквизитовФормы.МинЗП * коэфОВ_аванс;
	ЗаполнитьПоказательНаСервере("R0080G4", R0080G4, Форма, "ПриложениеОВ");
	R0081G4 = ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0081G3", Форма, "ПриложениеОВ")) * Форма.СтруктураРеквизитовФормы.МинЗП * коэфОВ_аванс;
	ЗаполнитьПоказательНаСервере("R0081G4", R0081G4, Форма, "ПриложениеОВ");  
	R026G4 = R026G4 + R0080G4 + R0081G4;
	
	R0090G4 = ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0090G3", Форма, "ПриложениеОВ")) * 3 * Форма.СтруктураРеквизитовФормы.МинЗП * коэфОВ_аванс;
	ЗаполнитьПоказательНаСервере("R0090G4", R0090G4, Форма, "ПриложениеОВ");
	R0091G4 = ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0091G3", Форма, "ПриложениеОВ")) * Форма.СтруктураРеквизитовФормы.МинЗП * коэфОВ_аванс;
	ЗаполнитьПоказательНаСервере("R0091G4", R0091G4, Форма, "ПриложениеОВ");   
	R026G4 = R026G4 + R0090G4 + R0091G4;
	
	R0100G4 = ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0100G3", Форма, "ПриложениеОВ")) * 3 * Форма.СтруктураРеквизитовФормы.МинЗП * коэфОВ_аванс;
	ЗаполнитьПоказательНаСервере("R0100G4", R0100G4, Форма, "ПриложениеОВ");
	R0101G4 = ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0101G3", Форма, "ПриложениеОВ")) * Форма.СтруктураРеквизитовФормы.МинЗП * коэфОВ_аванс;
	ЗаполнитьПоказательНаСервере("R0101G4", R0101G4, Форма, "ПриложениеОВ");   
	R026G4 = R026G4 + R0100G4 + R0101G4;
	
	R0110G4 = ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0110G3", Форма, "ПриложениеОВ")) * 3 * Форма.СтруктураРеквизитовФормы.МинЗП * коэфОВ_аванс;
	ЗаполнитьПоказательНаСервере("R0110G4", R0110G4, Форма, "ПриложениеОВ");
	R0111G4 = ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0111G3", Форма, "ПриложениеОВ")) * Форма.СтруктураРеквизитовФормы.МинЗП * коэфОВ_аванс;
	ЗаполнитьПоказательНаСервере("R0111G4", R0111G4, Форма, "ПриложениеОВ");   
	R026G4 = R026G4 + R0110G4 + R0111G4;
	
	R0120G4 = ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0120G3", Форма, "ПриложениеОВ")) * 3 * Форма.СтруктураРеквизитовФормы.МинЗП * коэфОВ_аванс;
	ЗаполнитьПоказательНаСервере("R0120G4", R0120G4, Форма, "ПриложениеОВ");
	R0121G4 = ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0121G3", Форма, "ПриложениеОВ")) * Форма.СтруктураРеквизитовФормы.МинЗП * коэфОВ_аванс;
	ЗаполнитьПоказательНаСервере("R0121G4", R0121G4, Форма, "ПриложениеОВ");  
	R026G4 = R026G4 + R0120G4 + R0121G4;
	
	ЗаполнитьПоказательНаСервере("R026G4", R026G4, Форма, "ПриложениеОВ");
		
	ЗаполнитьПоказательНаСервере("R026G3", R026G4, Форма, "Декларация"); 
	R028G3 = R026G4 - ПолучитьПоказательНаСервере("R027G3",Форма,"Декларация");
	ЗаполнитьПоказательНаСервере("R028G3", R028G3, Форма, "Декларация");
	//////////////////////////////////////////////////////////////////////////////////////////
	// ВП
	...
	R0064G3 = (ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R00641G3", Форма, "ПриложениеВП"))
											 + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R00642G3", Форма, "ПриложениеВП"))
											)* ПолучитьПоказательНаСервере("R0064G1", Форма, "ПриложениеВП") / 100;
											 
	ЗаполнитьПоказательНаСервере("R0064G3", R0064G3, Форма, "ПриложениеВП");
	...
	R017G3 =  ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R006G3", Форма, "ПриложениеВП"))
											...
											+ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0062G3", Форма, "ПриложениеВП"))
											+ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0063G3", Форма, "ПриложениеВП"))
											+ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0064G3", Форма, "ПриложениеВП"))
	...
	R028G3 =  ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R026G3", Форма, "ПриложениеВП"))
											-ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R027G3", Форма, "ПриложениеВП"));
	ЗаполнитьПоказательНаСервере("R028G3", R028G3, Форма, "ПриложениеВП");
	
	R031G3 = ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R029G3", Форма, "ПриложениеВП"))* 0.05;
	Если R031G3 < 0 Тогда
		R031G3 = 0;
	КонецЕсли;
	ЗаполнитьПоказательНаСервере("R031G3", R031G3, Форма, "ПриложениеВП");
	
	R034G3 = ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R033G3", Форма, "ПриложениеВП"))* 0.05;
	Если R034G3 < 0 Тогда
		R034G3 = 0;
	КонецЕсли;
	ЗаполнитьПоказательНаСервере("R034G3", R034G3, Форма, "ПриложениеВП");	
	
										   
	R037G3 = ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R036G3", Форма, "ПриложениеВП"))* 0.05;
	Если R037G3 < 0 Тогда
		R037G3 = 0;
	КонецЕсли;
	ЗаполнитьПоказательНаСервере("R037G3", R037G3, Форма, "ПриложениеВП");	
	...
	R0064G3 = (ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R00641G3", Форма, "Декларация"))
										   +ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R00642G3", Форма, "Декларация"))
										   )* ПолучитьПоказательНаСервере("R0064G1", Форма, "Декларация") / 100;
	Если R0064G3 < 0 Тогда
		R0064G3 = 0;
	КонецЕсли;										  
	ЗаполнитьПоказательНаСервере("R0064G3", R0064G3, Форма, "Декларация");
	...
	//////////////////////////////////////////////////////////////////////////////////////////
	// МЗЗ
	ЗаполнитьПоказательНаСервере("MZR01G5", 0, Форма, "ПриложениеМЗЗ");
	ЗаполнитьПоказательНаСервере("MZR01G6", 0, Форма, "ПриложениеМЗЗ");
	
	Форма.мСтруктураМногострочныхРазделов.Свойство(Форма.СтруктураРеквизитовФормы.мИдГруппыMZ1, ТаблицаБлока);
	СтруктураМЗ1 = Форма[ТаблицаБлока];
	Для каждого СтрокаМЗ1 Из СтруктураМЗ1 Цикл
	
		//СтрокаМЗ1.MZT1RXXXXG6 =   ОкруглитьЧислоПоФормату(Форма, СтрокаМЗ1.MZT1RXXXXG3)
		//				  *	ОкруглитьЧислоПоФормату(Форма, СтрокаМЗ1.MZT1RXXXXG4)
		//				  * Форма.СтруктураРеквизитовФормы.КоеффициентМПЗ /12;  
		
		СтрокаМЗ1.MZT1RXXXXG6 =   ОкруглитьЧислоПоФормату(Форма,СтрокаМЗ1.MZT1RXXXXG3
						  *	СтрокаМЗ1.MZT1RXXXXG4
						  * Форма.СтруктураРеквизитовФормы.КоеффициентМПЗ /12);
						  
		ЗаполнитьПоказательНаСервере("MZT1RXXXXG6_"+Формат(СтруктураМЗ1.Индекс(СтрокаМЗ1) + 1, "ЧГ=;"), СтрокаМЗ1.MZT1RXXXXG6, Форма, "ПриложениеМЗЗ");

		R01G5 = ПолучитьПоказательНаСервере("MZR01G5", Форма, "ПриложениеМЗЗ") + СтрокаМЗ1.MZT1RXXXXG5;
		ЗаполнитьПоказательНаСервере("MZR01G5", R01G5, Форма, "ПриложениеМЗЗ");

		R01G6 = ПолучитьПоказательНаСервере("MZR01G6", Форма, "ПриложениеМЗЗ") + СтрокаМЗ1.MZT1RXXXXG6;
		ЗаполнитьПоказательНаСервере("MZR01G6", R01G6, Форма, "ПриложениеМЗЗ");
		
	КонецЦикла;
											
	ЗаполнитьПоказательНаСервере("MZR02G5", 0, Форма, "ПриложениеМЗЗ");
	ЗаполнитьПоказательНаСервере("MZR02G6", 0, Форма, "ПриложениеМЗЗ");
	
	Форма.мСтруктураМногострочныхРазделов.Свойство(Форма.СтруктураРеквизитовФормы.мИдГруппыMZ2, ТаблицаБлока);
	СтруктураМЗ2 = Форма[ТаблицаБлока];
	Для каждого СтрокаМЗ2 Из СтруктураМЗ2 Цикл
	
		//СтрокаМЗ2.MZT2RXXXXG6 =   ОкруглитьЧислоПоФормату(Форма, СтрокаМЗ2.MZT2RXXXXG3)
		//				  *	ОкруглитьЧислоПоФормату(Форма, СтрокаМЗ2.MZT2RXXXXG4)
		//				  *	ОкруглитьЧислоПоФормату(Форма, СтрокаМЗ2.MZT2RXXXXG5)
		//				  * Форма.СтруктураРеквизитовФормы.КоеффициентМПЗ /12;   
		
		СтрокаМЗ2.MZT2RXXXXG6 =   ОкруглитьЧислоПоФормату(Форма,СтрокаМЗ2.MZT2RXXXXG3
						  *	СтрокаМЗ2.MZT2RXXXXG4
						  *	СтрокаМЗ2.MZT2RXXXXG5
						  * Форма.СтруктураРеквизитовФормы.КоеффициентМПЗ /12);
						  
		ЗаполнитьПоказательНаСервере("MZT2RXXXXG6_"+Формат(СтруктураМЗ2.Индекс(СтрокаМЗ2) + 1, "ЧГ=;"), СтрокаМЗ2.MZT2RXXXXG6, Форма, "ПриложениеМЗЗ");

		R02G5 = ПолучитьПоказательНаСервере("MZR02G5", Форма, "ПриложениеМЗЗ") + СтрокаМЗ2.MZT2RXXXXG5;
		ЗаполнитьПоказательНаСервере("MZR02G5", R02G5, Форма, "ПриложениеМЗЗ");

		R02G6 = ПолучитьПоказательНаСервере("MZR02G6", Форма, "ПриложениеМЗЗ") + СтрокаМЗ2.MZT2RXXXXG6;
		ЗаполнитьПоказательНаСервере("MZR02G6", R02G6, Форма, "ПриложениеМЗЗ");
		
	КонецЦикла; 
	//MZR03G6 =  ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("MZR01G6", Форма, "ПриложениеМЗЗ")) 
	//  		 + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("MZR02G6", Форма, "ПриложениеМЗЗ"));
	
	MZR03G6 =  ПолучитьПоказательНаСервере("MZR01G6", Форма, "ПриложениеМЗЗ") 
  			 + ПолучитьПоказательНаСервере("MZR02G6", Форма, "ПриложениеМЗЗ");

	ЗаполнитьПоказательНаСервере("MZR03G6", MZR03G6, Форма, "ПриложениеМЗЗ");
	ЗаполнитьПоказательНаСервере("R02G3",   MZR03G6, Форма, "ПриложениеМПЗ");

	// МПЗ
	//R04G3 =  ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R02G3", Форма, "ПриложениеМПЗ")) 
	//  	   - ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R03G3", Форма, "ПриложениеМПЗ")); 
	
	R03G3 	= ПолучитьПоказательНаСервере("R031G3", Форма, "ПриложениеМПЗ")
			+ ПолучитьПоказательНаСервере("R032G3", Форма, "ПриложениеМПЗ")
			+ ПолучитьПоказательНаСервере("R033G3", Форма, "ПриложениеМПЗ")
			+ ПолучитьПоказательНаСервере("R034G3", Форма, "ПриложениеМПЗ")
			+ ПолучитьПоказательНаСервере("R035G3", Форма, "ПриложениеМПЗ")
			+ ПолучитьПоказательНаСервере("R036G3", Форма, "ПриложениеМПЗ")
			+ ПолучитьПоказательНаСервере("R037G3", Форма, "ПриложениеМПЗ");
			
	ЗаполнитьПоказательНаСервере("R03G3", R03G3, Форма, "ПриложениеМПЗ");    
	
	R04G3 =  ПолучитьПоказательНаСервере("R02G3", Форма, "ПриложениеМПЗ") 
  		   - ПолучитьПоказательНаСервере("R03G3", Форма, "ПриложениеМПЗ"); 

	ЗаполнитьПоказательНаСервере("R04G3",   R04G3, Форма, "ПриложениеМПЗ");
	ЗаполнитьПоказательНаСервере("R0062G3", R04G3, Форма, "Декларация");
		   
	//////////////////////////////////////////////////////////////////////////////////////////
	// ДИЯ
	//позитивне значення(рядок 1 - рядок 1.1 - рядок 1.2 - рядок 1.3)
	R002G3 =  ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R001G3", Форма, "ПриложениеДИЯ")) 
  		   - ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0011G3", Форма, "ПриложениеДИЯ")) 
  		   - ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0012G3", Форма, "ПриложениеДИЯ")) 
  		   - ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0013G3", Форма, "ПриложениеДИЯ")); 
	ЗаполнитьПоказательНаСервере("R002G3", ?(R002G3 > 0, R002G3, 0), Форма, "ПриложениеДИЯ");
	//позитивне значення(рядок 3 - рядок 3.1 - рядок 3.2 - рядок 4 - рядок 5)
	R006G3 =  ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R003G3", Форма, "ПриложениеДИЯ")) 
  		   - ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0031G3", Форма, "ПриложениеДИЯ")) 
  		   - ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0032G3", Форма, "ПриложениеДИЯ")) 
  		   - ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R004G3", Форма, "ПриложениеДИЯ")) 
  		   - ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R005G3", Форма, "ПриложениеДИЯ")); 
	ЗаполнитьПоказательНаСервере("R006G3", ?(R006G3 > 0, R006G3, 0), Форма, "ПриложениеДИЯ");
	//позитивне значення(рядок 7 - рядок 7.1 - рядок 7.2 - рядок 8 - рядок 9)
	R010G3 =  ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R007G3", Форма, "ПриложениеДИЯ")) 
  		   - ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0071G3", Форма, "ПриложениеДИЯ")) 
  		   - ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0072G3", Форма, "ПриложениеДИЯ")) 
  		   - ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R008G3", Форма, "ПриложениеДИЯ")) 
  		   - ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R009G3", Форма, "ПриложениеДИЯ")); 
	ЗаполнитьПоказательНаСервере("R010G3", ?(R010G3 > 0, R010G3, 0), Форма, "ПриложениеДИЯ");
	//позитивне значення(рядок 11 - рядок 11.1 - рядок 12)
	R013G3 =  ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R011G3", Форма, "ПриложениеДИЯ")) 
  		   - ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0111G3", Форма, "ПриложениеДИЯ")) 
  		   - ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R012G3", Форма, "ПриложениеДИЯ")); 
	ЗаполнитьПоказательНаСервере("R013G3", ?(R013G3 > 0, R013G3, 0), Форма, "ПриложениеДИЯ");
	//позитивне значення(рядок 14 - 14.1 - рядок 14.3)
	R015G3 =  ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R014G3", Форма, "ПриложениеДИЯ")) 
  		   - ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0141G3", Форма, "ПриложениеДИЯ")) 
  		   - ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0143G3", Форма, "ПриложениеДИЯ")); 
	ЗаполнитьПоказательНаСервере("R015G3", ?(R015G3 > 0, R015G3, 0), Форма, "ПриложениеДИЯ");
	//позитивне значення(рядок 16 - рядок 16.1 - рядок 16.2 - рядок 16.3 - рядок 16.4)
	R017G3 =  ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R016G3", Форма, "ПриложениеДИЯ")) 
  		   - ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0161G3", Форма, "ПриложениеДИЯ")) 
  		   - ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0162G3", Форма, "ПриложениеДИЯ")) 
  		   - ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0163G3", Форма, "ПриложениеДИЯ")) 
  		   - ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0164G3", Форма, "ПриложениеДИЯ")); 
	ЗаполнитьПоказательНаСервере("R017G3", ?(R017G3 > 0, R017G3, 0), Форма, "ПриложениеДИЯ");
	//позитивне значення (рядок 18 - рядок 18.1 - рядок 18.4 - рядок 18.5 - рядок 18.6 - рядок 18.7 - рядок 18.8 - рядок 18.9)			 
	R019G3 =  ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R018G3", Форма, "ПриложениеДИЯ")) 
  		   - ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0181G3", Форма, "ПриложениеДИЯ")) 
  		   - ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0184G3", Форма, "ПриложениеДИЯ")) 
  		   - ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0185G3", Форма, "ПриложениеДИЯ")) 
   		   - ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0186G3", Форма, "ПриложениеДИЯ")) 
   		   - ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0187G3", Форма, "ПриложениеДИЯ")) 
  		   - ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0188G3", Форма, "ПриложениеДИЯ")) 
		   - ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0189G3", Форма, "ПриложениеДИЯ")); 
	ЗаполнитьПоказательНаСервере("R019G3", ?(R019G3 > 0, R019G3, 0), Форма, "ПриложениеДИЯ");
	
	//(рядок 22.1 + рядок 22.2 + 
	//(позитивне значення (рядок 22.3 - рядок 22.3.1 - рядок 22.3.2 - рядок 22.3.3 - рядок 22.3.4 - рядок 22.3.5)) 
	//+ (позитивне значення (рядок 22.4 - рядок 22.4.1 - рядок 22.4.2 - рядок 22.4.3)))
	Знач1  =  ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0223G3", Форма, "ПриложениеДИЯ")) 
  		   - ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R02231G3", Форма, "ПриложениеДИЯ")) 
  		   - ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R02232G3", Форма, "ПриложениеДИЯ")) 
  		   - ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R02233G3", Форма, "ПриложениеДИЯ")) 
  		   - ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R02234G3", Форма, "ПриложениеДИЯ")) 
  		   - ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R02235G3", Форма, "ПриложениеДИЯ")); 
	Знач2  =  ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0224G3", Форма, "ПриложениеДИЯ")) 
  		   - ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R02241G3", Форма, "ПриложениеДИЯ")) 
  		   - ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R02242G3", Форма, "ПриложениеДИЯ")) 
  		   - ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R02243G3", Форма, "ПриложениеДИЯ")); 
	R023G3 =  ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0221G3", Форма, "ПриложениеДИЯ")) 
  		   +  ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0222G3", Форма, "ПриложениеДИЯ")) 
  		   + ?(Знач1 > 0, Знач1, 0) + ?(Знач2 > 0, Знач2, 0); 
	ЗаполнитьПоказательНаСервере("R023G3", R023G3, Форма, "ПриложениеДИЯ");
	
	//позитивне значення  (рядок 24 - рядок 24.1 - рядок 24.3 - рядок 24.4)			 
	R025G3 =  ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R024G3", Форма, "ПриложениеДИЯ")) 
  		   - ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0241G3", Форма, "ПриложениеДИЯ")) 
  		   - ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0243G3", Форма, "ПриложениеДИЯ")) 
  		   - ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0244G3", Форма, "ПриложениеДИЯ")); 
	ЗаполнитьПоказательНаСервере("R025G3", ?(R025G3 > 0, R025G3, 0), Форма, "ПриложениеДИЯ");
	//позитивне значення  (рядок 26 - рядок 26.1 - рядок 26.2 - рядок 26.3 - рядок 26.4)			 
	R027G3 =  ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R026G3", Форма, "ПриложениеДИЯ")) 
  		   - ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0261G3", Форма, "ПриложениеДИЯ")) 
  		   - ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0262G3", Форма, "ПриложениеДИЯ")) 
  		   - ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0263G3", Форма, "ПриложениеДИЯ")) 
  		   - ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0264G3", Форма, "ПриложениеДИЯ")); 
	ЗаполнитьПоказательНаСервере("R027G3", ?(R027G3 > 0, R027G3, 0), Форма, "ПриложениеДИЯ");
	//позитивне значення (рядок 28 - рядок 28.7 - рядок 28.8 - рядок 28.9)			 
	R029G3 =  ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R028G3", Форма, "ПриложениеДИЯ")) 
  		   - ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0287G3", Форма, "ПриложениеДИЯ")) 
  		   - ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0288G3", Форма, "ПриложениеДИЯ")) 
  		   - ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0289G3", Форма, "ПриложениеДИЯ")); 
	ЗаполнитьПоказательНаСервере("R029G3", ?(R029G3 > 0, R029G3, 0), Форма, "ПриложениеДИЯ");
	// (рядок 40 + рядок 41 + рядок 42 + рядок 43)
	R039G3 =  ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R040G3", Форма, "ПриложениеДИЯ")) 
  		   + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R041G3", Форма, "ПриложениеДИЯ")) 
   		   + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R042G3", Форма, "ПриложениеДИЯ")) 
 		   + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R043G3", Форма, "ПриложениеДИЯ")); 
	ЗаполнитьПоказательНаСервере("R039G3", R039G3, Форма, "ПриложениеДИЯ");
	
	//колонка 6: графа 3 х графа 4/100- графа 5 
	R002G6 = ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R002G3", Форма, "ПриложениеДИЯ")) * 9 / 100 
			- ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R002G5", Форма, "ПриложениеДИЯ"));
	ЗаполнитьПоказательНаСервере("R002G6", ?(R002G6 > 0, R002G6, 0), Форма, "ПриложениеДИЯ");
	R006G6 = ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R006G3", Форма, "ПриложениеДИЯ")) * 9 / 100 
			- ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R006G5", Форма, "ПриложениеДИЯ"));
	ЗаполнитьПоказательНаСервере("R006G6", ?(R006G6 > 0, R006G6, 0), Форма, "ПриложениеДИЯ");
	R010G6 = ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R010G3", Форма, "ПриложениеДИЯ")) * 9 / 100 
			- ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R010G5", Форма, "ПриложениеДИЯ"));
	ЗаполнитьПоказательНаСервере("R010G6", ?(R010G6 > 0, R010G6, 0), Форма, "ПриложениеДИЯ");
	R013G6 = ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R013G3", Форма, "ПриложениеДИЯ")) * 9 / 100 
			- ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R013G5", Форма, "ПриложениеДИЯ"));
	ЗаполнитьПоказательНаСервере("R013G6", ?(R013G6 > 0, R013G6, 0), Форма, "ПриложениеДИЯ");
	R015G6 = ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R015G3", Форма, "ПриложениеДИЯ")) * 9 / 100 
			- ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R015G5", Форма, "ПриложениеДИЯ"));
	ЗаполнитьПоказательНаСервере("R015G6", ?(R015G6 > 0, R015G6, 0), Форма, "ПриложениеДИЯ");
	R017G6 = ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R017G3", Форма, "ПриложениеДИЯ")) * 9 / 100 
			- ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R017G5", Форма, "ПриложениеДИЯ"));
	ЗаполнитьПоказательНаСервере("R017G6", ?(R017G6 > 0, R017G6, 0), Форма, "ПриложениеДИЯ");
	R019G6 = ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R019G3", Форма, "ПриложениеДИЯ")) * 9 / 100 
			- ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R019G5", Форма, "ПриложениеДИЯ"));
	ЗаполнитьПоказательНаСервере("R019G6", ?(R019G6 > 0, R019G6, 0), Форма, "ПриложениеДИЯ");
	R020G6 = ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R020G3", Форма, "ПриложениеДИЯ")) * 9 / 100 
			- ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R020G5", Форма, "ПриложениеДИЯ"));
	ЗаполнитьПоказательНаСервере("R020G6", ?(R020G6 > 0, R020G6, 0), Форма, "ПриложениеДИЯ");
	R021G6 = ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R021G3", Форма, "ПриложениеДИЯ")) * 9 / 100 
			- ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R021G5", Форма, "ПриложениеДИЯ"));
	ЗаполнитьПоказательНаСервере("R021G6", ?(R021G6 > 0, R021G6, 0), Форма, "ПриложениеДИЯ");
	R023G6 = ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R023G3", Форма, "ПриложениеДИЯ")) * 9 / 100 
			- ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R023G5", Форма, "ПриложениеДИЯ"));
	ЗаполнитьПоказательНаСервере("R023G6", ?(R023G6 > 0, R023G6, 0), Форма, "ПриложениеДИЯ");
	R025G6 = ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R025G3", Форма, "ПриложениеДИЯ")) * 9 / 100 
			- ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R025G5", Форма, "ПриложениеДИЯ"));
	ЗаполнитьПоказательНаСервере("R025G6", ?(R025G6 > 0, R025G6, 0), Форма, "ПриложениеДИЯ");
	R027G6 = ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R027G3", Форма, "ПриложениеДИЯ")) * 9 / 100 
			- ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R027G5", Форма, "ПриложениеДИЯ"));
	ЗаполнитьПоказательНаСервере("R027G6", ?(R027G6 > 0, R027G6, 0), Форма, "ПриложениеДИЯ");
	R029G6 = ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R029G3", Форма, "ПриложениеДИЯ")) * 9 / 100 
			- ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R029G5", Форма, "ПриложениеДИЯ"));
	ЗаполнитьПоказательНаСервере("R029G6", ?(R029G6 > 0, R029G6, 0), Форма, "ПриложениеДИЯ");
	R030G6 = ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R030G3", Форма, "ПриложениеДИЯ")) * 9 / 100 
			- ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R030G5", Форма, "ПриложениеДИЯ"));
	ЗаполнитьПоказательНаСервере("R030G6", ?(R030G6 > 0, R030G6, 0), Форма, "ПриложениеДИЯ");
	R031G6 = ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R031G3", Форма, "ПриложениеДИЯ")) * 9 / 100 
			- ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R031G5", Форма, "ПриложениеДИЯ"));
	ЗаполнитьПоказательНаСервере("R031G6", ?(R031G6 > 0, R031G6, 0), Форма, "ПриложениеДИЯ");
	R032G6 = ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R032G3", Форма, "ПриложениеДИЯ")) * 9 / 100 
			- ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R032G5", Форма, "ПриложениеДИЯ"));
	ЗаполнитьПоказательНаСервере("R032G6", ?(R032G6 > 0, R032G6, 0), Форма, "ПриложениеДИЯ");
	R033G6 = ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R033G3", Форма, "ПриложениеДИЯ")) * 9 / 100 
			- ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R033G5", Форма, "ПриложениеДИЯ"));
	ЗаполнитьПоказательНаСервере("R033G6", ?(R033G6 > 0, R033G6, 0), Форма, "ПриложениеДИЯ");
	R034G6 = ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R034G3", Форма, "ПриложениеДИЯ")) * 9 / 100 
			- ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R034G5", Форма, "ПриложениеДИЯ"));
	ЗаполнитьПоказательНаСервере("R034G6", ?(R034G6 > 0, R034G6, 0), Форма, "ПриложениеДИЯ");
	R035G6 = ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R035G3", Форма, "ПриложениеДИЯ")) * 9 / 100 
			- ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R035G5", Форма, "ПриложениеДИЯ"));
	ЗаполнитьПоказательНаСервере("R035G6", ?(R035G6 > 0, R035G6, 0), Форма, "ПриложениеДИЯ");
	R036G6 = ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R036G3", Форма, "ПриложениеДИЯ")) * 9 / 100 
			- ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R036G5", Форма, "ПриложениеДИЯ"));
	ЗаполнитьПоказательНаСервере("R036G6", ?(R036G6 > 0, R036G6, 0), Форма, "ПриложениеДИЯ");
	R037G6 = ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R037G3", Форма, "ПриложениеДИЯ")) * 18 / 100 
			- ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R037G5", Форма, "ПриложениеДИЯ"));
	ЗаполнитьПоказательНаСервере("R037G6", ?(R037G6 > 0, R037G6, 0), Форма, "ПриложениеДИЯ");
	R038G6 = ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R038G3", Форма, "ПриложениеДИЯ")) * 18 / 100 
			- ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R038G5", Форма, "ПриложениеДИЯ"));
	ЗаполнитьПоказательНаСервере("R038G6", ?(R038G6 > 0, R038G6, 0), Форма, "ПриложениеДИЯ");
	R039G6 = ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R039G3", Форма, "ПриложениеДИЯ")) * 9 / 100; 
	ЗаполнитьПоказательНаСервере("R039G6", R039G6, Форма, "ПриложениеДИЯ");
	
	R044G6 =  ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R002G6", Форма, "ПриложениеДИЯ")) 
										 + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R006G6", Форма, "ПриложениеДИЯ")) 	
										 + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R010G6", Форма, "ПриложениеДИЯ")) 	
										 + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R013G6", Форма, "ПриложениеДИЯ")) 	
										 + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R015G6", Форма, "ПриложениеДИЯ")) 	
										 + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R017G6", Форма, "ПриложениеДИЯ")) 
										 + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R019G6", Форма, "ПриложениеДИЯ")) 
										 + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R020G6", Форма, "ПриложениеДИЯ")) 
										 + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R021G6", Форма, "ПриложениеДИЯ")) 
										 + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R023G6", Форма, "ПриложениеДИЯ")) 
										 + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R025G6", Форма, "ПриложениеДИЯ")) 
										 + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R027G6", Форма, "ПриложениеДИЯ")) 
										 + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R029G6", Форма, "ПриложениеДИЯ")) 
										 + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R030G6", Форма, "ПриложениеДИЯ")) 
										 + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R031G6", Форма, "ПриложениеДИЯ")) 
										 + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R032G6", Форма, "ПриложениеДИЯ")) 
										 + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R033G6", Форма, "ПриложениеДИЯ")) 
										 + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R034G6", Форма, "ПриложениеДИЯ")) 
										 + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R035G6", Форма, "ПриложениеДИЯ")) 
										 + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R036G6", Форма, "ПриложениеДИЯ")) 
										 + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R037G6", Форма, "ПриложениеДИЯ")) 
										 + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R038G6", Форма, "ПриложениеДИЯ")) 
										 + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R039G6", Форма, "ПриложениеДИЯ"));
										 
	ЗаполнитьПоказательНаСервере("R044G6", R044G6, Форма, "ПриложениеДИЯ");
	ЗаполнитьПоказательНаСервере("R0063G3", R044G6, Форма, "Декларация");
	...
	//ЗП       
	Если ИмяСтраницыПанели = "ПриложениеОВ" или ИмяСтраницыПанели = "ПриложениеКИК" или ИмяСтраницыПанели = "Декларация" Тогда   
		
		R026G4ОВ = ПолучитьПоказательНаСервере("R026G4", Форма, "ПриложениеОВ");  
		R0165G3_предел  = ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R006G3", Форма, "Декларация"))
			+ ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0061G3", Форма, "Декларация"))
			- ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R01641G3", Форма, "ПриложениеЗП")); 
		
		ЗаполнитьПоказательНаСервере("R0165G3", Мин(R026G4ОВ,R0165G3_предел), Форма, "ПриложениеЗП");   
		
	КонецЕсли; 
	
	R0165G3 = ПолучитьПоказательНаСервере("R0165G3", Форма, "ПриложениеЗП");  
	R0165G3_предел  = ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R006G3", Форма, "Декларация"))
		+ ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0061G3", Форма, "Декларация"))
		- ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R01641G3", Форма, "ПриложениеЗП")); 
		
	R0165G3 = Мин(R0165G3,R0165G3_предел);
	Если R0165G3 < 0 Тогда
		R0165G3 = 0;
	КонецЕсли;
	ЗаполнитьПоказательНаСервере("R0165G3", R0165G3, Форма, "ПриложениеЗП");     
	...
	R017G3 =  ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R006G3", Форма, "Декларация")) 
										 + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0061G3", Форма, "Декларация")) 	
										 + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0062G3", Форма, "Декларация")) 	
										 + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0063G3", Форма, "Декларация")) 	
										 + ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R0064G3", Форма, "Декларация")) 	
	...
	Если ЗначениеЗаполнено(ПолучитьПоказательНаСервере("HZU", Форма, "Декларация"))Тогда
		...
		R033G3  =  ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R029G3", Форма, "Декларация"))* 0.03;
		ЗаполнитьПоказательНаСервере("R033G3", R033G3, Форма, "Декларация");
		R037G3  =  ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R034G3", Форма, "Декларация"))* 0.03;
		ЗаполнитьПоказательНаСервере("R037G3", R037G3, Форма, "Декларация");
		R041G3  =  ОкруглитьЧислоПоФормату(Форма, ПолучитьПоказательНаСервере("R038G3", Форма, "Декларация"))* 0.03;
		ЗаполнитьПоказательНаСервере("R041G3", R041G3, Форма, "Декларация");
	...
	Иначе
		...
		ЗаполнитьПоказательНаСервере("R031G3", ПолучитьПоказательНаСервере("R031G3", Форма, "ПриложениеВП"), Форма, "Декларация");
		ЗаполнитьПоказательНаСервере("R032G3", ПолучитьПоказательНаСервере("R032G3", Форма, "ПриложениеВП"), Форма, "Декларация");
		ЗаполнитьПоказательНаСервере("R033G3", 0, Форма, "Декларация");
		
		ЗаполнитьПоказательНаСервере("R034G3", ПолучитьПоказательНаСервере("R033G3", Форма, "ПриложениеВП"), Форма, "Декларация");
		ЗаполнитьПоказательНаСервере("R035G3", ПолучитьПоказательНаСервере("R034G3", Форма, "ПриложениеВП"), Форма, "Декларация");
		ЗаполнитьПоказательНаСервере("R036G3", ПолучитьПоказательНаСервере("R035G3", Форма, "ПриложениеВП"), Форма, "Декларация");
		ЗаполнитьПоказательНаСервере("R037G3", 0, Форма, "Декларация");
		
		ЗаполнитьПоказательНаСервере("R038G3", ПолучитьПоказательНаСервере("R036G3", Форма, "ПриложениеВП"), Форма, "Декларация");
		ЗаполнитьПоказательНаСервере("R039G3", ПолучитьПоказательНаСервере("R037G3", Форма, "ПриложениеВП"), Форма, "Декларация");
		ЗаполнитьПоказательНаСервере("R040G3", ПолучитьПоказательНаСервере("R038G3", Форма, "ПриложениеВП"), Форма, "Декларация");
		ЗаполнитьПоказательНаСервере("R041G3", 0, Форма, "Декларация");
	КонецЕсли;	
...
Процедура ОбработкаВыбораВПолеТабличногоДокумента(Элемент, Область, СтандартнаяОбработка)
   ...
   ИначеЕсли ИмяЯчейки = "HHY1"     //Приложение АМ
	...
	ИначеЕсли ВРЕГ(ИмяЯчейки) = "H091" Тогда
		...
		СтруктураРеквизитовФормы.H091 = ТабличныйДокумент.Области[ИмяЯчейки].Значение;	

	ИначеЕсли ВРЕГ(Лев(ИмяЯчейки, 3)) = "H09"
						ИЛИ ИмяЯчейки = "HLIQ" ИЛИ ИмяЯчейки = "H01G3" 
						ИЛИ (ИмяЯчейки = "H01" И НЕ НаименованиеТекЛиста = "Декларация" И НЕ НаименованиеТекЛиста = "ПриложениеМПЗ")
						ИЛИ (ИмяЯчейки = "R01G6" И НаименованиеТекЛиста = "ПриложениеПН")
						ИЛИ (ИмяЯчейки = "R01G7" И НаименованиеТекЛиста = "ПриложениеПН")
	...
	ИначеЕсли (ИмяЯчейки = "H01" И НаименованиеТекЛиста = "ПриложениеМПЗ") Тогда
	...
	ИначеЕсли ВРЕГ(Лев(ИмяЯчейки, 4))  = "HTEL"
	  ...
	  ИначеЕсли (ВРЕГ(Лев(ИмяЯчейки, 5))  = "H01G2" и НЕ ВРЕГ(ИмяЯчейки)  = "H01G2S") 
				ИЛИ (ВРЕГ(Лев(ИмяЯчейки, 5)) = "R01G4" И НаименованиеТекЛиста = "ПриложениеПН")   Тогда
	...
	ИначеЕсли Найти(ИмяЯчейки, "R071G2S") > 0 или Найти(ИмяЯчейки, "R071G3S") > 0 Тогда
	  ...
	  ИначеЕсли ВРЕГ(Лев(ИмяЯчейки, 6))  = "R01G5S" И НаименованиеТекЛиста = "ПриложениеПН" Тогда
		...
		ОписаниеОповещения = Новый ОписаниеОповещения("ВводПоказателяВПолеТабличногоДокументЗавершение",
													   ЭтаФорма, Новый Структура("ИмяЯчейки, ИмяСтраницы,
																				 |ИмяЯчейкиКвадратов, ИмяСтраницыКвадратов, 
																				 |Размерность, ДополнитьЗначение, НольКакНоль", 
																				 ИмяОбластиЗначения,  "ПриложениеПН",
																				 ИмяОбластиЗначения + "_", "ПриложениеПН",
																				 15, Ложь, Неопределено));
		
		ПоказатьВводСтроки(ОписаниеОповещения,Значение, НСтр("ru='Введите значение';uk='Введіть значення'"), 15);
		                                
										
	ИначеЕсли Лев(ИмяЯчейки,2) = "HD" И НЕ ИмяЯчейки = "HD3" И НЕ ИмяЯчейки = "HD13" Тогда  
		  	
		ТабличныйДокумент.Области[ИмяЯчейки].Значение = ?(ЗначениеЗаполнено(ТабличныйДокумент.Области[ИмяЯчейки].Значение), "", "+");
		Если ЗначениеЗаполнено(ПолучитьПоказательНаСервере("H091", ЭтаФорма, "Декларация")) Тогда
			ТабличныйДокумент.Области.HD15.Значение = "";
			ТабличныйДокумент.Области.HD16.Значение = "";
		КонецЕсли; 
...
Процедура ОбработкаИзмененияСодержимогоВПолеТабличногоДокумента(Элемент, Область)
	...
	Если ИмяРаздела = "Декларация" Тогда
		Если    ИмяОбласти = "HTIN" 
			...
			СтруктураДанныхПриложениеМПЗ[ИмяОбласти] = ТабличныйДокумент.Области[ИмяОбласти].Значение;
			СтруктураДанныхПриложениеМЗЗ[ИмяОбласти] = ТабличныйДокумент.Области[ИмяОбласти].Значение;
			СтруктураДанныхПриложениеДИЯ[ИмяОбласти] = ТабличныйДокумент.Области[ИмяОбласти].Значение;
			СтруктураДанныхПриложениеОВ[ИмяОбласти] = ТабличныйДокумент.Области[ИмяОбласти].Значение;
...
Процедура ОчиститьНаСервере() Экспорт
	...
	СтруктураДанныхПриложениеМПЗ.Очистить();
	СтруктураДанныхПриложениеМЗЗ.Очистить();
	СтруктураДанныхПриложениеДИЯ.Очистить();
	СтруктураДанныхПриложениеОВ.Очистить();
...
Процедура Заполнить(ПараметрыЗаполненияЗвит1С)
	...
	ФлПерехода = Ложь;
	ФлДвухПериодов = Ложь;
	//не было перехода на ЕН 2%, обычный отчет
	ДатаНачала1 = СтруктураРеквизитовФормы.мДатаНачалаПериодаОтчета; 
	ДатаОкончания1 = СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета;
	
	Если ЗначениеЗаполнено(СтруктураРеквизитовФормы.ДатаНачалаНаЕдиномНалоге) 
		ИЛИ ЗначениеЗаполнено(СтруктураРеквизитовФормы.ДатаОкончанияНаЕдиномНалоге) Тогда
		//был переход на ЕН 2%
		ФлПерехода = Истина;
		
		ДатаНачалаЕН    = СтруктураРеквизитовФормы.мДатаНачалаПериодаОтчета;
		ДатаОкончанияЕН = СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета;
		Если ЗначениеЗаполнено(СтруктураРеквизитовФормы.ДатаНачалаНаЕдиномНалоге) Тогда
			//был переход на ЕН 2%
			ДатаНачалаЕН = Макс(НачалоДня(СтруктураРеквизитовФормы.ДатаНачалаНаЕдиномНалоге), ДатаНачалаЕН);
		КонецЕсли;	
		Если ЗначениеЗаполнено(СтруктураРеквизитовФормы.ДатаОкончанияНаЕдиномНалоге) Тогда
			//был переход с ЕН 2%
			ДатаОкончанияЕН = Мин(КонецДня(СтруктураРеквизитовФормы.ДатаОкончанияНаЕдиномНалоге),ДатаОкончанияЕН);
		КонецЕсли;
		Если ДатаНачалаЕН <> СтруктураРеквизитовФормы.мДатаНачалаПериодаОтчета 
			 И ДатаОкончанияЕН <> СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета Тогда
			 
			//два периода заполнения
			ФлДвухПериодов = Истина;
			ДатаНачала1 = СтруктураРеквизитовФормы.мДатаНачалаПериодаОтчета; 
			ДатаОкончания1 = КонецДня(ДатаНачалаЕН-86400);
			//2-й
			ДатаНачала2 = НачалоДня(ДатаОкончанияЕН+86400); 
			ДатаОкончания2 = СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета;
			
		ИначеЕсли ДатаНачалаЕН <> СтруктураРеквизитовФормы.мДатаНачалаПериодаОтчета Тогда
			ДатаНачала1 = СтруктураРеквизитовФормы.мДатаНачалаПериодаОтчета; 
			ДатаОкончания1 = КонецДня(ДатаНачалаЕН-86400);
		ИначеЕсли ДатаОкончанияЕН < СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета Тогда
			ДатаНачала1 = НачалоДня(ДатаОкончанияЕН+86400); 
			ДатаОкончания1 = СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета;
		КонецЕсли;	
	КонецЕсли;	
	...
	Если РегламентированнаяОтчетностьПереопределяемый.ИДКонфигурации() = "БП"  ИЛИ РегламентированнаяОтчетностьПереопределяемый.ИДКонфигурации() = "БСП"  // ИНАГРО
		или РегламентированнаяОтчетностьПереопределяемый.ИДКонфигурации(Истина) = "ERP25" Тогда
		НалогНаПрибыльБезКорректировокФинансовогоРезультата = УчетнаяПолитика.НалогНаПрибыльБезКорректировокФинансовогоРезультата(СтруктураРеквизитовФормы.Организация, ?(ФлДвухПериодов, ДатаОкончания2, ДатаОкончания1));
	Иначе
		ПараметрыУчетнойПолитики = РегистрыСведений.УчетнаяПолитикаОрганизаций.ПараметрыУчетнойПолитики(СтруктураРеквизитовФормы.Организация, ?(ФлДвухПериодов, ДатаОкончания2, ДатаОкончания1));
	...
	Если ФлПерехода Тогда
		//можем заполнить только из предприятия
		ТекстСообщения = НСтр("ru='Из-за перехода на Единый налог 2% строки 01 и 02 Декларации будут заполнены 
									|по данным бухучета, а не из сохраненного отчета о финансовом состоянии.';uk= 'Через перехід на Єдиний податок 2% рядки 01 та 02 Декларації будуть заповнені 
									|за даними бухобліку , а не зі збереженого звіту про фінансовий стан.'");
		...
		КонецЕсли;
		ЗаполнитьДанныеФинОтчетностиВП(1);
		Если ФлДвухПериодов Тогда
			ЗаполнитьДанныеФинОтчетностиВП(2);
		КонецЕсли;	
	Иначе	
	...
	Если ЮрЛицо Тогда
		...
		Если НалогНаПрибыльБезКорректировокФинансовогоРезультата = Ложь Тогда
			Если ФлПерехода Тогда
				ЗаполнитьПриложениеРИ_АМ_ТЦ(1);
				Если ФлДвухПериодов Тогда
					ЗаполнитьПриложениеРИ_АМ_ТЦ(2);
				Иначе
					ЗаполнитьПриложениеРИ_АМ_ТЦ(3);
				КонецЕсли;	
			Иначе	
		...
		// Приложение ЗП
		Если ФлПерехода Тогда
			ЗаполнитьПриложениеЗП(1);
			Если ФлДвухПериодов Тогда
				ЗаполнитьПриложениеЗП(2);
			КонецЕсли;	
		Иначе	
		...
		Для каждого ДанныеКИК Из ЭтаФорма.ТаблицаСтраницыРаздела2 Цикл
			ДанныеКИК.Данные[0].Значение.Вставить("R04G1", Ставка)
		КонецЦикла; 
		
		///////////////////////////////////////////////////////////////////////////
		// МЗЗ 
		Если ИНАГРО_ОбщийВызовСервераПовтИсп.ЕстьБСПУ() Тогда
			ЗаполнитьМЗЗ(ПараметрыЗаполненияЗвит1С);
		КонецЕсли;
...
&НаСервере
Процедура ЗаполнитьДанныеФинОтчетностиВП(НомерПериода)
	
	Если НомерПериода = 1 Тогда
		ДатаНачала = ДатаНачала1;
		ДатаКонца = ДатаОкончания1;
	ИначеЕсли НомерПериода = 2 Тогда
		ДатаНачала = ДатаНачала2;
		ДатаКонца = ДатаОкончания2;
	Иначе	
		ДатаНачала = СтруктураРеквизитовФормы.мДатаНачалаПериодаОтчета;
		ДатаКонца = СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета;
	КонецЕсли;
	...
	мБухИтоги.РассчитатьИтоги("Хозрасчетный", Итоги, "Сумма", "Счет,КорСчет", ДатаНачала, ДатаКонца, , , , , , "Организация", СтруктураРеквизитовФормы.Организация);
	
	Если СтруктураРеквизитовФормы.ВидФинОтчетности = 0 Тогда
		//финрез
		R001G3 = КО(Счет70_1) + КО(Счет70_2) + КО(Счет70_3) + КО(Счет70_9_1) + КО(Счет71) + КО(Счет72) + КО(Счет73)
				+ КО(Счет74) - ОБ(Счет70_9_1,Счет70) - ОБ(Счет70, Счет70_9_1) - ОБ(Счет70_1,Счет64) - ОБ(Счет70_2,Счет64)   
				- ОБ(Счет70_3,Счет64) - ОБ(Счет70_9_1,Счет64) - ОБ(Счет70,Счет36) - ОБ(Счет70,Счет30)    
				- ОБ(Счет70,Счет68_5) - ОБ(Счет70_4, Счет37_7) - ОБ(Счет70_4, Счет63)- ОБ(Счет70_4,Счет64) 
				+ ОБ(Счет64, Счет70_4)  + ОБ(Счет30,Счет70_4) - ОБ(Счет71,Счет64) - ОБ(Счет74,Счет64);	
				
				
		_ДобавитьСтрокуРасшифровки( ЭтаФорма,"R001G3", "Показник 01 Декларації",	"+", "!КО",КО(Счет70_1), Счет70_1,,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма,"R001G3", "",	"+", "!КО",КО(Счет70_2),Счет70_2,,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма,"R001G3", "",	"+", "!КО",КО(Счет70_3),Счет70_3,,ДатаНачала, ДатаКонца, "Декларация");
		
		_ДобавитьСтрокуРасшифровки( ЭтаФорма,"R001G3", "",	"+", "!КО",КО(Счет70_9_1),Счет70_9_1,,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма,"R001G3", "",	"-", "!ОБ",ОБ(Счет70_9_1,Счет70),Счет70_9_1, Счет70,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма,"R001G3", "",	"-", "!ОБ",ОБ(Счет70,Счет70_9_1),Счет70, Счет70_9_1,ДатаНачала, ДатаКонца, "Декларация");
		
		_ДобавитьСтрокуРасшифровки( ЭтаФорма,"R001G3", "",	"-", "!ОБ",ОБ(Счет70_1,Счет64),Счет70_1,Счет64,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма,"R001G3", "",	"-", "!ОБ",ОБ(Счет70_2,Счет64),Счет70_2,Счет64,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма,"R001G3", "",	"-", "!ОБ",ОБ(Счет70_3,Счет64),Счет70_3,Счет64,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма,"R001G3", "",	"-", "!ОБ",ОБ(Счет70_9_1,Счет64),Счет70_9_1,Счет64,ДатаНачала, ДатаКонца, "Декларация");
		
		_ДобавитьСтрокуРасшифровки( ЭтаФорма,"R001G3", "",	"-", "!ОБ",ОБ(Счет70,Счет36),Счет70,Счет36,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма,"R001G3", "",	"-", "!ОБ",ОБ(Счет70,Счет30),Счет70,Счет30,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма,"R001G3", "",	"-", "!ОБ",ОБ(Счет70,Счет68_5),Счет70,Счет68_5,ДатаНачала, ДатаКонца, "Декларация");
		
		_ДобавитьСтрокуРасшифровки( ЭтаФорма,"R001G3", "",	"-", "!ОБ",ОБ(Счет70_4,Счет37_7),Счет70_4,Счет37_7,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма,"R001G3", "",	"-", "!ОБ",ОБ(Счет70_4,Счет63),Счет70_4,Счет63,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма,"R001G3", "",	"-", "!ОБ",ОБ(Счет70_4,Счет64),Счет70_4,Счет64,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма,"R001G3", "",	"+", "!ОБ",ОБ(Счет64,Счет70_4),Счет64,Счет70_4,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма,"R001G3", "",	"+", "!ОБ",ОБ(Счет30,Счет70_4),Счет30,Счет70_4,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма,"R001G3", "",	"+", "!КО",КО(Счет71), Счет71,,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма,"R001G3", "",	"-", "!ОБ",ОБ(Счет71,Счет64),Счет71,Счет64,ДатаНачала, ДатаКонца, "Декларация");	
		_ДобавитьСтрокуРасшифровки( ЭтаФорма,"R001G3", "",	"+", "!КО",КО(Счет72), Счет72,,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма,"R001G3", "",	"+", "!КО",КО(Счет73), Счет73,,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма,"R001G3", "",	"+", "!КО",КО(Счет74), Счет74,,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма,"R001G3", "",	"-", "!ОБ",ОБ(Счет74,Счет64),Счет74,Счет64,ДатаНачала, ДатаКонца, "Декларация");	
		
		Вал3 = R001G3 - (ДО(Счет90_1) + ДО(Счет90_2) + ДО(Счет90_3) + ДО(Счет90_4));
		
		ДоходОперДеят3 = Вал3  	- (ДО(Счет92) + ДО(Счет93) + ДО(Счет94));
		
		R002G3 = ДоходОперДеят3 - (ДО(Счет95) + ДО(Счет96) + ДО(Счет97));
		
		
		_ДобавитьСтрокуРасшифровки( ЭтаФорма,"R002G3", "Показник 02 Декларації",	"+", "Значення рядка 01",R001G3, ,,, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма,"R002G3", "",	"-", "!ДО",ДО(Счет90_1), Счет90_1,,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма,"R002G3", "",	"-", "!ДО",ДО(Счет90_2), Счет90_2,,ДатаНачала, ДатаКонца, "Декларация");	
		_ДобавитьСтрокуРасшифровки( ЭтаФорма,"R002G3", "",	"-", "!ДО",ДО(Счет90_3), Счет90_3,,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма,"R002G3", "",	"-", "!ДО",ДО(Счет90_4), Счет90_4,,ДатаНачала, ДатаКонца, "Декларация");
		
		_ДобавитьСтрокуРасшифровки( ЭтаФорма,"R002G3", "",	"-", "!ДО",ДО(Счет92), Счет92,,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма,"R002G3", "",	"-", "!ДО",ДО(Счет93), Счет93,,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма,"R002G3", "",	"-", "!ДО",ДО(Счет94), Счет94,,ДатаНачала, ДатаКонца, "Декларация");
		
		_ДобавитьСтрокуРасшифровки( ЭтаФорма,"R002G3", "",	"-", "!ДО",ДО(Счет95), Счет95,,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма,"R002G3", "",	"-", "!ДО",ДО(Счет96), Счет96,,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма,"R002G3", "",	"-", "!ДО",ДО(Счет97), Счет97,,ДатаНачала, ДатаКонца, "Декларация");
		
	
	Иначе	//МПС и МП
		
		R001G3 = КО(Счет70_1) + КО(Счет70_2) + КО(Счет70_3) + КО(Счет70_9_1) + КО(Счет71) + КО(Счет72) + КО(Счет73)
				+ КО(Счет74) - ОБ(Счет70_9_1,Счет70_1) - ОБ(Счет70_9_1,Счет70_2) - ОБ(Счет70_9_1,Счет70_3) 
				- ОБ(Счет70,Счет70_9_1)	 - ОБ(Счет70, Счет64_1) - ОБ(Счет70, Счет64_2) - ОБ(Счет70, Счет64_3) 
				- ОБ(Счет70,Счет36)	- ОБ(Счет70, Счет30) - ОБ(Счет70, Счет31) - ОБ(Счет70, Счет68_5) - ОБ(Счет70_4, Счет63)
				+ ОБ(Счет30, Счет70_4) + ОБ(Счет31, Счет70_4) + ОБ(Счет64_3, Счет70_4) + ОБ(Счет64_4, Счет70_4)
				- ОБ(Счет71,Счет64_1) - ОБ(Счет71,Счет64_3)- ОБ(Счет74,Счет64_1) - ОБ(Счет74,Счет64_3);
							
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "R001G3", "Показник 01 Декларації",	"+", "!КО",КО(Счет70_1), Счет70_1,,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "R001G3", "",	"+", "!КО",КО(Счет70_2),Счет70_2,,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "R001G3", "",	"+", "!КО",КО(Счет70_3),Счет70_3,,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "R001G3", "",	"+", "!КО",КО(Счет70_9_1),Счет70_9_1,,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "R001G3", "",	"-", "!ОБ",ОБ(Счет70_9_1,Счет70_1),Счет70_9_1, Счет70_1,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "R001G3", "",	"-", "!ОБ",ОБ(Счет70_9_1,Счет70_2),Счет70_9_1, Счет70_2,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "R001G3", "",	"-", "!ОБ",ОБ(Счет70_9_1,Счет70_3),Счет70_9_1, Счет70_3,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "R001G3", "",	"-", "!ОБ",ОБ(Счет70,Счет70_9_1),Счет70, Счет70_9_1,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "R001G3", "",	"-", "!ОБ",ОБ(Счет70, Счет64_1), Счет70_1, Счет64_1,ДатаНачала, ДатаКонца, "Декларация");	
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "R001G3", "",	"-", "!ОБ",ОБ(Счет70, Счет64_2),Счет70, Счет64_2,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "R001G3", "",	"-", "!ОБ",ОБ(Счет70, Счет64_3),Счет70, Счет64_3,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "R001G3", "",	"-", "!ОБ",ОБ(Счет70, Счет36),Счет70, Счет36,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "R001G3", "",	"-", "!ОБ",ОБ(Счет70, Счет30),Счет70, Счет30,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "R001G3", "",	"-", "!ОБ",ОБ(Счет70, Счет31),Счет70, Счет31,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "R001G3", "",	"-", "!ОБ",ОБ(Счет70, Счет68_5),Счет70, Счет68_5,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "R001G3", "",	"+", "!ОБ",ОБ(Счет30, Счет70_4),Счет30, Счет70_4,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "R001G3", "",	"+", "!ОБ",ОБ(Счет31, Счет70_4),Счет31, Счет70_4,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "R001G3", "",	"-", "!ОБ",ОБ(Счет70_4, Счет63),Счет70_4, Счет63,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "R001G3", "",	"+", "!ОБ",ОБ(Счет64_3, Счет70_4),Счет64_3, Счет70_4,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "R001G3", "",	"+", "!ОБ",ОБ(Счет64_4, Счет70_4),Счет64_4, Счет70_4,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "R001G3", "",	"+", "!КО",КО(Счет71), Счет71,,ДатаНачала, ДатаКонца, "Декларация");	
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "R001G3", "",	"-", "!ОБ",ОБ(Счет71,Счет64_1),Счет71,Счет64_1,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "R001G3", "",	"-", "!ОБ",ОБ(Счет71,Счет64_3),Счет71,Счет64_3,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "R001G3", "",	"+", "!КО",КО(Счет72),Счет72,,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "R001G3", "",	"+", "!КО",КО(Счет73),Счет73,,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "R001G3", "",	"+", "!КО",КО(Счет74),Счет74,,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "R001G3", "",	"-", "!ОБ",ОБ(Счет74,Счет64_1),Счет74, Счет64_1,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "R001G3", "",	"-", "!ОБ",ОБ(Счет74,Счет64_3),Счет74,Счет64_3,ДатаНачала, ДатаКонца, "Декларация");
	
		R002G3 = R001G3 - ((ДО(Счет92) + ДО(Счет93) + ДО(Счет94) + ДО(Счет95) + ДО(Счет96) + ДО(Счет97)) + ДО(Счет90));
		
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "R002G3", "Показник 02 Декларації",	"+", "Значення рядка 01",R001G3, ,,, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "R002G3", "",	"-", "!ДО",ДО(Счет90), Счет90,,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "R002G3", "",	"-", "!ДО",ДО(Счет92), Счет92,,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "R002G3", "",	"-", "!ДО",ДО(Счет93), Счет93,,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "R002G3", "",	"-", "!ДО",ДО(Счет94), Счет94,,ДатаНачала, ДатаКонца, "Декларация");
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "R002G3", "",	"-", "!ДО",ДО(Счет95), Счет95,,ДатаНачала, ДатаКонца, "Декларация");
	...
	КонецЕсли;		
	СтруктураДанныхДекларация.R001G3 = СтруктураДанныхДекларация.R001G3 + R001G3;
	СтруктураДанныхДекларация.R002G3 = СтруктураДанныхДекларация.R002G3 + ОкруглитьЧислоПоФорматуФИН(R002G3);
	
КонецПроцедуры

&НаСервере
Процедура ЗаполнитьПриложениеРИ_АМ_ТЦ(НомерПериода = 0)
	...
	Если НомерПериода = 1 Тогда
		ДатаНачала = НачалоМесяца(ДатаНачала1);
		ДатаКонца = КонецМесяца(ДатаОкончания1);
	ИначеЕсли НомерПериода = 2 Тогда
		ДатаНачала = НачалоМесяца(ДатаНачала2);
		ДатаКонца = КонецМесяца(ДатаОкончания2);
	Иначе	
		ДатаНачала = СтруктураРеквизитовФормы.мДатаНачалаПериодаОтчета;
		ДатаКонца = СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета;
	КонецЕсли;
   ...
   // Списание    = Кт оборот 10,11,12,286 - не в корр с 10,11,12,13,286 при условии, что на конец приода нет остатка по этим счетам учета (по Дт)
	...
	ИДКонERP25 = РегламентированнаяОтчетностьПереопределяемый.ИДКонфигурации(Истина);		
		
	Запрос.Текст = "ВЫБРАТЬ
	               |	СведенияГруппа.ОсновноеСредство КАК НеоборотныйАктив,
	               |	СведенияГруппа.НалоговаяГруппаОС КАК Группа,
	               |   " + ?(ИДКонERP25 = "ERP25", " СведенияГруппа."," СведенияНалНазначение.")+"НалоговоеНазначение КАК НалоговоеНазначение
	               |ПОМЕСТИТЬ Сведения
	               |ИЗ
	               |	РегистрСведений." + ?(ИДКонERP25 = "ERP25", "ПорядокУчетаОСБУ.","ПервоначальныеСведенияОСНалоговыйУчет.")+"СрезПоследних(&ДатаКон, Организация = &Организация) КАК СведенияГруппа
				   |     " + ?(НЕ ИДКонERP25 = "ERP25", " ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.НалоговыеНазначенияОС.СрезПоследних(&ДатаКон, Организация = &Организация) КАК СведенияНалНазначение
	               ...
	               |ИЗ
	               |	РегистрСведений." + ?(ИДКонERP25 = "ERP25", "ПорядокУчетаНМАБУ.","ПервоначальныеСведенияНМАНалоговыйУчет.")+"СрезПоследних(&ДатаКон, Организация = &Организация) КАК Сведения
	               |
	               |ОБЪЕДИНИТЬ ВСЕ
	               |
	               |ВЫБРАТЬ
	               ...
	               |	        ПервоначальныеСведенияНМАБухгалтерскийУчет.ПервоначальнаяСтоимость" + ?(ИДКонERP25 = "ERP25", "БУ","")+" КАК ПервоначальнаяСтоимость
				   |		ИЗ
	               |	        РегистрСведений." + ?(ИДКонERP25 = "ERP25", "ПервоначальныеСведенияНМА","ПервоначальныеСведенияНМАБухгалтерскийУчет")+" КАК ПервоначальныеСведенияНМАБухгалтерскийУчет
				   |		
				   |		ОБЪЕДИНИТЬ ВСЕ
				   |		
				   |		ВЫБРАТЬ
				   |			ПервоначальныеСведенияОСБухгалтерскийУчет.ОсновноеСредство,
	               |	        ПервоначальныеСведенияОСБухгалтерскийУчет.ПервоначальнаяСтоимость" + ?(ИДКонERP25 = "ERP25", "БУ","")+"
				   |		ИЗ
	               |	        РегистрСведений." + ?(ИДКонERP25 = "ERP25", "ПервоначальныеСведенияОС","ПервоначальныеСведенияОСБухгалтерскийУчет")+" КАК ПервоначальныеСведенияОСБухгалтерскийУчет) КАК ВложенныйЗапрос
				   |		ПО ХозрасчетныйОбороты.КорСубконто1 = ВложенныйЗапрос.ОсновноеСредство
	               |	    ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений." + ?(ИДКонERP25 = "ERP25", "ПорядокУчетаОСБУ","НалоговыеНазначенияОС")+" КАК НалоговыеНазначенияОС
	...
	Для Сч = 1 По 16 Цикл
		...
		ОстаточнаяСтоимостьРазвернуто.Вставить("ОС_"+НомГр+"_5", 0);
		Если Сч <=6 Тогда
			...
			ОстаточнаяСтоимостьРазвернуто.Вставить("НМА_"+НомГр+"_5", 0);
		КонецЕсли;
	КонецЦикла;
	Если ИДКонф = "ЕРП" Тогда
		...
		Запрос286.УстановитьПараметр("ДатаКон", 		ДатаКонца);
	...
	Пока Выборка.Следующий() Цикл
		...
		Если НЕ ПустаяСтрока(ИмяЯчейкиАМ) Тогда
			Если (ФлДвухПериодов И НомерПериода = 1) или НомерПериода = 0 или НомерПериода = 3 Тогда
			...
			КонецЕсли;
			Если НЕ НомерПериода = 1 Тогда
				//заполняем в последнем периоде
			...
			КонецЕсли;
			Если НЕ НомерПериода = 3 Тогда
				ОстаточнаяСтоимостьРазвернуто[ИмяДляОстСтоим + "_5"] = ОстаточнаяСтоимостьРазвернуто[ИмяДляОстСтоим + "_5"] + Выборка.АмортизацияНУ;
			КонецЕсли;
		КонецЕсли;
	...
	Для НомГрОС= 1 По 16 Цикл
		...
		Если НЕ НомерПериода = 3  Тогда 
			_ДобавитьСтрокуРасшифровки(ЭтаФорма, 
																...
																"+",
																"!КО"
																,ОстаточнаяСтоимостьРазвернуто["ОС_" + НомГр + "_5"]
																,СчетаИзносаОС,,,,"ПриложениеАМ"
																,,,,ТекСписокОС);
		КонецЕсли;
	КонецЦикла;
	...
	Для НомГрНМА= 1 По 6 Цикл
		...
		Если НЕ НомерПериода = 3  Тогда 
			_ДобавитьСтрокуРасшифровки(ЭтаФорма, 
																...
																"+",
																"!КО"
																,ОстаточнаяСтоимостьРазвернуто["НМА_" + НомГр + "_5"]
																,ПланыСчетов.Хозрасчетный.НакопленнаяАмортизацияНематериальныхАктивов,,,,"ПриложениеАМ"
																,,,,ТекСписокНМА);
		КонецЕсли;
	КонецЦикла;
	...
	Если НЕ (R0111G3_ОС + R0111G3_Номенклатура + R0111G3_НМА) = 0 Тогда
		СтруктураДанныхПриложениеРИ.R0111G3 = СтруктураДанныхПриложениеРИ.R0111G3 + R0111G3_ОС + R0111G3_Номенклатура + R0111G3_НМА;
	...
	Если НЕ R01111G3 = 0 Тогда
		СтруктураДанныхПриложениеРИ.R01111G3 = СтруктураДанныхПриложениеРИ.R01111G3 + R01111G3;
		_ДобавитьСтрокуРасшифровки(ЭтаФорма, 
															    "R01111G3", 
	...
	Если НЕ R0112G3 = 0 Тогда
		СтруктураДанныхПриложениеРИ.R0112G3 = СтруктураДанныхПриложениеРИ.R0112G3 + R0112G3;
		_ДобавитьСтрокуРасшифровки(ЭтаФорма, 
															    "R0112G3", 
	...
	Если НЕ R0113G3 = 0 Тогда
		СтруктураДанныхПриложениеРИ.R0113G3 = СтруктураДанныхПриложениеРИ.R0113G3 + R0113G3;
		_ДобавитьСтрокуРасшифровки(ЭтаФорма, 
															    "R0113G3", 
    ...
    Если НЕ R01211G3 = 0 Тогда
		СтруктураДанныхПриложениеРИ.R01211G3 = СтруктураДанныхПриложениеРИ.R01211G3 + R01211G3;
		_ДобавитьСтрокуРасшифровки(ЭтаФорма, 
															    "R01211G3", 
    ...
    Если НЕ R01212G3 = 0 Тогда
		СтруктураДанныхПриложениеРИ.R01212G3 = СтруктураДанныхПриложениеРИ.R01212G3 + R01212G3;
		_ДобавитьСтрокуРасшифровки(ЭтаФорма, 
															    "R01212G3", 
    ...
    Если НЕ R0122G3 = 0 Тогда
		СтруктураДанныхПриложениеРИ.R0122G3 = СтруктураДанныхПриложениеРИ.R0122G3 + R0122G3;
		_ДобавитьСтрокуРасшифровки(ЭтаФорма, 
															    "R0122G3", 
    ...
    Если НЕ R0123G3 = 0 Тогда
		СтруктураДанныхПриложениеРИ.R0123G3 = СтруктураДанныхПриложениеРИ.R0123G3 + R0123G3;
		_ДобавитьСтрокуРасшифровки(ЭтаФорма, 
															    "R0123G3", 
    ...
    Если НЕ R042162G3 = 0 Тогда  
		СтруктураДанныхПриложениеРИ.R042162G3 = СтруктураДанныхПриложениеРИ.R042162G3 + R042162G3;
		_ДобавитьСтрокуРасшифровки(ЭтаФорма, 
															    "R042162G3", 
	...
	КонецЕсли;	
	//////////////////////////////////////////////////////////////////
	//	Приложение ТЦ, только для ЕРП
	Если ИДКонф = "ЕРП" И ИДКонERP25 <> "КУП" и СтруктураРеквизитовФормы.мПериодичность = Перечисления.Периодичность.Год Тогда
		
		ИмяГруппы = СтруктураРеквизитовФормы.мИдГруппыTC1;
		ДанныеФормы 	= ЭтаФорма[ИмяГруппы]; 
		СтруктураГруппы = ДанныеФормыВЗначение(ДанныеФормы, Тип("ТаблицаЗначений"));		
		мСтруктураИсхКолвоСтрокРазделов.Свойство(ИмяГруппы, ИсходноеКоличествоСтрокГруппы);
		
		ПрефиксИмениКолонки = "TCT1RXXXX";
		...
		КонецЕсли;
		Запрос.УстановитьПараметр("ДатаКон", ДатаКонца);
		Запрос.УстановитьПараметр("ПериодГод", НачалоГода(ДатаКонца));
		
		Запрос.Текст = "ВЫБРАТЬ
		               |	СвязанностьЛицКонтролируемыхОперацийСрезПоследних.Контрагент,
		               |	СвязанностьЛицКонтролируемыхОперацийСрезПоследних.Страна
		               |ПОМЕСТИТЬ Страны
		               |ИЗ
		               |	РегистрСведений.СвязанностьЛицКонтролируемыхОпераций.СрезПоследних(&ДатаКон, Организация = &Организация) КАК СвязанностьЛицКонтролируемыхОперацийСрезПоследних
		               |;
		               |
		               |////////////////////////////////////////////////////////////////////////////////
		               |ВЫБРАТЬ
		               |	КонтролируемыеОперации.СуммаКорректировкиДоходов КАК СуммаКорректировкиДоходов,
		               |	КонтролируемыеОперации.СуммаКорректировкиРасходов КАК СуммаКорректировкиРасходов,
		               |	КонтролируемыеОперации.ДоговорКонтрагента.Контрагент.НаименованиеПолное КАК ПолноеНаименование,
					   |	КонтролируемыеОперации.ДоговорКонтрагента,
		               ...
		               |	ПриложенияОтчета.НомерПриложенияОтчета КАК НомерПриложенияОтчета,
		               |	Страны.Страна.НаименованиеПолное,
		               |	Страны.Страна.Код
		               |ИЗ
		               |	РегистрНакопления.КонтролируемыеОперации КАК КонтролируемыеОперации
		               |		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.КонтрагентыВключаемыеВОтчетОКонтролируемыхОперациях КАК ПриложенияОтчета
		               |		ПО КонтролируемыеОперации.Контрагент = ПриложенияОтчета.Контрагент
		               |		ЛЕВОЕ СОЕДИНЕНИЕ Страны КАК Страны
		               |		ПО КонтролируемыеОперации.Контрагент = Страны.Контрагент
		               |ГДЕ
		               |	КонтролируемыеОперации.Период МЕЖДУ &ДатаНач И &ДатаКон
		               |	И КонтролируемыеОперации.Активность
		               |	И КонтролируемыеОперации.Организация = &Организация
		               |	И ПриложенияОтчета.Период = &ПериодГод
		               |
		               |УПОРЯДОЧИТЬ ПО
		               |	КонтролируемыеОперации.НомерСтроки
		               |ИТОГИ
		               |	МАКСИМУМ(НомерПриложенияОтчета)
		               |ПО
		               |	КонтролируемыеОперации.ДоговорКонтрагента.Контрагент";
		...
		Пока ВыборкаКонтрагент.Следующий() Цикл
			...
			НомерПриложения = 0;
			Если ЗначениеЗаполнено(ВыборкаКонтрагент.НомерПриложенияОтчета) Тогда
				НомерПриложения = ВыборкаКонтрагент.НомерПриложенияОтчета;
			КонецЕсли;
			...
			Пока Выборка.Следующий() Цикл
				...
				Если ТекНомСтр < ИсходноеКоличествоСтрокГруппы Тогда
					ДобавленнаяСтрока = СтруктураГруппы[ТекНомСтр];
				Иначе
					ДобавленнаяСтрока = СтруктураГруппы.Добавить();	
				КонецЕсли;
				
				ДобавленнаяСтрока[ПрефиксИмениКолонки+"G1S"] = Выборка.ПолноеНаименование;
				
				ДобавленнаяСтрока[ПрефиксИмениКолонки+"G2S"] = Выборка.КодСтороныОперации;	
				
				ДобавленнаяСтрока[ПрефиксИмениКолонки+"G3S"] = Выборка.СтранаНаименованиеПолное;	
				ДобавленнаяСтрока[ПрефиксИмениКолонки+"G4S"] = Выборка.СтранаКод;	

				Если ЗначениеЗаполнено(Выборка.ДатаКонтракта) Тогда
					ДобавленнаяСтрока[ПрефиксИмениКолонки+"G5D"] = Выборка.ДатаКонтракта;
				КонецЕсли;
				ДобавленнаяСтрока[ПрефиксИмениКолонки+"G6S"] = Выборка.НомерКонтракта;
				ДобавленнаяСтрока[ПрефиксИмениКолонки+"G7S"] = Выборка.КодНаименованияОперации;	
				ДобавленнаяСтрока[ПрефиксИмениКолонки+"G8S"] = Выборка.ПредметСделкиСтрока;
				ДобавленнаяСтрока[ПрефиксИмениКолонки+"G9S"] = Выборка.КодПредмета;
				ДобавленнаяСтрока[ПрефиксИмениКолонки+"G10S"] = Выборка.КодУКТВЭД;
				ДобавленнаяСтрока[ПрефиксИмениКолонки+"G11S"] = Выборка.КодУКВЭП;
				ДобавленнаяСтрока[ПрефиксИмениКолонки+"G12D"] = Выборка.ДатаОперацииС;
				ДобавленнаяСтрока[ПрефиксИмениКолонки+"G13D"] = Выборка.ДатаОперацииПо;
				Если НомерПриложения > 0 Тогда
					ДобавленнаяСтрока[ПрефиксИмениКолонки+"G14S"] = НомерПриложения;
					ДобавленнаяСтрока[ПрефиксИмениКолонки+"G15"] = КонтрагентНомСтр;
				КонецЕсли;
				ДобавленнаяСтрока[ПрефиксИмениКолонки+"G17"] = Выборка.СуммаКорректировкиДоходов;//+
				Если Выборка.СуммаКорректировкиДоходов <> 0 Тогда
					ДобавленнаяСтрока[ПрефиксИмениКолонки+"G16"] = Выборка.ЗначениеПоказателяРентабельности;
				КонецЕсли;
				ДобавленнаяСтрока[ПрефиксИмениКолонки+"G19"] = -Выборка.СуммаКорректировкиРасходов;//-;
				Если Выборка.СуммаКорректировкиРасходов <> 0 Тогда
					ДобавленнаяСтрока[ПрефиксИмениКолонки+"G18"] = Выборка.ЗначениеПоказателяРентабельности;
				КонецЕсли;
				ТекНомСтр = ТекНомСтр + 1;
				КонтрагентНомСтр = КонтрагентНомСтр + 1;
				
			КонецЦикла;
		
			СтруктураДанныхДекларация.HD4 = "+";	
		КонецЦикла;
	...
	ЗаполнитьРемонтНепроизводственныхОС(НомерПериода);
	ЗаполнитьШтрафы(НомерПериода);
	ЗаполнитьСписаниеНеБезнЗадолженности(НомерПериода);
	ЗаполнитьПередачуНеприбыльным(НомерПериода);
	ЗаполнитьПриобретениеУНеприбыльных(НомерПериода);
	ЗаполнитьПриобретениеИзОффшоров(НомерПериода);
	ЗаполнитьПриобретениеИзОффшоровОргформа(НомерПериода);
	ЗаполнитьРеализациюИзОффшоров(НомерПериода);
	ЗаполнитьРеализациюИзОффшоровОргформа(НомерПериода);
	...
	Пока Выборка.Следующий() Цикл
		...
		ИначеЕсли Выборка.Статья = СтНД.НП15_РИ_Др_Переходные_ЗатратыВнешниеКредиты				Тогда ЗаполнитьКорректировкуРИ("R04114G3","+",  Выборка.Сумма, Выборка.Статья)
		...
		ИначеЕсли Выборка.Статья = СтНД.НП15_РИ_Фин_ГрантРасход							Тогда ЗаполнитьКорректировкуРИ("R03114G3", "+", Выборка.Сумма, Выборка.Статья)
		ИначеЕсли Выборка.Статья = СтНД.НП15_РИ_Фин_Грант								Тогда ЗаполнитьКорректировкуРИ("R0326G3", "-",  Выборка.Сумма, Выборка.Статья)	
		ИначеЕсли Выборка.Статья = СтНД.НП15_РИ_Др_Переходные_КомпенсацияКовид			Тогда ЗаполнитьКорректировкуРИ("R04222G3", "-", Выборка.Сумма, Выборка.Статья)
		ИначеЕсли Выборка.Статья = СтНД.НП15_РИ_Др_СписаниеСанкций_КомпенсацияКовид		Тогда ЗаполнитьКорректировкуРИ("R04223G3", "-", Выборка.Сумма, Выборка.Статья)

		ИначеЕсли Выборка.Статья = СтНД.НП15_РИ_Фин_Оздоровление							Тогда ЗаполнитьКорректировкуРИ("R031102G3", "+",  Выборка.Сумма, Выборка.Статья)	
		Иначе			
			Попытка		
				Если Выборка.Статья = СтНД.НП15_РИ_Фин_БезвозврФинПомощьСвязЛиц			Тогда ЗаполнитьКорректировкуРИ("R031101G3", "+",  Выборка.Сумма, Выборка.Статья)	
				ИначеЕсли Выборка.Статья = СтНД.НП15_РИ_Переходные_ДоходЗеленыйТариф	Тогда ЗаполнитьКорректировкуРИ("R04122G3", "+",  Выборка.Сумма, Выборка.Статья)	
				ИначеЕсли Выборка.Статья = СтНД.НП15_РИ_Переходные_ЗатратыСебестЗеленТариф	Тогда ЗаполнитьКорректировкуРИ("R04123G3", "+",  Выборка.Сумма, Выборка.Статья)	
				ИначеЕсли Выборка.Статья = СтНД.НП15_РИ_Переходные_ЗатратыСебестЗеленТарифНеОплачен	Тогда ЗаполнитьКорректировкуРИ("R04224G3", "-", Выборка.Сумма, Выборка.Статья)
				ИначеЕсли Выборка.Статья = СтНД.НП15_РИ_Переходные_ЗатратыСебестЗеленТарифОплачен	Тогда ЗаполнитьКорректировкуРИ("R04225G3", "-", Выборка.Сумма, Выборка.Статья)
				КонецЕсли;
			Исключение	
			КонецПопытки;
			
			Попытка 
				Если Выборка.Статья = СтНД.НП15_РИ_Др_3_СебестоимостьБУОбСтр		Тогда ЗаполнитьКорректировкуРИ("R04142G3", "+",  Выборка.Сумма, Выборка.Статья)
				ИначеЕсли Выборка.Статья = СтНД.НП15_РИ_Др_3_ДоходОбСтр					Тогда ЗаполнитьКорректировкуРИ("R04231G3", "-",  Выборка.Сумма, Выборка.Статья)			
				ИначеЕсли Выборка.Статья = СтНД.НП15_РИ_Др_3_ДоходОбСтрПред				Тогда ЗаполнитьКорректировкуРИ("R04143G3", "+",  Выборка.Сумма, Выборка.Статья)			
				ИначеЕсли Выборка.Статья = СтНД.НП15_РИ_Др_3_СебестоимостьБУОбСтрПред	Тогда ЗаполнитьКорректировкуРИ("R04232G3", "-",  Выборка.Сумма, Выборка.Статья)			
				ИначеЕсли Выборка.Статья = СтНД.НП15_РИ_Др_2_ГосБюджетГаз				Тогда ЗаполнитьКорректировкуРИ("R04226G3", "-", Выборка.Сумма, Выборка.Статья)
				ИначеЕсли Выборка.Статья = СтНД.НП15_РИ_Др_2_ЗатратыПраваСобств			Тогда ЗаполнитьКорректировкуРИ("R04124G3", "+", Выборка.Сумма, Выборка.Статья)
				ИначеЕсли Выборка.Статья = СтНД.НП15_РИ_Др_2_ДоходыПраваСобств			Тогда ЗаполнитьКорректировкуРИ("R04227G3", "-", Выборка.Сумма, Выборка.Статья)
				ИначеЕсли Выборка.Статья = СтНД.НП15_РИ_Др_2_ДолгИзъятПраваСобств		Тогда ЗаполнитьКорректировкуРИ("R04228G3", "-", Выборка.Сумма, Выборка.Статья)
				КонецЕсли;
			Исключение
			КонецПопытки;
		КонецЕсли;
...
&НаСервере  
Процедура ЗаполнитьСписаниеНеБезнЗадолженности(НомерПериода)
	
	ЗаполнитьПоСтатьямЗатрат("R0213G3", СтруктураРеквизитовФормы.СписаниеНеБезнадежнойЗадолженности_Статьи, НомерПериода);
	
КонецПроцедуры

&НаСервере
Процедура ЗаполнитьШтрафы(НомерПериода)
	
	ЗаполнитьПоСтатьямЗатрат("R03111G3", СтруктураРеквизитовФормы.Штрафы_Статьи, НомерПериода);
	
	
КонецПроцедуры

&НаСервере
Процедура ЗаполнитьПередачуНеприбыльным(НомерПериода)

	ПередачаНеприбыльным = ЗаполнитьПоСтатьямЗатрат("", СтруктураРеквизитовФормы.ПередачаНеприбыльным_СтатьиЗатрат, НомерПериода);
	...
	СтруктураДанныхПриложениеРИ["R0319G3"] = СтруктураДанныхПриложениеРИ["R0319G3"] + ПередачаНеприбыльным_норм;
...
&НаСервере
Функция ЗаполнитьПоСтатьямЗатрат(ИмяЯчейки, ФильтрСтатей, НомерПериода)
	...
	Если ЗначениеЗаполнено(ИмяЯчейки) Тогда
		...
		СтруктураДанныхПриложениеРИ[ИмяЯчейки] = СтруктураДанныхПриложениеРИ[ИмяЯчейки] + Разница;
...
&НаСервере
Процедура ЗаполнитьПриобретениеУНеприбыльных(НомерПериода)

	ЗаполнитьПриобретения("R0316G3", СтруктураРеквизитовФормы.Контрагенты_Неприбыльные, "3.1.6", НомерПериода);

КонецПроцедуры

&НаСервере 
Процедура ЗаполнитьПриобретениеИзОффшоров(НомерПериода)
	ЗаполнитьПриобретения("R03161G3", СтруктураРеквизитовФормы.Контрагенты_Оффшоры, "3.1.6.1", НомерПериода);
КонецПроцедуры

&НаСервере
Процедура ЗаполнитьПриобретениеИзОффшоровОргформа(НомерПериода)

	ЗаполнитьПриобретения("R03162G3", СтруктураРеквизитовФормы.Контрагенты_ОффшорыОргформа, "3.1.6.2", НомерПериода);

КонецПроцедуры

&НаСервере
Процедура ЗаполнитьПриобретения(ИмяЯчейки, ФильтрКонтрагентов, ПредставлениеПоказателя, НомерПериода)
	Если НомерПериода = 1 Тогда
		ДатаНачала = ДатаНачала1;
		ДатаКонца = ДатаОкончания1;
	ИначеЕсли НомерПериода = 2 Тогда
	...
	Если ТекущиеДанные.Следующий() Тогда
		...
		Если ИмяЯчейки = "R0316G3" Тогда   
			...
			Если ФлДвухПериодов и НомерПериода = 2 Тогда
				СуммаДляСравнения = СтруктураДанныхПриложениеРИ[ИмяЯчейки] + ТекущиеДанные.Сумма;
				Если СуммаДляСравнения <= СтруктураРеквизитовФормы.МинЗП * 25 Тогда
					СуммаРасшифровки3 = СуммаДляСравнения;
				...
				Иначе	
					СтруктураДанныхПриложениеРИ[ИмяЯчейки] =  СуммаДляСравнения * 0.3;
				КонецЕсли;	
			ИначеЕсли ФлДвухПериодов и НомерПериода = 1 Тогда
				//первый раз просто запишем
				СтруктураДанныхПриложениеРИ[ИмяЯчейки] =  СтруктураДанныхПриложениеРИ[ИмяЯчейки];
			Иначе	
				СтруктураДанныхПриложениеРИ[ИмяЯчейки] =  ТекущиеДанные.Сумма * 0.3;
			КонецЕсли;	
		Иначе	
			СтруктураДанныхПриложениеРИ[ИмяЯчейки] =  СтруктураДанныхПриложениеРИ[ИмяЯчейки] + ТекущиеДанные.Сумма * 0.3;
		КонецЕсли;	
...
&НаСервере
Процедура ЗаполнитьРеализациюИзОффшоров(НомерПериода)
	ЗаполнитьРеализацию("R0317G3", СтруктураРеквизитовФормы.Контрагенты_Оффшоры, "3.1.7", НомерПериода);
КонецПроцедуры

&НаСервере
Процедура ЗаполнитьРеализациюИзОффшоровОргформа(НомерПериода)

	ЗаполнитьРеализацию("R03171G3", СтруктураРеквизитовФормы.Контрагенты_ОффшорыОргформа, "3.1.7.1", НомерПериода);

КонецПроцедуры

&НаСервере

Процедура ЗаполнитьРеализацию(ИмяЯчейки, ФильтрКонтрагентов, ПредставлениеПоказателя, НомерПериода)
...
&НаСервере
Процедура ЗаполнитьПриложениеЗП(НомерПериода=0)
	...
	ЗапросАванс.Текст = "ВЫБРАТЬ
						...
						|";
	ЗапросАванс.УстановитьПараметр("ДатаНач", ДатаНачала);
	ЗапросАванс.УстановитьПараметр("ДатаКон", ДатаКонца);
	...
	СтруктураДанныхПриложениеЗП["R0162G3"] = СтруктураДанныхПриложениеЗП["R0162G3"] + R0162G3;
...
&НаСервере 
Процедура ЗаполнитьРемонтНепроизводственныхОС(НомерПериода = 0)
	...
	Если РегламентированнаяОтчетностьПереопределяемый.ИДКонфигурации() = "БП"  ИЛИ РегламентированнаяОтчетностьПереопределяемый.ИДКонфигурации() = "БСП" Тогда //ИН-АГРО
		...
		КонецЕсли;
		РасшСтрокой = "Сума витрат на ремонт ОЗ та НМА, відображена документами ""Модернізації та ремонту"", що була раніше накопичена на рахунку 15 або 235 по об'єктам будівництва з податковим призначеннями - ""негосподарська діяльність"""
	...
	Иначе	//ЕРП
		...
		Если Счет9.Родитель = ПланыСчетов.Хозрасчетный.ПустаяСсылка() Тогда
			ИспКлассыСчетовВКачествеГрупп = Истина;
		КонецЕсли;
		РасшСтрокой = "Сума витрат на ремонт ОЗ та НМА, відображена документами ""Ремонт"", що була раніше накопичена на рахунку 15 або 239 по об'єктам будівництва з податковим призначеннями - ""негосподарська діяльність"""
	КонецЕсли;
	...
	СтруктураДанныхПриложениеРИ["R0114G3"] = СтруктураДанныхПриложениеРИ["R0114G3"] + R0114G3;
	_ДобавитьСтрокуРасшифровки(ЭтаФорма, 
															"R0114G3", 
															"Рядок 1.1.4",
															"+",
...
Процедура ЗаполнитьУбытокПрошлогоГода(ПараметрыЗаполненияЗвит1С)
	...
	Иначе
		...
		Если ГодПериода = 2022 Тогда 
			ИмяСхемы1 = ?(ЗначениеЗаполнено(СтруктураДанныхДекларация.H091), "J0100522","J0100122");
			ИмяСхемы2 = ?(ЗначениеЗаполнено(СтруктураДанныхДекларация.H091), "J0100523","J0100123");
		Иначе  //2023
			ИмяСхемы1 = ИмяСхемы1 + "24";
			// сельхозники
			ИмяСхемы2 = "J0100524"; 
		КонецЕсли;
...
Процедура ЗаполнитьПоказателиПрошогоПериода(ПараметрыЗаполненияЗвит1С)
	...
	Если ПолучитьДанныеЗаПрошлыйКварталИз1С Тогда
		...
		Если ДанныеПрошлогоКвартала <> Неопределено  Тогда
			...
			Если ДатаПрошлогоКвартала>='20230401' Тогда
				R027G3 = ДанныеПрошлогоКвартала.R026G3;
			КонецЕсли;
		КонецЕсли;
		...
		СтруктураДанныхДекларация.R024G3 = R024G3;
			СтруктураДанныхДекларация.R027G3 = R027G3;
	...
	Иначе
        ...
        ПрошлыйГодПериода   = Год(ДатаПрошлогоГода);
		
		Если Месяц(ДатаПрошлогоКвартала) = 3 и ГодПериода = 2023 Тогда 
			Если ЮрЛицо Тогда  
				ИмяСхемы = "J0100123";  // Декларация о прибыли 
		...
		Иначе
			Если ЮрЛицо Тогда  
				ИмяСхемы = "J0100124";  // Декларация о прибыли 
				Если ЗначениеЗаполнено(СтруктураДанныхДекларация.H091) Тогда
					// сельхозники
					ИмяСхемы = "J0100524"; 
				КонецЕсли;
		...
		Если ЮрЛицо Тогда
			// данные за прошлый год  ЗП
			Если ПрошлыйГодПериода = 2022 Тогда 
				ИмяСхемы = ?(ЗначениеЗаполнено(СтруктураДанныхДекларация.H091), "J0151422","J0111422"); 
				ИмяСхемы2 = ?(ЗначениеЗаполнено(СтруктураДанныхДекларация.H091), "J0151423","J0111423"); 
			Иначе  //2023
				ИмяСхемы = ?(ЗначениеЗаполнено(СтруктураДанныхДекларация.H091), "J0151424","J0111424");  
			КонецЕсли;
			
			Если Месяц(ДатаПрошлогоГода) = 3 Тогда
				ТипПериода   = 10; // 1 квартал					
			ИначеЕсли Месяц(ДатаПрошлогоГода) = 6 Тогда
				ТипПериода   = 20; // 1 полугодие
			ИначеЕсли Месяц(ДатаПрошлогоГода) = 9 Тогда
				ТипПериода   = 25; // 9 месяцев
			Иначе
				ТипПериода   = 30; // Год
			КонецЕсли;
			...
			Если ПрошлыйГодПериода = 2022 Тогда 
				ПараметрыЗаполненияПоказателиПрошлогоГода.Вставить("ПараметрыЗапроса", Новый Структура("ИмяСхемы, ИмяСхемы2, ТипПериода, НомерПериода, ГодПериода", ИмяСхемы, ИмяСхемы2, ТипПериода, НомерПериода, ПрошлыйГодПериода));
			Иначе
...
Функция ОкруглитьЧислоПоФорматуФИН(ИсходноеЧисло) Экспорт 
	
	Возврат Окр(ИсходноеЧисло/1000, 0) * 1000;
		...
		Если ПараметрыЗаполненияЗвит1С.Свойство("ПараметрыЗаполненияПоказателиПрошогоПериода", ПараметрыЗаполненияПоказателиПрошогоПериода) Тогда
			...
			Попытка
				...
				Если Данные = Неопределено Тогда
					...
					ВыводитьПредупреждения = (Найти(глМенеджерЗвит1С.ИмяСхемыЗвит1С,"0100")> 0); // Основная форма J01001.., F01007..
				...
				Иначе
					...
					Если СтруктураРеквизитовФормы.мДатаНачалаПериодаОтчета>= '20230701' ТОгда 
						R027G3 = ПолучитьЗначениеПоказателяЗвит1С(Данные, "A26",Ложь);  
					КонецЕсли;
				КонецЕсли;
			Исключение
				ТекстОшибки = "Помилка алгоритму заповнення звіту!
			...
			ЗаполнитьПоказательНаСервере("R027G3", R027G3, ЭтаФорма, "Декларация");   
		...
		Если ПараметрыЗаполненияЗвит1С.Свойство("ПараметрыЗаполненияПоказателиПрошлогоГода", ПараметрыЗаполненияПоказателиПрошлогоГода) Тогда
			...
			Попытка
				...
				Если Данные = Неопределено Тогда
					...
					// за год 2022, как исключение из правил, может быть схема "22" и "23", 
					Попытка //до 2019
						Данные = глКомпонентаЗвит1С.GetReport(ПараметрыЗаполненияПоказателиПрошлогоГода.ПараметрыЗапроса.ИмяСхемы2,
																ПараметрыЗаполненияУбытокПрошлогоГода.ПараметрыЗапроса.ТипПериода, 
																ПараметрыЗаполненияУбытокПрошлогоГода.ПараметрыЗапроса.НомерПериода, 
																ПараметрыЗаполненияУбытокПрошлогоГода.ПараметрыЗапроса.ГодПериода);
					Исключение
...
Процедура  ОпределитьСписокВыгружаемыхСхем(тбСхемыXML);
	...
	Для Каждого стр Из  тбСхемыXML Цикл
		...
		Если Лев(Стр.Префикс,3) = "MPZ"  Тогда
			Если НЕ ЗначениеЗаполнено(ПолучитьПоказательНаСервере("HD14", ЭтаФорма, "Декларация")) Тогда
				Сообщение.Текст = НСтр("ru='Приложение МПЗ не выгружается, т.к. не установлена соответствующая пометка в разделе  ""Наявність додатків"" в Декларации';uk='Додаток МПЗ не вивантажується, т.щ. не встановлена відповідна позначка в розділі  ""Наявність додатків"" в Декларації'");
				Сообщение.Сообщить();
				стр.фВыгрузка = 0;
			КонецЕсли;
		КонецЕсли;

		Если Лев(Стр.Префикс,2) = "MZ"  Тогда
			Если НЕ ЗначениеЗаполнено(ПолучитьПоказательНаСервере("H01", ЭтаФорма, "ПриложениеМПЗ")) Тогда
				Сообщение.Текст = НСтр("ru='Приложение МПЗ-З не выгружается, т.к. не установлена соответствующая пометка в разделе  ""Наявність додатка"" в Приложении МПЗ';uk='Додаток МПЗ-З не вивантажується, т.щ. не встановлена відповідна позначка в розділі  ""Наявність додатка"" в Додатку МПЗ'");
				Сообщение.Сообщить();
				стр.фВыгрузка = 0;
			КонецЕсли;
		КонецЕсли;

		Если Лев(Стр.Префикс,3) = "DI"  Тогда
			Если НЕ ЗначениеЗаполнено(ПолучитьПоказательНаСервере("HD15", ЭтаФорма, "Декларация")) Тогда
				Сообщение.Текст = НСтр("ru='Приложение ДІЯ не выгружается, т.к. не установлена соответствующая пометка в разделе  ""Наявність додатків"" в Декларации';uk='Додаток ДІЯ не вивантажується, т.щ. не встановлена відповідна позначка в розділі  ""Наявність додатків"" в Декларації'");
				Сообщение.Сообщить();
				стр.фВыгрузка = 0;
			КонецЕсли;
		КонецЕсли;

		Если Лев(Стр.Префикс,3) = "OV"  Тогда
			Если НЕ ЗначениеЗаполнено(ПолучитьПоказательНаСервере("HD16", ЭтаФорма, "Декларация")) Тогда
				Сообщение.Текст = НСтр("ru='Приложение ОВ не выгружается, т.к. не установлена соответствующая пометка в разделе  ""Наявність додатків"" в Декларации';uk='Додаток ОВ не вивантажується, т.щ. не встановлена відповідна позначка в розділі  ""Наявність додатків"" в Декларації'");
				Сообщение.Сообщить();
				стр.фВыгрузка = 0;
			КонецЕсли;
		КонецЕсли;    
...
Функция ЗаполнитьТаблицуСоСхемамиВыгрузки()
	...
	Если ЮрЛицо Тогда
		...
		НовСтрока.ИмяСхемы = ?(ПроизводительСХ, "J0100524", "J0100124");  
		...
		НовСтрока = тбСхемыXML.Добавить();
		НовСтрока.ИмяСхемы = ?(ПроизводительСХ, "J0151824", "J0111824");  
		...
		НовСтрока = тбСхемыXML.Добавить();
		НовСтрока.ИмяСхемы = ?(ПроизводительСХ, "J0150324", "J0110324");  
		...
		НовСтрока = тбСхемыXML.Добавить();
		НовСтрока.ИмяСхемы = ?(ПроизводительСХ, "J0152824", "J0112824");  
		...
		НовСтрока = тбСхемыXML.Добавить();
		НовСтрока.ИмяСхемы = ?(ПроизводительСХ, "J0150624", "J0110624");  
		...
		НовСтрока = тбСхемыXML.Добавить();
		НовСтрока.ИмяСхемы = ?(ПроизводительСХ, "J0151324", "J0111324");  
		...
		НовСтрока = тбСхемыXML.Добавить(); 
		НовСтрока.ИмяСхемы = ?(ПроизводительСХ, "J0151424", "J0111424");  
		...
		Для  Инд = 1 ПО ТаблицаСтраницыРаздела1.Количество() Цикл
			...
			НовСтрока = тбСхемыXML.Добавить();
			НовСтрока.ИмяСхемы = ?(ПроизводительСХ, "J0151524", "J0111524");  
		...
		НовСтрока = тбСхемыXML.Добавить();
		НовСтрока.ИмяСхемы = ?(ПроизводительСХ, "J0151624", "J0111624");  
		...
		Если НЕ ЗначениеЗаполнено(ПолучитьПоказательНаСервере("HZU", ЭтаФорма, "Декларация")) Тогда
			НовСтрока = тбСхемыXML.Добавить();
			НовСтрока.ИмяСхемы = ?(ПроизводительСХ, "J0151724", "J0111724");  
		...
		НовСтрока = тбСхемыXML.Добавить();
		НовСтрока.ИмяСхемы = ?(ПроизводительСХ, "J0152024", "J0112024");  
		...
		Для  Инд = 1 ПО ТаблицаСтраницыРаздела2.Количество() Цикл
			...
			НовСтрока = тбСхемыXML.Добавить();
			НовСтрока.ИмяСхемы = ?(ПроизводительСХ, "J0154424", "J0114424");  
		...
		НовСтрока = тбСхемыXML.Добавить();
		НовСтрока.ИмяСхемы = ?(ПроизводительСХ, "J0154824", "J0114824");  
		НовСтрока.ПредставлениеСхемы = НСтр("ru='Приложение МПЗ';uk='Додаток МПЗ'");
		НовСтрока.НазваниеСтраницыПанели ="ПриложениеМПЗ";
		НовСтрока.Префикс = "MPZ";
		
		НовСтрока = тбСхемыXML.Добавить();
		НовСтрока.ИмяСхемы = ?(ПроизводительСХ, "J0154924", "J0114924");  
		НовСтрока.ПредставлениеСхемы = НСтр("ru='Приложение МПЗ-З';uk='Додаток МПЗ-З'");
		НовСтрока.НазваниеСтраницыПанели ="ПриложениеМЗЗ";
		НовСтрока.Префикс = "MZ";
		
		Если не ПроизводительСХ Тогда
			НовСтрока = тбСхемыXML.Добавить();
			НовСтрока.ИмяСхемы = "J0115024";  
			НовСтрока.ПредставлениеСхемы = НСтр("ru='Приложение ДІЯ';uk='Додаток ДІЯ'");
			НовСтрока.НазваниеСтраницыПанели ="ПриложениеДИЯ";
			НовСтрока.Префикс = "DI";    
			
			НовСтрока = тбСхемыXML.Добавить();
			НовСтрока.ИмяСхемы = "J0115924";  
			НовСтрока.ПредставлениеСхемы = НСтр("ru='Приложение ОВ';uk='Додаток ОВ'");
			НовСтрока.НазваниеСтраницыПанели ="ПриложениеОВ";
			НовСтрока.Префикс = "OV";   
		КонецЕсли;
		
	Иначе
		НовСтрока = тбСхемыXML.Добавить();
		НовСтрока.ИмяСхемы = "F0100724";
		НовСтрока.ПредставлениеСхемы = НСтр("ru='Декларация о прибыли';uk='Декларація про прибуток'");
		НовСтрока.НазваниеСтраницыПанели ="Декларация";
...
Функция СформироватьДанныеДляЗвит1С(ОтчетЗвит1С = Неопределено) Экспорт 
	...
	H02 = ""; H01 = "Х";
	СтруктураРеквизитовФормы.мПериодичность = ПредопределенноеЗначение("Перечисление.Периодичность.Квартал");	
	Если СтруктураРеквизитовФормы.ДляФредоТипПериода Тогда  //Год
		СтруктураРеквизитовФормы.мПериодичность = ПредопределенноеЗначение("Перечисление.Периодичность.Год");	
		H02 = "Х"; H01 = "";
	КонецЕсли;
	ЗаполнитьПоказательНаСервере("H02", H02, ЭтаФорма, "Декларация");
...
Процедура ОткрытьФормуПараметров(Команда)
	...
	мПараметрыФормы.Вставить("КоеффициентМПЗ", 					СтруктураРеквизитовФормы.КоеффициентМПЗ);  
	мПараметрыФормы.Вставить("КорректироватьПлощади", 			СтруктураРеквизитовФормы.КорректироватьПлощади);  
	мПараметрыФормы.Вставить("ДатаНачалаНаЕдиномНалоге", 		СтруктураРеквизитовФормы.ДатаНачалаНаЕдиномНалоге);
	мПараметрыФормы.Вставить("ДатаОкончанияНаЕдиномНалоге", 	СтруктураРеквизитовФормы.ДатаОкончанияНаЕдиномНалоге);
	...
	мПараметрыФормы.Вставить("ДляФредоПроизводительСХ", ЗначениеЗаполнено(СтруктураРеквизитовФормы.H091));
...
Процедура ЗаполнитьНастраиваемыеПараметрыЗаполнения()
	...
	Попытка
		ФлПроверять = ЗначениеЗаполнено(Перечисления.ГруппыПлательщиковЕдиногоНалога.ТретьяГруппаОсобая);
	Исключение
		ФлПроверять = Ложь;
	КонецПопытки;
	ДатаНачалаЕН = Неопределено;
	ДатаОкончанияЕН = Неопределено;
	Если  СтруктураРеквизитовФормы.ДатаНачалаНаЕдиномНалоге = Неопределено И ФлПроверять Тогда
	...
	Если РегламентированнаяОтчетностьПереопределяемый.ИДКонфигурации() = "БП"  ИЛИ РегламентированнаяОтчетностьПереопределяемый.ИДКонфигурации() = "БСП" Тогда //ИН-АГРО
		...
		ИначеЕсли  РегламентированнаяОтчетностьПереопределяемый.ИДКонфигурации(Истина) = "ERP25" Тогда
			
			Запрос = Новый Запрос();
				Запрос.Текст = 
				"ВЫБРАТЬ
				|	СтатусыПлательщиковЕдиногоНалога.ГруппаПлательщикаЕдиногоНалога КАК ГруппаПлательщикаЕдиногоНалога,
				|	СтатусыПлательщиковЕдиногоНалога.Период КАК ДатаИзмененияСхемыНалогообложенияВСерединеМесяца,
				|	СтатусыПлательщиковЕдиногоНалога.Период КАК Период,
				|	СтатусыПлательщиковЕдиногоНалога.ПлательщикЕН КАК ПлательщикЕдиногоНалога
				|ИЗ
		...
		Иначе
			Запрос = Новый Запрос();
				Запрос.Текст = 
				"ВЫБРАТЬ
				|	УчетнаяПолитикаОрганизаций.ПлательщикЕН КАК ПлательщикЕдиногоНалога,
				|	СтатусыПлательщиковЕдиногоНалога.ГруппаПлательщикаЕдиногоНалога КАК ГруппаПлательщикаЕдиногоНалога,
				|	УчетнаяПолитикаОрганизаций.ДатаИзмененияУчетнойПолитики КАК ДатаИзмененияСхемыНалогообложенияВСерединеМесяца,
				|	УчетнаяПолитикаОрганизаций.Период КАК Период
				|ИЗ
				|	РегистрСведений.УчетнаяПолитикаОрганизаций КАК УчетнаяПолитикаОрганизаций
				|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ РегистрСведений.СтатусыПлательщиковЕдиногоНалога КАК СтатусыПлательщиковЕдиногоНалога
				|		ПО (СтатусыПлательщиковЕдиногоНалога.Организация = &Организация)
				|			И (СтатусыПлательщиковЕдиногоНалога.Период = УчетнаяПолитикаОрганизаций.ДатаИзмененияУчетнойПолитики)
				|ГДЕ
				|	УчетнаяПолитикаОрганизаций.Организация = &Организация
				|
				|УПОРЯДОЧИТЬ ПО
		...
		Пока Выборка.Следующий() Цикл
			...
			Если ЗначениеЗаполнено(ДатаНачалаЕН) Тогда
				//есть записи после перехода
				Если Выборка.ПлательщикЕдиногоНалога = ИСТИНА И 
					 Выборка.ГруппаПлательщикаЕдиногоНалога = Перечисления.ГруппыПлательщиковЕдиногоНалога.ТретьяГруппаОсобая Тогда
					 
					Продолжить; 
				Иначе
					//переход с ЕН 2%
					ДатаОкончанияЕН = Мин(Выборка.Период-1,СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета);
				КонецЕсли;
			КонецЕсли;
			...
			Если Выборка.ПлательщикЕдиногоНалога = ИСТИНА И 
				...
				Если ЗначениеЗаполнено(Выборка.ДатаИзмененияСхемыНалогообложенияВСерединеМесяца) Тогда
					 Если Выборка.ДатаИзмененияСхемыНалогообложенияВСерединеМесяца <= СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета  Тогда
						 ДатаНачалаЕН = Выборка.ДатаИзмененияСхемыНалогообложенияВСерединеМесяца;   
					 КонецЕсли;
				Иначе
					//с начала месяца     
					 Если Выборка.Период <= СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета  Тогда
						 ДатаНачалаЕН = Выборка.Период;
					 КонецЕсли;
				КонецЕсли;
			КонецЕсли;
		...
		Если (ЗначениеЗаполнено(ДатаОкончанияЕН) и ДатаОкончанияЕН < СтруктураРеквизитовФормы.мДатаНачалаПериодаОтчета) Тогда    
		...
		Иначе	
			...
			Если ЗначениеЗаполнено(ДатаНачалаЕН) Тогда
				ДатаНачалаЕН = Макс(ДатаНачалаЕН, СтруктураРеквизитовФормы.мДатаНачалаПериодаОтчета);    
			КонецЕсли;	
	...
	СтруктураРеквизитовФормы.ДатаНачалаНаЕдиномНалоге    = ДатаНачалаЕН;
	СтруктураРеквизитовФормы.ДатаОкончанияНаЕдиномНалоге = ДатаОкончанияЕН;
	...
	Если Выборка.Следующий() Тогда
		...
		ДанныеОтчета.Свойство("КоеффициентМПЗ", СтруктураРеквизитовФормы.КоеффициентМПЗ);
		Если  СтруктураРеквизитовФормы.КоеффициентМПЗ = Неопределено Тогда
			СтруктураРеквизитовФормы.КоеффициентМПЗ = 0.04; //2022-2023 0,04, потом 0,05
		КонецЕсли;
...
Процедура _ДобавитьСтрокуРасшифровки(Форма, ИмяЯчейки, ИмяПоказателя, ЗнакОперации, ИмяСлагаемого, Сумма, Счет = Неопределено, КорСчет = Неопределено, Сдвиг = Неопределено, ПраваяГраница = Неопределено, ИмяРаздела = Неопределено, НомерЛиста = Неопределено, МнЧ = Неопределено, НомерСтроки = Неопределено, Субконто1 = Неопределено, Субконто2 = Неопределено, Субконто3 = Неопределено)
	...
	ОбщиеПараметрыРасшифровки.Вставить("НачалоПериода", Сдвиг);
	ОбщиеПараметрыРасшифровки.Вставить("КонецПериода", ПраваяГраница);
	...
	Если ЗначениеЗаполнено(КорСчет) Тогда
		Представление = ИмяСлагаемого + " " + ПредставлениеСчета + ?(ЗначениеЗаполнено(КорСчет)," " + КорСчет, "");
	Иначе	
...
&НаСервере
Функция ПодготовитьЗапросМЗЗ() Экспорт 
	
	Запрос = Новый Запрос;  
	
	Если СтруктураРеквизитовФормы.КорректироватьПлощади Тогда
	
		Запрос.Текст = 
		"ВЫБРАТЬ РАЗЛИЧНЫЕ
		|	НормативнаяОценка.Договор КАК Договор,
		|	НормативнаяОценка.Участок КАК Участок,
		|	НормативнаяОценка.Актуальность КАК Актуальность,
		|	НормативнаяОценка.ДоляЗемельногоПая КАК ДоляЗемельногоПая,
		|	НормативнаяОценка.НормативнаяОценкаЗемли КАК НормативнаяОценкаЗемли,
		|	ВЫБОР
		|		КОГДА НормативнаяОценка.Участок.ТипУчастка = ЗНАЧЕНИЕ(Перечисление.ИНАГРО_ТипУчастка.Аренда)
		|			ТОГДА НормативнаяОценка.ПроцентВыплаты
		|		ИНАЧЕ 0
		|	КОНЕЦ КАК ПроцентВыплаты,
		|	НормативнаяОценка.СуммаАренднойПлаты КАК СуммаАренднойПлаты,
		|	НормативнаяОценка.НормативнаяОценкаЗемлиЕдПлощади КАК НормативнаяОценкаЗемлиЕдПлощади,
		|	ВЫБОР
		|		КОГДА НормативнаяОценка.Период <= &ДатаНач
		|			ТОГДА ДОБАВИТЬКДАТЕ(&ДатаНач, ГОД, -1)
		|		ИНАЧЕ &ДатаНач
		|	КОНЕЦ КАК Период,
		|	ГодоваяАктуальность.Актуальность КАК ГодоваяАктуальность
		|ПОМЕСТИТЬ Вт_НормативнаяОценка
		|ИЗ
		|	(ВЫБРАТЬ
		|		ИНАГРО_НормативнаяОценкаЗемлиСрезПоследних.Договор КАК Договор,
		|		ИНАГРО_НормативнаяОценкаЗемлиСрезПоследних.Участок КАК Участок,
		|		ИНАГРО_НормативнаяОценкаЗемлиСрезПоследних.Актуальность КАК Актуальность,
		|		ИНАГРО_НормативнаяОценкаЗемлиСрезПоследних.ДоляЗемельногоПая КАК ДоляЗемельногоПая,
		|		ИНАГРО_НормативнаяОценкаЗемлиСрезПоследних.НормативнаяОценкаЗемли КАК НормативнаяОценкаЗемли,
		|		ИНАГРО_НормативнаяОценкаЗемлиСрезПоследних.ПроцентВыплаты КАК ПроцентВыплаты,
		|		ИНАГРО_НормативнаяОценкаЗемлиСрезПоследних.СуммаАренднойПлаты КАК СуммаАренднойПлаты,
		|		ИНАГРО_НормативнаяОценкаЗемлиСрезПоследних.НормативнаяОценкаЗемлиЕдПлощади КАК НормативнаяОценкаЗемлиЕдПлощади,
		|		ИНАГРО_НормативнаяОценкаЗемлиСрезПоследних.Период КАК Период
		|	ИЗ
		|		РегистрСведений.ИНАГРО_НормативнаяОценкаЗемли.СрезПоследних(
		|				&ДатаНач,
		|				НЕ Участок.Загрязненные
		|					И Участок.Поле.ИНАГРО_ВидПоля <> ЗНАЧЕНИЕ(Перечисление.ИНАГРО_ВидыПолей.ПустаяСсылка)) КАК ИНАГРО_НормативнаяОценкаЗемлиСрезПоследних
		|	ГДЕ
		|		ИНАГРО_НормативнаяОценкаЗемлиСрезПоследних.Актуальность
		|	
		|	ОБЪЕДИНИТЬ ВСЕ
		|	
		|	ВЫБРАТЬ
		|		ИНАГРО_НормативнаяОценкаЗемлиСрезПоследних.Договор,
		|		ИНАГРО_НормативнаяОценкаЗемлиСрезПоследних.Участок,
		|		ИНАГРО_НормативнаяОценкаЗемлиСрезПоследних.Актуальность,
		|		ИНАГРО_НормативнаяОценкаЗемлиСрезПоследних.ДоляЗемельногоПая,
		...
		|		ИНАГРО_НормативнаяОценкаЗемлиСрезПоследних.НормативнаяОценкаЗемлиЕдПлощади,
		|		ИНАГРО_НормативнаяОценкаЗемлиСрезПоследних.Период
		|	ИЗ
		|		РегистрСведений.ИНАГРО_НормативнаяОценкаЗемли.СрезПоследних(
		|				&ДатаКон,
		|				НЕ Участок.Загрязненные
		...
		|	
		|	ВЫБРАТЬ
		|		АктуальностьЗаГод.Договор,
		|		АктуальностьЗаГод.Участок,
		|		АктуальностьЗаГод.Актуальность,
		|		АктуальностьЗаГод.ДоляЗемельногоПая,
		|		АктуальностьЗаГод.НормативнаяОценкаЗемли,
		|		АктуальностьЗаГод.ПроцентВыплаты,
		|		АктуальностьЗаГод.СуммаАренднойПлаты,
		|		АктуальностьЗаГод.НормативнаяОценкаЗемлиЕдПлощади,
		|		АктуальностьЗаГод.Период
		|	ИЗ
		|		(ВЫБРАТЬ
		|			ИНАГРО_НормативнаяОценкаЗемли.Период КАК Период,
		|			ИНАГРО_НормативнаяОценкаЗемли.Организация КАК Организация,
		|			ИНАГРО_НормативнаяОценкаЗемли.Договор КАК Договор,
		|			ИНАГРО_НормативнаяОценкаЗемли.Участок КАК Участок,
		|			ИНАГРО_НормативнаяОценкаЗемли.Актуальность КАК Актуальность,
		|			ИНАГРО_НормативнаяОценкаЗемли.ДоляЗемельногоПая КАК ДоляЗемельногоПая,
		|			ИНАГРО_НормативнаяОценкаЗемли.НормативнаяОценкаЗемли КАК НормативнаяОценкаЗемли,
		|			ИНАГРО_НормативнаяОценкаЗемли.ПроцентВыплаты КАК ПроцентВыплаты,
		|			ИНАГРО_НормативнаяОценкаЗемли.СуммаАренднойПлаты КАК СуммаАренднойПлаты,
		|			ИНАГРО_НормативнаяОценкаЗемли.НормативнаяОценкаЗемлиЕдПлощади КАК НормативнаяОценкаЗемлиЕдПлощади
		|		ИЗ
		|			РегистрСведений.ИНАГРО_НормативнаяОценкаЗемли КАК ИНАГРО_НормативнаяОценкаЗемли
		|		ГДЕ
		|			ИНАГРО_НормативнаяОценкаЗемли.Период МЕЖДУ &ДатаНач И &ДатаКон
		|			И НЕ ИНАГРО_НормативнаяОценкаЗемли.Участок.Загрязненные
		|			И ИНАГРО_НормативнаяОценкаЗемли.Участок.Поле.ИНАГРО_ВидПоля <> ЗНАЧЕНИЕ(Перечисление.ИНАГРО_ВидыПолей.ПустаяСсылка)
		|			И ИНАГРО_НормативнаяОценкаЗемли.Актуальность) КАК АктуальностьЗаГод
		...
		|				И НЕ ИНАГРО_НормативнаяОценкаЗемли.Участок.Загрязненные
		|				И ИНАГРО_НормативнаяОценкаЗемли.Участок.Поле.ИНАГРО_ВидПоля <> ЗНАЧЕНИЕ(Перечисление.ИНАГРО_ВидыПолей.ПустаяСсылка)
		|				И НЕ ИНАГРО_НормативнаяОценкаЗемли.Актуальность) КАК ОтменаАктуальностиЗаГод
		|			ПО АктуальностьЗаГод.Организация = ОтменаАктуальностиЗаГод.Организация
		|				И АктуальностьЗаГод.Договор = ОтменаАктуальностиЗаГод.Договор
		|				И АктуальностьЗаГод.Участок = ОтменаАктуальностиЗаГод.Участок
		|				И АктуальностьЗаГод.Период < ОтменаАктуальностиЗаГод.Период) КАК НормативнаяОценка
		|		ЛЕВОЕ СОЕДИНЕНИЕ (ВЫБРАТЬ
		|			ИНАГРО_НормативнаяОценкаЗемлиНаНачалоПериода.Участок КАК Участок,
		|			ИНАГРО_НормативнаяОценкаЗемлиНаНачалоПериода.Актуальность КАК Актуальность,
		|			ИНАГРО_НормативнаяОценкаЗемлиНаНачалоПериода.Участок.КодКОАТУУ КАК УчастокКодКОАТУУ
		|		ИЗ
		|			РегистрСведений.ИНАГРО_НормативнаяОценкаЗемли.СрезПоследних(
		|					&ДатаНач,
		|					НЕ Участок.Загрязненные
		|						И Участок.Поле.ИНАГРО_ВидПоля <> ЗНАЧЕНИЕ(Перечисление.ИНАГРО_ВидыПолей.ПустаяСсылка)) КАК ИНАГРО_НормативнаяОценкаЗемлиНаНачалоПериода
		|				ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.ИНАГРО_НормативнаяОценкаЗемли.СрезПоследних(
		|						&ДатаКон,
		|						НЕ Участок.Загрязненные
		|							И Участок.Поле.ИНАГРО_ВидПоля <> ЗНАЧЕНИЕ(Перечисление.ИНАГРО_ВидыПолей.ПустаяСсылка)) КАК ИНАГРО_НормативнаяОценкаЗемлиНаКонецПериода
		|				ПО ИНАГРО_НормативнаяОценкаЗемлиНаНачалоПериода.Участок = ИНАГРО_НормативнаяОценкаЗемлиНаКонецПериода.Участок
		|		ГДЕ
		|			ИНАГРО_НормативнаяОценкаЗемлиНаКонецПериода.Актуальность
		|			И ИНАГРО_НормативнаяОценкаЗемлиНаНачалоПериода.Актуальность
		|		
		|		СГРУППИРОВАТЬ ПО
		|			ИНАГРО_НормативнаяОценкаЗемлиНаНачалоПериода.Актуальность,
		|			ИНАГРО_НормативнаяОценкаЗемлиНаНачалоПериода.Участок,
		|			ИНАГРО_НормативнаяОценкаЗемлиНаНачалоПериода.Участок.КодКОАТУУ) КАК ГодоваяАктуальность
		|		ПО НормативнаяОценка.Участок = ГодоваяАктуальность.Участок
		|;
		|
		|////////////////////////////////////////////////////////////////////////////////
		|ВЫБРАТЬ
		|	ДоговорыКонтрагентов.Ссылка КАК Ссылка,
		|	Вт_НормативнаяОценка.Договор КАК Договор,
		|	Вт_НормативнаяОценка.Участок КАК Участок,
		|	Вт_НормативнаяОценка.Актуальность КАК Актуальность,
		|	Вт_НормативнаяОценка.ДоляЗемельногоПая КАК ДоляЗемельногоПая,
		|	Вт_НормативнаяОценка.НормативнаяОценкаЗемли КАК НормативнаяОценкаЗемли,
		|	Вт_НормативнаяОценка.ПроцентВыплаты КАК ПроцентВыплаты,
		|	Вт_НормативнаяОценка.СуммаАренднойПлаты КАК СуммаАренднойПлаты,
		|	Вт_НормативнаяОценка.НормативнаяОценкаЗемлиЕдПлощади КАК НормативнаяОценкаЗемлиЕдПлощади,
		|	Вт_НормативнаяОценка.Период КАК Период,
		|	ВЫБОР
		|		КОГДА Вт_НормативнаяОценка.ГодоваяАктуальность
		|			ТОГДА 12
		|		ИНАЧЕ РАЗНОСТЬДАТ(ВЫБОР
		|					КОГДА НАЧАЛОПЕРИОДА(ДоговорыКонтрагентов.Дата, МЕСЯЦ) >= НАЧАЛОПЕРИОДА(&ДатаНач, МЕСЯЦ)
		|						ТОГДА НАЧАЛОПЕРИОДА(ДоговорыКонтрагентов.Дата, МЕСЯЦ)
		|					ИНАЧЕ НАЧАЛОПЕРИОДА(&ДатаНач, МЕСЯЦ)
		|				КОНЕЦ, ВЫБОР
		|					КОГДА КОНЕЦПЕРИОДА(ДоговорыКонтрагентов.ИНАГРО_СрокДействия, МЕСЯЦ) <= КОНЕЦПЕРИОДА(&ДатаКон, МЕСЯЦ)
		|						ТОГДА КОНЕЦПЕРИОДА(ДОБАВИТЬКДАТЕ(ДоговорыКонтрагентов.ИНАГРО_СрокДействия, ДЕНЬ, 1), МЕСЯЦ)
		|					ИНАЧЕ КОНЕЦПЕРИОДА(ДОБАВИТЬКДАТЕ(&ДатаКон, ДЕНЬ, 1), МЕСЯЦ)
		|				КОНЕЦ, МЕСЯЦ)
		|	КОНЕЦ КАК Месяцев,
		|	Вт_НормативнаяОценка.Участок.ПлощадьФизическая КАК ПлощадьФизическая,
		|	Вт_НормативнаяОценка.Участок.Поле.ИНАГРО_ВидПоля КАК ВидПоля,
		|	ВЫБОР
		|		КОГДА Вт_НормативнаяОценка.Участок.ТипУчастка = ЗНАЧЕНИЕ(Перечисление.ИНАГРО_ТипУчастка.Собственный)
		|			ТОГДА ""1""
		|		КОГДА Вт_НормативнаяОценка.Участок.ТипУчастка = ЗНАЧЕНИЕ(Перечисление.ИНАГРО_ТипУчастка.ПостоянноеИспользование)
		|			ТОГДА ""2""
		|		КОГДА Вт_НормативнаяОценка.Участок.ТипУчастка = ЗНАЧЕНИЕ(Перечисление.ИНАГРО_ТипУчастка.Аренда)
		|			ТОГДА ""3""
		|		КОГДА Вт_НормативнаяОценка.Участок.ТипУчастка = ЗНАЧЕНИЕ(Перечисление.ИНАГРО_ТипУчастка.ПровоНаПай)
		|			ТОГДА ""4""
		|		ИНАЧЕ """"
		|	КОНЕЦ КАК ВидПрава,
		|	Вт_НормативнаяОценка.Участок.Поле.ИНАГРО_Район КАК Район,
		|	Вт_НормативнаяОценка.Участок.ПроведенаНормативнаяОценка КАК ПроведенаНормативнаяОценка,
		|	ИНАГРО_СтавкиЗемельногоНалогаСрезПоследних.Ставка КАК Ставка,
		|	Вт_НормативнаяОценка.ГодоваяАктуальность КАК ГодоваяАктуальность
		|ПОМЕСТИТЬ Вт_ДоговорыПериоды
		|ИЗ
		|	Вт_НормативнаяОценка КАК Вт_НормативнаяОценка
		|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Справочник.ДоговорыКонтрагентов КАК ДоговорыКонтрагентов
		|		ПО Вт_НормативнаяОценка.Договор = ДоговорыКонтрагентов.Ссылка
		|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.ИНАГРО_СтавкиЗемельногоНалога.СрезПоследних(&ДатаКон, ) КАК ИНАГРО_СтавкиЗемельногоНалогаСрезПоследних
		|		ПО Вт_НормативнаяОценка.Участок.Поле.ИНАГРО_ЦелевоеНазначение = ИНАГРО_СтавкиЗемельногоНалогаСрезПоследних.ЦелевоеНазначение
		|ГДЕ
		|	ДоговорыКонтрагентов.Организация = &Организация
		|	И ДоговорыКонтрагентов.ВидДоговора = ЗНАЧЕНИЕ(Перечисление.ВидыДоговоровКонтрагентов.ИНАГРО_АрендаЗемли)
		|	И НЕ ДоговорыКонтрагентов.ПометкаУдаления
		|	И ДоговорыКонтрагентов.ИНАГРО_СрокДействия >= &ДатаНач
		|	И ДоговорыКонтрагентов.Дата <= &ДатаКон
		|;
		|
		|////////////////////////////////////////////////////////////////////////////////
		|ВЫБРАТЬ
		|	СУММА(Вт_ДоговорыПериоды.ДоляЗемельногоПая) КАК ДоляЗемельногоПая,
		|	Вт_ДоговорыПериоды.НормативнаяОценкаЗемли КАК НормативнаяОценкаЗемли,
		|	Вт_ДоговорыПериоды.НормативнаяОценкаЗемлиЕдПлощади КАК НормативнаяОценкаЗемлиЕдПлощади,
		|	Вт_ДоговорыПериоды.Месяцев КАК Месяцев,
		|	Вт_ДоговорыПериоды.Период КАК Период,
		|	Вт_ДоговорыПериоды.Участок.КадастровыйНомер КАК КадастровыйНомер,
		|	Вт_ДоговорыПериоды.ПлощадьФизическая КАК ПлощадьФизическая,
		|	Вт_ДоговорыПериоды.ВидПоля КАК ВидПоля,
		|	Вт_ДоговорыПериоды.ВидПрава КАК ВидПрава,
		|	Вт_ДоговорыПериоды.Район КАК Район,
		|	Вт_ДоговорыПериоды.ПроведенаНормативнаяОценка КАК ПроведенаНормативнаяОценка,
		|	Вт_ДоговорыПериоды.Ставка КАК Ставка,
		|	Вт_ДоговорыПериоды.ПроцентВыплаты КАК ПроцентВыплаты,
		|	Вт_ДоговорыПериоды.ГодоваяАктуальность КАК ГодоваяАктуальность
		|ПОМЕСТИТЬ Вт_ГруппировкаНаследников
		|ИЗ
		|	Вт_ДоговорыПериоды КАК Вт_ДоговорыПериоды
		|ГДЕ
		|	Вт_ДоговорыПериоды.Месяцев <> 0
		|
		|СГРУППИРОВАТЬ ПО
		|	Вт_ДоговорыПериоды.НормативнаяОценкаЗемлиЕдПлощади,
		|	Вт_ДоговорыПериоды.Месяцев,
		|	Вт_ДоговорыПериоды.Период,
		|	Вт_ДоговорыПериоды.Участок.КадастровыйНомер,
		|	Вт_ДоговорыПериоды.ВидПрава,
		|	Вт_ДоговорыПериоды.Район,
		|	Вт_ДоговорыПериоды.ВидПоля,
		|	Вт_ДоговорыПериоды.НормативнаяОценкаЗемли,
		|	Вт_ДоговорыПериоды.ПлощадьФизическая,
		|	Вт_ДоговорыПериоды.ПроведенаНормативнаяОценка,
		|	Вт_ДоговорыПериоды.Ставка,
		|	Вт_ДоговорыПериоды.ПроцентВыплаты,
		|	Вт_ДоговорыПериоды.ГодоваяАктуальность
		|;
		|
		|////////////////////////////////////////////////////////////////////////////////
		|ВЫБРАТЬ
		|	Вт_ГруппировкаНаследников.КадастровыйНомер КАК КадастровыйНомер,
		|	Вт_ГруппировкаНаследников.ДоляЗемельногоПая КАК ДоляЗемельногоПая,
		|	Вт_ГруппировкаНаследников.НормативнаяОценкаЗемли * ВЫБОР
		|		КОГДА ЕСТЬNULL(Вт_ГруппировкаНаследников.ДоляЗемельногоПая, 1) = 0
		|				ИЛИ ЕСТЬNULL(Вт_ГруппировкаНаследников.ДоляЗемельногоПая, 1) > 1
		|			ТОГДА 1
		|		ИНАЧЕ ЕСТЬNULL(Вт_ГруппировкаНаследников.ДоляЗемельногоПая, 1)
		|	КОНЕЦ КАК НормативнаяОценкаЗемли,
		|	Вт_ГруппировкаНаследников.НормативнаяОценкаЗемлиЕдПлощади КАК НормативнаяОценкаЗемлиЕдПлощади,
		|	СУММА(Вт_ГруппировкаНаследников.Месяцев) КАК КоличествоМесяцев,
		|	Вт_ГруппировкаНаследников.ГодоваяАктуальность КАК ГодоваяАктуальность,
		|	Вт_ГруппировкаНаследников.ПлощадьФизическая * ВЫБОР
		|		КОГДА ЕСТЬNULL(Вт_ГруппировкаНаследников.ДоляЗемельногоПая, 1) = 0
		|				ИЛИ ЕСТЬNULL(Вт_ГруппировкаНаследников.ДоляЗемельногоПая, 1) > 1
		|			ТОГДА 1
		|		ИНАЧЕ ЕСТЬNULL(Вт_ГруппировкаНаследников.ДоляЗемельногоПая, 1)
		|	КОНЕЦ КАК ПлощадьФизическая,
		|	Вт_ГруппировкаНаследников.ВидПоля КАК ВидПоля,
		|	Вт_ГруппировкаНаследников.ВидПрава КАК ВидПрава,
		|	Вт_ГруппировкаНаследников.Район КАК Район,
		|	Вт_ГруппировкаНаследников.ПроведенаНормативнаяОценка КАК ПроведенаНормативнаяОценка,
		|	ЕСТЬNULL(Вт_ГруппировкаНаследников.Ставка, 0) КАК Ставка,
		|	Вт_ГруппировкаНаследников.ПроцентВыплаты КАК ПроцентВыплаты
		|ПОМЕСТИТЬ Вт_ГруппировкаМесяцев
		|ИЗ
		|	Вт_ГруппировкаНаследников КАК Вт_ГруппировкаНаследников
		|
		|СГРУППИРОВАТЬ ПО
		|	Вт_ГруппировкаНаследников.КадастровыйНомер,
		|	Вт_ГруппировкаНаследников.ДоляЗемельногоПая,
		|	Вт_ГруппировкаНаследников.НормативнаяОценкаЗемлиЕдПлощади,
		|	Вт_ГруппировкаНаследников.ВидПоля,
		|	Вт_ГруппировкаНаследников.ВидПрава,
		|	Вт_ГруппировкаНаследников.Район,
		|	Вт_ГруппировкаНаследников.ПроведенаНормативнаяОценка,
		|	ЕСТЬNULL(Вт_ГруппировкаНаследников.Ставка, 0),
		|	Вт_ГруппировкаНаследников.ПроцентВыплаты,
		|	Вт_ГруппировкаНаследников.ГодоваяАктуальность,
		|	Вт_ГруппировкаНаследников.ПлощадьФизическая * ВЫБОР
		|		КОГДА ЕСТЬNULL(Вт_ГруппировкаНаследников.ДоляЗемельногоПая, 1) = 0
		|				ИЛИ ЕСТЬNULL(Вт_ГруппировкаНаследников.ДоляЗемельногоПая, 1) > 1
		|			ТОГДА 1
		...
		|////////////////////////////////////////////////////////////////////////////////
		|ВЫБРАТЬ
		|	Вт_ГруппировкаМесяцев.КадастровыйНомер КАК КадастровыйНомер,
		|	Вт_ГруппировкаМесяцев.ДоляЗемельногоПая КАК ДоляЗемельногоПая,
		|	Вт_ГруппировкаМесяцев.НормативнаяОценкаЗемли КАК НормативнаяОценкаЗемли,
		|	Вт_ГруппировкаМесяцев.НормативнаяОценкаЗемлиЕдПлощади КАК НормативнаяОценкаЗемлиЕдПлощади,
		|	ВЫБОР
		|		КОГДА Вт_ГруппировкаМесяцев.ГодоваяАктуальность
		|			ТОГДА 12
		|		ИНАЧЕ Вт_ГруппировкаМесяцев.КоличествоМесяцев
		|	КОНЕЦ КАК КоличествоМесяцев,
		|	Вт_ГруппировкаМесяцев.ГодоваяАктуальность КАК ГодоваяАктуальность,
		|	Вт_ГруппировкаМесяцев.ПлощадьФизическая КАК ПлощадьФизическая,
		|	Вт_ГруппировкаМесяцев.ВидПоля КАК ВидПоля,
		|	Вт_ГруппировкаМесяцев.ВидПрава КАК ВидПрава,
		|	Вт_ГруппировкаМесяцев.Район КАК Район,
		|	Вт_ГруппировкаМесяцев.ПроведенаНормативнаяОценка КАК ПроведенаНормативнаяОценка,
		|	Вт_ГруппировкаМесяцев.Ставка КАК Ставка,
		|	Вт_ГруппировкаМесяцев.ПроцентВыплаты КАК ПроцентВыплаты
		|ИЗ
		|	Вт_ГруппировкаМесяцев КАК Вт_ГруппировкаМесяцев
		|ГДЕ
		|	Вт_ГруппировкаМесяцев.ПроведенаНормативнаяОценка = &ПроведенаНО
		|
		|УПОРЯДОЧИТЬ ПО
		|	КадастровыйНомер";
	...
	Иначе  
		...
		|						НЕ Участок.Загрязненные
		|							И Участок.Поле.ИНАГРО_ВидПоля <> ЗНАЧЕНИЕ(Перечисление.ИНАГРО_ВидыПолей.ПустаяСсылка)) КАК ИНАГРО_НормативнаяОценкаЗемлиНаКонецПериода
		|				ПО ИНАГРО_НормативнаяОценкаЗемлиНаНачалоПериода.Участок.КадастровыйНомер = ИНАГРО_НормативнаяОценкаЗемлиНаКонецПериода.Участок.КадастровыйНомер
		|		ГДЕ
		|			ИНАГРО_НормативнаяОценкаЗемлиНаКонецПериода.Актуальность
		|			И ИНАГРО_НормативнаяОценкаЗемлиНаНачалоПериода.Актуальность
		|		
		...
		|			ИНАГРО_НормативнаяОценкаЗемлиНаНачалоПериода.Участок,
		|			ИНАГРО_НормативнаяОценкаЗемлиНаНачалоПериода.Участок.КодКОАТУУ) КАК ГодоваяАктуальность
		|		ПО НормативнаяОценка.Участок.КадастровыйНомер = ГодоваяАктуальность.Участок.КадастровыйНомер
		|;
		|
		|////////////////////////////////////////////////////////////////////////////////
		|ВЫБРАТЬ
		...
		|////////////////////////////////////////////////////////////////////////////////
		|ВЫБРАТЬ
		|	СУММА(Вт_ДоговорыПериоды.НормативнаяОценкаЗемли) КАК НормативнаяОценкаЗемли,
		|	Вт_ДоговорыПериоды.НормативнаяОценкаЗемлиЕдПлощади КАК НормативнаяОценкаЗемлиЕдПлощади,
		|	Вт_ДоговорыПериоды.Месяцев КАК Месяцев,
		|	Вт_ДоговорыПериоды.Период КАК Период,
		|	Вт_ДоговорыПериоды.Участок.КадастровыйНомер КАК КадастровыйНомер,
		|	СУММА(Вт_ДоговорыПериоды.ПлощадьФизическая) КАК ПлощадьФизическая,
		|	Вт_ДоговорыПериоды.ВидПоля КАК ВидПоля,
		|	Вт_ДоговорыПериоды.ВидПрава КАК ВидПрава,
		|	Вт_ДоговорыПериоды.Район КАК Район,
		|	Вт_ДоговорыПериоды.ПроведенаНормативнаяОценка КАК ПроведенаНормативнаяОценка,
		...
		|ВЫБРАТЬ
		|	Вт_ГруппировкаНаследников.КадастровыйНомер КАК КадастровыйНомер,
		|	Вт_ГруппировкаНаследников.НормативнаяОценкаЗемли КАК НормативнаяОценкаЗемли,
		|	Вт_ГруппировкаНаследников.НормативнаяОценкаЗемлиЕдПлощади КАК НормативнаяОценкаЗемлиЕдПлощади,
		|	СУММА(Вт_ГруппировкаНаследников.Месяцев) КАК КоличествоМесяцев,
		|	Вт_ГруппировкаНаследников.ГодоваяАктуальность КАК ГодоваяАктуальность,
		|	Вт_ГруппировкаНаследников.ПлощадьФизическая КАК ПлощадьФизическая,
		|	Вт_ГруппировкаНаследников.ВидПоля КАК ВидПоля,
		|	Вт_ГруппировкаНаследников.ВидПрава КАК ВидПрава,
		|	Вт_ГруппировкаНаследников.Район КАК Район,
		|	Вт_ГруппировкаНаследников.ПроведенаНормативнаяОценка КАК ПроведенаНормативнаяОценка,
		...
		|	Вт_ГруппировкаНаследников.КадастровыйНомер,
		|	Вт_ГруппировкаНаследников.НормативнаяОценкаЗемлиЕдПлощади,
		|	Вт_ГруппировкаНаследников.НормативнаяОценкаЗемли,
		|	Вт_ГруппировкаНаследников.ПлощадьФизическая,
		|	Вт_ГруппировкаНаследников.ВидПоля,
		|	Вт_ГруппировкаНаследников.ВидПрава,
		|	Вт_ГруппировкаНаследников.Район,
		|	Вт_ГруппировкаНаследников.ПроведенаНормативнаяОценка,
...
&НаСервере
Процедура ЗаполнитьМЗЗ(ПараметрыЗаполненияЗвит1С)

	Запрос = ПодготовитьЗапросМЗЗ();
	
	Запрос.УстановитьПараметр("ДатаКон", СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета);  
	Запрос.УстановитьПараметр("ДатаНач", СтруктураРеквизитовФормы.мДатаНачалаПериодаОтчета);
	Запрос.УстановитьПараметр("Организация", СтруктураРеквизитовФормы.Организация);
	Запрос.УстановитьПараметр("ПроведенаНО", Истина); 
	Запрос.УстановитьПараметр("КорректироватьПлощади", СтруктураРеквизитовФормы.КорректироватьПлощади); 
	...
	Если НЕ РезультатЗапроса.Пустой() Тогда
		...
		СоответствиеПолейТаблица.Вставить("MZT1RXXXXG2S",  	"КадастровыйНомер");
		СоответствиеПолейТаблица.Вставить("MZT1RXXXXG3",  	"НормативнаяОценкаЗемли");
		СоответствиеПолейТаблица.Вставить("MZT1RXXXXG4",  	"КоличествоМесяцев");  
		СоответствиеПолейТаблица.Вставить("MZT1RXXXXG5",  	"ПлощадьФизическая");  
						
		ДанныеФормы 	= ЭтаФорма[СтруктураРеквизитовФормы.мИдГруппыMZ1];
		Таблица = ДанныеФормыВЗначение(ДанныеФормы, Тип("ТаблицаЗначений"));
		Таблица.Очистить();
		...
		Пока Результат.Следующий() Цикл
			...
			Для каждого ПолеТаблицы Из СоответствиеПолейТаблица Цикл
				...
				СтрокаТаблицы[ПолеТаблицы.Ключ]	= Результат[ПолеТаблицы.Значение];
	
			КонецЦикла;
			
		КонецЦикла;
		
		Пока Таблица.Количество() < мСтруктураИсхКолвоСтрокРазделов[СтруктураРеквизитовФормы.мИдГруппыMZ1] Цикл
			Таблица.Добавить();
		КонецЦикла;
		ЗначениеВРеквизитФормы(Таблица, СтруктураРеквизитовФормы.мИдГруппыMZ1);
		
	КонецЕсли;
	
	Запрос.УстановитьПараметр("ПроведенаНО", Ложь);
	РезультатЗапроса = Запрос.Выполнить();  
	...
	Если НЕ РезультатЗапроса.Пустой() Тогда
		...
		СоответствиеПолейТаблица = Новый Структура();
		СоответствиеПолейТаблица.Вставить("MZT2RXXXXG2S",  	"КадастровыйНомер");
		СоответствиеПолейТаблица.Вставить("MZT2RXXXXG3",  	"НормативнаяОценкаЗемлиЕдПлощади");
		СоответствиеПолейТаблица.Вставить("MZT2RXXXXG4",  	"КоличествоМесяцев");  
		СоответствиеПолейТаблица.Вставить("MZT2RXXXXG5",  	"ПлощадьФизическая");  
						
		ДанныеФормы 	= ЭтаФорма[СтруктураРеквизитовФормы.мИдГруппыMZ2];
		Таблица = ДанныеФормыВЗначение(ДанныеФормы, Тип("ТаблицаЗначений"));
		Таблица.Очистить();
		...
		Пока Таблица.Количество() < мСтруктураИсхКолвоСтрокРазделов[СтруктураРеквизитовФормы.мИдГруппыMZ2] Цикл
			Таблица.Добавить();
		КонецЦикла;
		ЗначениеВРеквизитФормы(Таблица, СтруктураРеквизитовФормы.мИдГруппыMZ2);
