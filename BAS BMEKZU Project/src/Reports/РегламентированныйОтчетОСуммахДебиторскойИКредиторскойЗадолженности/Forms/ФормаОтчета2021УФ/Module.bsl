...
Процедура ЗаполнитьСведенияОбОрганизации(Форма)
	...
	ЗаполнитьПоказательНаСервере("ЕДРПОУ", ЕДРПОУ, Форма, "ОтчетОДебиторскойИКредиторскойЗадолженности");
	...
	Если ЗначениеЗаполнено(КодКАТОТТГ) Тогда
		ЗаполнитьПоказательНаСервере("КАТОТТГ", КодКАТОТТГ, Форма, "ОтчетОДебиторскойИКредиторскойЗадолженности");
		ЗаполнитьПоказательНаСервере("КОАТУУ", "", Форма, "ОтчетОДебиторскойИКредиторскойЗадолженности");
	Иначе	
		ЗаполнитьПоказательНаСервере("КОАТУУ", КодКОАТУУ, Форма, "ОтчетОДебиторскойИКредиторскойЗадолженности");
		ЗаполнитьПоказательНаСервере("КАТОТТГ", "", Форма, "ОтчетОДебиторскойИКредиторскойЗадолженности");
	КонецЕсли;
	...
	РегламентированнаяОтчетностьКлиентСервер.ПроставитьВКвадратыЗначения(Форма, "ОтчетОДебиторскойИКредиторскойЗадолженности", "КОАТУУ"+"_",  10, КодКОАТУУ, Ложь);		
