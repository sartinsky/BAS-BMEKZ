			...
			Если НЕ СтрокаПриемаУвольнений = Неопределено Тогда
				...
				ИначеЕсли ЗначениеЗаполнено(ДатаПриема)
					...
					Если ДатаПриема <= ДатаУвольнения Тогда
						...
						ДатаКон = День(ДатаУвольнения + 1);
						Дней = День(ДатаУвольнения + 1) - День(ДатаПриема) + 1;					
					Иначе	
						...
						Дней = День(ДатаУвольнения + 1) + (День(КонецВЦикле) - День(ДатаПриема) + 1);
