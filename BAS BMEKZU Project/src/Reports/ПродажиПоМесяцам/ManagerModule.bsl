...
Функция ПолучитьТекстЗаголовка(ПараметрыОтчета, ОрганизацияВНачале = Истина) Экспорт 
	...
	Возврат НСтр("ru='Продажи по месяцам за ';uk='Продажі по місяцях за '") + Формат(ПараметрыОтчета.НачалоПериода, "ДФ=yyyy; ДП=...") + " - " + Формат(ПараметрыОтчета.КонецПериода, "ДФ=yyyy; ДП=...");
...
Функция ВариантыНастроек() Экспорт
	...
	Массив.Добавить(Новый Структура("Имя, Представление","ПродажиПоМесяцам", НСтр("ru='Продажи по месяцам';uk='Продажі по місяцях'")));
...
Процедура ЗаполнитьПараметрыРасшифровкиОтчета(Адрес, Расшифровка, ПараметрыРасшифровки) Экспорт
	...
	СписокПунктовМеню.Добавить("Продажи", НСтр("ru='Продажи по номенклатурным группам';uk='Продажі по номенклатурних групах'"));
