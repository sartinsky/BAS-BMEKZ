...
Функция ДатыЗапретаПодготовленные(ПараметрыДанных)
	...
	Для Каждого Строка Из Таблица Цикл
		...
		Если Строка.АдресатНастройки = Перечисления.ВидыНазначенияДатЗапрета.ДляВсехПользователей Тогда
			Строка.АдресатНастройкиПредставление = НСтр("ru='Для всех пользователей, кроме указанных';uk='Для всіх користувачів, крім зазначених'");
		Иначе
		...
		Если Строка.ВладелецНастройки = Перечисления.ВидыНазначенияДатЗапрета.ДляВсехПользователей Тогда
			Строка.ВладелецНастройкиПредставление = НСтр("ru='Для всех пользователей, кроме указанных';uk='Для всіх користувачів, крім зазначених'");
		Иначе
