...
Перем мВерсияОтчета Экспорт; // Хранит версию отчета	
Перем мПолноеИмяФайлаВнешнейОбработки Экспорт; // Хранит полное имя файла внешней обработки
