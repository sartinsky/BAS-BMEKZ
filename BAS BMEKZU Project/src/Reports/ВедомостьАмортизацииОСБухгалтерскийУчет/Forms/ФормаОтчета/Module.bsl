...
Процедура ЗаполнитьНастройкамиПоУмолчанию(ЗаполняемыеНастройки) Экспорт
	...
	Если ЗаполняемыеНастройки.Свойство("Группировка") Тогда
		Если ЗаполняемыеНастройки.Группировка Тогда
			...
			НоваяСтрока.Использование  = Ложь;
			НоваяСтрока.Представление  = НСтр("ru='Налоговая группа ОС';uk='Податкова група ОЗ'");
			НоваяСтрока.ТипГруппировки = 0;
	...
	Если ЗаполняемыеНастройки.Свойство("ДополнительныеПоля") Тогда
		Если ЗаполняемыеНастройки.ДополнительныеПоля Тогда
			...
			НоваяСтрока = Отчет.ДополнительныеПоля.Добавить();
			НоваяСтрока.Поле           = "СпособНачисленияАмортизацииНУ";
			НоваяСтрока.Представление  = НСтр("ru='Способ начисления амортизации НУ';uk='Спосіб нарахування амортизації ПО'");
			НоваяСтрока.Использование  = Ложь;
			
			НоваяСтрока = Отчет.ДополнительныеПоля.Добавить();
			НоваяСтрока.Поле           = "ПараметрВыработки";
			НоваяСтрока.Представление  = НСтр("ru='Параметр выработки';uk='Параметр виробітку'");
			НоваяСтрока.Использование  = Ложь;
			...
			НоваяСтрока = Отчет.ДополнительныеПоля.Добавить();
			НоваяСтрока.Поле           = "ОбъемПродукцииРабот";
			НоваяСтрока.Представление  = НСтр("ru='Предполагаемый объем продукции (работ) в натуральных ед.';uk='Передбачуваний обсяг продукції (робіт) у натуральних од.'");
			НоваяСтрока.Использование  = Ложь;
			
			НоваяСтрока = Отчет.ДополнительныеПоля.Добавить();
			НоваяСтрока.Поле           = "СрокИспользованияДляВычисленияАмортизации";
			НоваяСтрока.Представление  = НСтр("ru='Срок полезного использования, мес.';uk='Строк корисного використання, міс.'");
			НоваяСтрока.Использование  = Ложь;
			
			НоваяСтрока = Отчет.ДополнительныеПоля.Добавить();
			НоваяСтрока.Поле           = "СрокИспользованияДляВычисленияАмортизацииНУ";
			НоваяСтрока.Представление  = НСтр("ru='Срок полезного использования, мес. НУ';uk='Строк корисного використання, міс. ПО'");
			НоваяСтрока.Использование  = Ложь;
			
			НоваяСтрока = Отчет.ДополнительныеПоля.Добавить();
			НоваяСтрока.Поле           = "СтоимостьДляВычисленияАмортизации";
			НоваяСтрока.Представление  = НСтр("ru='Стоимость для вычисления амортизации';uk='Вартість для обчислення амортизації'");
			НоваяСтрока.Использование  = Ложь;
			
			НоваяСтрока = Отчет.ДополнительныеПоля.Добавить();
			НоваяСтрока.Поле           = "СтоимостьДляВычисленияАмортизацииНУ";
			НоваяСтрока.Представление  = НСтр("ru='Стоимость для вычисления амортизации НУ';uk='Вартість для обчислення амортизації ПО'");
			НоваяСтрока.Использование  = Ложь;
			...
			НоваяСтрока = Отчет.ДополнительныеПоля.Добавить();
			НоваяСтрока.Поле           = "СпособыОтраженияРасходовПоАмортизации";
			НоваяСтрока.Представление  = НСтр("ru='Способы отражения расходов по амортизации';uk='Способи відображення витрат по амортизації'");
			НоваяСтрока.Использование  = Ложь;
