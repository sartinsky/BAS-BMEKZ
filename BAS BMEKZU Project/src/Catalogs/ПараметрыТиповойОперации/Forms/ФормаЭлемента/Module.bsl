...
Процедура УправлениеФормой(Форма);
	...
	ИначеЕсли Форма.ОписаниеТипа.СодержитТип(Тип("СправочникСсылка.БанковскиеСчета")) Тогда
		ПодсказкаВвода = "Контрагент (владелец банковского счета)";
		ДоступностьСвязи = Истина;
	...
	Если ДоступностьСвязи Тогда
		ЭлементыФормы.СтраницыСвязьПоВладельцу.ТекущаяСтраница = ЭлементыФормы.СтраницаСвязьПоВладельцу;
	Иначе
		ЭлементыФормы.СтраницыСвязьПоВладельцу.ТекущаяСтраница = ЭлементыФормы.ПустаяСтраница;
	КонецЕсли;
	
	ЭлементыФормы.СвязьПоВладельцу.Доступность				 = ДоступностьСвязи;
...
Процедура СвязьПоВладельцуНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	ИначеЕсли ОписаниеТипа.СодержитТип(Тип("СправочникСсылка.БанковскиеСчета")) Тогда
		ПараметрыОтбора.Вставить("ТипПараметра", Новый ОписаниеТипов("СправочникСсылка.Контрагенты"));
