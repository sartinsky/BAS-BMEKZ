...
Процедура УправлениеФормой(Форма)
	...
	Если ХарактерЗатрат = "ОПЗ" Тогда
		Элементы.НалоговоеНазначениеДоходовИЗатрат.Заголовок = "Нал. назн. затрат до 01.08.2011 для ОПЗ";
	Иначе
		Элементы.НалоговоеНазначениеДоходовИЗатрат.Заголовок = "Нал. назн. затрат";
	КонецЕсли;
