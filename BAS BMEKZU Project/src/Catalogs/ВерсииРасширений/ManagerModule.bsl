...
// а также из формы установки расширений конфигурации в режиме клиентского приложения платформы.
//
...
Функция РасширенияИзмененыДинамически() Экспорт
	...
	Возврат ПараметрыСеанса.УстановленныеРасширения.Основные    <> УстановленныеРасширения.Основные
	    Или ПараметрыСеанса.УстановленныеРасширения.Исправления <> УстановленныеРасширения.Исправления;
...
//
Функция КонтрольныеСуммыРасширений(Расширения)
