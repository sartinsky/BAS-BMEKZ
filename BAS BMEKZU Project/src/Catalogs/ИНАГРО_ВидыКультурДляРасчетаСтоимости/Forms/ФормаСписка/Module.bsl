...
Процедура ПодобратьИзМакета(Команда)
	...
	ОткрытьФорму("Справочник.ИНАГРО_ВидыКультурДляРасчетаСтоимости.Форма.ФормаВыбораИзКлассификатора", СтруктураПараметров, ЭтаФорма);
...
Процедура ВопросПодобратьВидКультурыЗавершение(Результат, ДополнительныеПараметры) Экспорт
	...
	Иначе
		ОткрытьФорму("Справочник.ИНАГРО_ВидыКультурДляРасчетаСтоимости.Форма.ФормаЭлемента", ДополнительныеПараметры, ЭтаФорма);
	КонецЕсли;
