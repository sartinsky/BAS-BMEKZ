...
Процедура ЗаполнитьРазделы()
	...
	Если КоличествоОшибок > 0 Тогда
		...
		Для Каждого СтрокаТаблицы Из ОтфильтрованныеВарианты Цикл
			Если ТекущаяПричина <> СтрокаТаблицы.Причина Тогда
				...
				Если ТекущаяПричина = 1 Тогда
					СообщенияОбОшибках.Подробно = СообщенияОбОшибках.Подробно + НСтр("ru='Помеченные на удаление:';uk='Відмічені для вилучення:'");
				ИначеЕсли ТекущаяПричина = 2 Тогда
					СообщенияОбОшибках.Подробно = СообщенияОбОшибках.Подробно + НСтр("ru='Недостаточно прав для изменения:';uk='Недостатньо прав для зміни:'");
				ИначеЕсли ТекущаяПричина = 3 Тогда
					СообщенияОбОшибках.Подробно = СообщенияОбОшибках.Подробно + НСтр("ru='Отчет отключен или недоступен по правам:';uk='Звіт відключений або недоступний по правах:'");
				ИначеЕсли ТекущаяПричина = 4 Тогда
					СообщенияОбОшибках.Подробно = СообщенияОбОшибках.Подробно + НСтр("ru='Вариант отчета отключен по функциональной опции:';uk='Варіант звіту відключено по функціональній опції:'");
				КонецЕсли;
			КонецЕсли;
		...
		Если КоличествоВариантов = 0 Тогда
			СообщенияОбОшибках.Текст = НСтр("ru='Недостаточно прав для размещения в разделах выбранных вариантов отчетов.';uk='Недостатньо прав для розміщення в розділах обраних варіантів звітів.'");
		Иначе
