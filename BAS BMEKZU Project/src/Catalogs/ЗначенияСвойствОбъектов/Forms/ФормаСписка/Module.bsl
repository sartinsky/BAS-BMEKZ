...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ОбщегоНазначенияКлиентСервер.ЭтоМобильныйКлиент() Тогда // Временное решение для работы в мобильном клиенте, будет удалено в следующих версиях
		...
		Элементы.Переместить(Элементы.ОсновныеКоманды, Элементы.ФормаКоманднаяПанель);
		Элементы.Переместить(Элементы.ДополнительныеКоманды, Элементы.ФормаКоманднаяПанель);
	...
	Если ПустаяСтрока(СтрокаЗаголовка) Тогда
		...
		Если ЗначениеЗаполнено(Свойство) Тогда
			Если НЕ Параметры.РежимВыбора Тогда
				СтрокаЗаголовка = НСтр("ru='Значения свойства %1';uk='Значення властивості %1'");
			ИначеЕсли ВыборГрупп Тогда
				СтрокаЗаголовка = НСтр("ru='Выберите группу значений свойства %1';uk='Виберіть групу значень властивості %1'");
			Иначе
				СтрокаЗаголовка = НСтр("ru='Выберите значение свойства %1';uk='Виберіть значення властивості %1'");
			КонецЕсли;
		...
		ИначеЕсли Параметры.РежимВыбора Тогда
			...
			Если ВыборГрупп Тогда
				СтрокаЗаголовка = НСтр("ru='Выберите группу значений свойства';uk='Виберіть групу значень властивості'");
			Иначе
				СтрокаЗаголовка = НСтр("ru='Выберите значение свойства';uk='Виберіть значення властивості'");
			КонецЕсли;
		КонецЕсли;
	КонецЕсли;
