...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ОбщегоНазначенияКлиентСервер.ЭтоМобильныйКлиент() Тогда // Временное решение для работы в мобильном клиенте, будет удалено в следующих версиях
		...
		Для каждого ЭлементФормы Из Элементы.СписокКоманднаяПанель.ПодчиненныеЭлементы Цикл
			
			Элементы.Переместить(ЭлементФормы, Элементы.ФормаКоманднаяПанель);
			
		КонецЦикла;
		
		Элементы.Переместить(Элементы.СписокКлассификатор, Элементы.ФормаКоманднаяПанель);
		Элементы.Переместить(Элементы.СписокВыбратьИзКлассификатора, Элементы.ГруппаДобавитьМобильныйКлиент);
		Элементы.Переместить(Элементы.СписокСоздать, Элементы.ГруппаДобавитьМобильныйКлиент);
		
		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "СписокСоздать", "Заголовок", НСтр("ru='Новый...';uk='Новий...'"));
		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "СписокСоздать", "ТолькоВоВсехДействиях", Ложь);
		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "СписокСоздать", "Картинка", БиблиотекаКартинок.Пустая);
		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "СписокВыбратьИзКлассификатора", "Заголовок", НСтр("ru='Из классификатора';uk='З класифікатора'"));
		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "СписокВыбратьИзКлассификатора", "Картинка", БиблиотекаКартинок.Пустая);
