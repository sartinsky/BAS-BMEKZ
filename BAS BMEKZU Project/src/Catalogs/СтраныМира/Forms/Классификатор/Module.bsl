...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ОбщегоНазначенияКлиентСервер.ЭтоМобильныйКлиент() Тогда // Временное решение для работы в мобильном клиенте, будет удалено в следующих версиях
		...
		Элементы.Переместить(Элементы.КлассификаторИзменить, Элементы.ФормаКоманднаяПанель);
		Элементы.Переместить(Элементы.КлассификаторГруппаВывестиСписок, Элементы.ФормаКоманднаяПанель);
		Элементы.Переместить(Элементы.КлассификаторГруппаПоиск, Элементы.ФормаКоманднаяПанель);
		Элементы.Переместить(Элементы.КлассификаторСортироватьСписокПоВозрастанию, Элементы.ФормаКоманднаяПанель);
		Элементы.Переместить(Элементы.КлассификаторСортироватьСписокПоУбыванию, Элементы.ФормаКоманднаяПанель);
		Элементы.Переместить(Элементы.КлассификаторСправка, Элементы.ФормаКоманднаяПанель);
		
		Элементы.КлассификаторГруппаВывестиСписок.Вид = ВидГруппыФормы.ГруппаКнопок;
		Элементы.КлассификаторГруппаПоиск.Вид = ВидГруппыФормы.ГруппаКнопок;
	...
	Если Не РежимВыбора Тогда
		...
		Если СтраныНетВСпискеСтран(Страна.Наименование) Тогда
			ТекстВопроса = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru='Добавить страну ""%1"" из классификатора в список стран мира?';uk='Додати країну ""%1"" з класифікатора в список країн світу?'"),
				Страна.Наименование);
