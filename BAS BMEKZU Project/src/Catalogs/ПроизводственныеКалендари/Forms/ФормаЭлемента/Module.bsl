...
Процедура ОбработкаПроверкиЗаполненияНаСервере(Отказ, ПроверяемыеРеквизиты)
	...
	Если ЕстьБазовыйКалендарь И Не ЗначениеЗаполнено(Объект.БазовыйКалендарь) Тогда
		ТекстСообщения = НСтр("ru='Базовый календарь не заполнен.';uk='Базовий календар не заповнений.'");
...
Функция ПредставлениеПереноса(ДатаИсточник, ДатаПриемник, ВидДняИсточник, ВидДняПриемник)
	...
	ШаблонМР = НСтр("ru='%1 %3 перенесен на %2 %4';uk='%1 %3 перенесено на %2 %4'");
	ШаблонСР = НСтр("ru='%1 %3 перенесено на %2 %4';uk='%1 %3 перенесено на %2 %4'");
	ШаблонЖР = НСтр("ru='%1 %3 перенесена на %2 %4';uk='%1 %3 перенесена на %2 %4'");
	
	ДниЖР = Новый Соответствие;
	ДниЖР.Вставить(НСтр("ru='среда';uk='середа'"), НСтр("ru='среду';uk='середу'"));
	ДниЖР.Вставить(НСтр("ru='пятница';uk='п''ятниця'"), НСтр("ru='пятницу';uk='п''ятницю'"));
	ДниЖР.Вставить(НСтр("ru='суббота';uk='субота'"), НСтр("ru='субботу';uk='суботу'"));
	
	ДниСР = Новый Соответствие;
	ДниСР.Вставить(НСтр("ru='воскресенье';uk='неділя'"), Истина);
...
Функция ЗагрузитьСписокПоддерживаемыхПроизводственныхКалендарей()
	...
	ПараметрыВыполнения.НаименованиеФоновогоЗадания = НСтр("ru='Заполнение списка поддерживаемых календарей';uk='Заповнення списку підтримуваних календарів'");
