	...
	Если ЭтоНовый() Или ТекущаяПапка.Родитель <> Родитель Тогда
		...
		Если НЕ РаботаСФайламиСлужебный.ЕстьПраво("ИзменениеПапок", ТекущаяПапка.Родитель) Тогда
			ВызватьИсключение СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru='Недостаточно прав для перемещения из папки файлов ""%1"".';uk='Недостатньо прав для переміщення з папки файлів ""%1"".'"),
				Строка(?(ЗначениеЗаполнено(ТекущаяПапка.Родитель), ТекущаяПапка.Родитель, НСтр("ru='Папки';uk='Папки'"))));
		КонецЕсли;
		...
		Если НЕ РаботаСФайламиСлужебный.ЕстьПраво("ИзменениеПапок", Родитель) Тогда
			ВызватьИсключение СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				...
				Строка(?(ЗначениеЗаполнено(Родитель), Родитель, НСтр("ru='Папки';uk='Папки'"))));
		КонецЕсли;
	КонецЕсли;
