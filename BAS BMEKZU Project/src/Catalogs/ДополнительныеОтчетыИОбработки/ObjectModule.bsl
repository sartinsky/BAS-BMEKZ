		...
		Если Конфликтующие.Количество() > 0 Тогда
			...
			Если ПроверкаЭлемента Тогда
				ТекстОшибки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
                    ...
                    |;uk='Ім''я ""%1"", що використовується даним звітом (обробкою), уже зайнято іншим опублікованим додатковим звітом (обробкою). 
                    |
			...
			Иначе
				ТекстОшибки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
					НСтр("ru='Имя ""%1"", используемое отчетом (обработкой) ""%2"", уже занято другим опубликованным дополнительным отчетом (обработкой).';uk='Ім''я ""%1"", яке використовується звітом (обробкою) ""%2"", вже зайнято іншим опублікованим додатковим звітом (обробкою).'"),
					ИмяОбъекта,
