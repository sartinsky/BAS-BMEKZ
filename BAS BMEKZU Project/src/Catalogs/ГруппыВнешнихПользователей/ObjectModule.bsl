		...
		ИначеЕсли Родитель.ВсеОбъектыАвторизации Тогда
			Возврат СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru='Невозможно добавить подгруппу к группе ""%1"",
                           ...
                           |так як в число її учасників входять всі користувачі.'"), Родитель);
		КонецЕсли;
...
Функция ТекстОшибкиПроверкиНазначения()
	...
	Если Назначение.Количество() = 0 Тогда
		Возврат НСтр("ru='Не указан вид участников группы.';uk='Не зазначений вид учасників групи.'");
	КонецЕсли;
		...
		Если ОбщегоНазначенияКлиентСервер.СпискиЗначенийИдентичны(НазначениеВсеВнешниеПользователи, МассивНазначения) Тогда
			Возврат
				НСтр("ru='Невозможно создать группу, совпадающую по назначению
                           ...
                           |;uk='Неможливо створити групу, яка збігається за призначенням
                           |з напередвизначеною групою ""Всі зовнішні користувачі"".'");
		КонецЕсли;
		...
		Если НЕ РезультатЗапроса.Пустой() Тогда
			Возврат
				НСтр("ru='Невозможно изменить вид участников группы,
                           ...
                           |;uk='Неможливо змінити вид учасників групи,
                           |так як у неї є підгрупи.'");
		КонецЕсли;
	КонецЕсли;
		...
		Если НЕ РезультатЗапроса.Пустой() Тогда
			...
			Возврат СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru='Невозможно изменить вид участников группы,
                           ...
                           |;uk='Неможливо змінити вид учасників групи,
                           |так як у неї є підгрупа ""%1"" з іншим призначенням учасників.'"),
				Выборка.СсылкаПредставление);
		КонецЕсли;
	КонецЕсли;
