...
Процедура СписокПриПолученииДанныхНаСервере(ИмяЭлемента, Настройки, Строки)
	...
	Запрос.УстановитьПараметр("КалендарьНеЗаполнен", НСтр("ru='Производственный календарь не заполнен';uk='Виробничий календар не заповнений'"));
	Запрос.УстановитьПараметр("КалендарьНеЗаполненНаГод", НСтр("ru='Производственный календарь не заполнен на очередной календарный год';uk='Виробничий календар не заповнений на черговий календарний рік'"));
	Запрос.УстановитьПараметр("ГрафикНеЗаполнен", НСтр("ru='График не был заполнен на очередной календарный год';uk='Графік не був заповнений на черговий календарний рік'"));
	Запрос.УстановитьПараметр("ПериодГрафикаОграничен", НСтр("ru='Период заполнения графика ограничен (см. поле «Дата окончания»)';uk='Період заповнення графіка обмежений (див. поле «Дата закінчення»)'"));
	Запрос.Текст = 
		"ВЫБРАТЬ
