...
Процедура ОтменитьСопоставление(Команда)
	...
	Кнопки.Добавить("ОтменитьСопоставление", НСтр("ru='Отменить сопоставление';uk='Скасувати співставлення'"));
	Кнопки.Добавить("ОставитьСопоставление", НСтр("ru='Оставить сопоставление';uk='Залишити співставлення'"));
	...
	ПоказатьВопрос(
		...
		НСтр("ru='Отмена сопоставления пользователя информационной базы с пользователем в справочнике.
                   ...
                   |;uk='Скасування співставлення користувача інформаційної бази з користувачем у довіднику.
                   |
                   |Скасування співставлення потрібно вкрай рідко - тільки якщо співставлення було виконано некоректно, наприклад,
                   |при оновленні інформаційної бази, тому не рекомендується скасовувати співставлення за будь-якою іншою причиною.'"),
		Кнопки,
		,
