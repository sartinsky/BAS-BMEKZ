...
Процедура ПередЗаписью(Отказ)
	...
	Если Не ЭтоУникальнаяКомпонента() Тогда 
		ВызватьИсключение СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru='Внешняя компонента со значениями Идентификатор ""%1"" и версия ""%2"" уже загружена в программу.';uk='Зовнішня компонента зі значеннями Ідентифікатор користувача ""%1"" і версія ""%2"" вже завантажена в програму.'"),
			Идентификатор,
			Версия);
	КонецЕсли;
