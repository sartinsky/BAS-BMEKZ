...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.ДекорацияПояснение.Заголовок = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		НСтр("ru='%1
                   ...
                   |;uk='%1
                   |
                   |Компонента не завантажена в програму.
                   |Завантажити?'"),
		ТекстПояснения);
...
Функция НачатьПолучениеКомпонентыСПортала(Идентификатор, Версия)
	...
	ПараметрыВыполнения.НаименованиеФоновогоЗадания = НСтр("ru='Получение внешней компоненты.';uk='Отримання зовнішньої компоненти.'");
