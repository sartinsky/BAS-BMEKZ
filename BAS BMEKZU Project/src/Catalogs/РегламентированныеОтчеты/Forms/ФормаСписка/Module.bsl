...
Функция УстановленаСортировкаПоКоду()
	...
	//		СортировкаПоКоду = Ложь;
	//	ИначеЕсли Список.Порядок.Элементы[0].Поле <> ПолеДляУпорядочивания Тогда
	//		СортировкаПоКоду = Ложь;
	//	КонецЕсли;
	//	
	//КонецЕсли;
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//	ЭлементПорядкаДанных = Список.Порядок.Элементы.Добавить(Тип("ЭлементПорядкаКомпоновкиДанных"));
	//	ЭлементПорядкаДанных.Поле = Новый ПолеКомпоновкиДанных("Код");
	//	ЭлементПорядкаДанных.ТипУпорядочивания = НаправлениеСортировкиКомпоновкиДанных.Возр;
	//	ЭлементПорядкаДанных.Использование = Истина;
	//	
...
Функция ПроверитьСписокПередОперацией(СписокРеквизит, СписокЭлемент, УстановленныеОтборы)
	...
	//Иначе
	//	ЭлементыГруппировки = СписокРеквизит.Группировка.Элементы;
	//КонецЕсли;
	
	Для Каждого ЭлементГруппировки Из ЭлементыГруппировки Цикл
		Если ЭлементГруппировки.Использование Тогда
			ПоказатьПредупреждение(,НСтр("ru='Изменение порядка элементов невозможно при установленной группировке!';uk='Зміна порядку елементів неможлива при встановленому групуванні!'"));
			Возврат Ложь;
		КонецЕсли;
	КонецЦикла;
	...
	//Иначе
	//			
	//	ЭлементыСпискаРеквизитов = СписокРеквизит.Отбор.Элементы;
	//
	//КонецЕсли;
