...
Процедура ПроверитьПравоИзмененияСостава(ИзмененияСостава)
	...
	ТекстОшибки =
		НСтр("ru='Недостаточно прав доступа.
                   ...
                   |
                   |До складу учасників груп користувачів можна додавати і видаляти лише
                   |нових (доданих) користувачів, у яких включений ознака Підготовлений.
                   |
                   |Заборонено додавати і видаляти існуючих користувачів:'");
