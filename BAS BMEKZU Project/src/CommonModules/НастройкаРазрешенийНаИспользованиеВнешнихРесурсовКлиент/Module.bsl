...
//  ФормаВладелец - УправляемаяФорма, Неопределено - форма, по отношению которой открывался мастер.
...
//
// Параметры:
//  ФормаВладелец - УправляемаяФорма, Неопределено - форма, после закрытия которой требуется выполнить
