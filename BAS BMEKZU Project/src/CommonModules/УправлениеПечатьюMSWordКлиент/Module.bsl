...
#Если ВебКлиент Тогда
	ТекстУточнения = НСтр("ru='Для формирования этой печатной формы необходимо воспользоваться тонким клиентом.';uk='Для формування цієї друкованої форми необхідно скористатися тонким клієнтом.'");
#Иначе		
	ТекстУточнения = "";	
#КонецЕсли
