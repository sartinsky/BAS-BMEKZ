...
//        * ТипАдреса        - Строка - основной тип адреса (только для национальных адресов).
//                                      Варианты: "Муниципальный", "Административно-территориальный".
//        * Страна           - Строка - текстовое представление страны.
//        * КодСтраны        - Строка - код страны по КСМ.
...
//            ** Номер - Строка  - текстовое представление номера дома (только для национальных адресов).
...
Функция ОсновнаяСтрана() Экспорт
	Возврат ПредопределенноеЗначение("Справочник.СтраныМира.Украина");
КонецФункции
...
Функция ТипыОбъектовАдресацииАдреса() Экспорт
	...
	Результат.Добавить(СтрокаОбъектаАдресации("1034", "Гараж",        1, 4, 4));
	Результат.Добавить(СтрокаОбъектаАдресации("1036", "Здание",       1, 5, 5));
	Результат.Добавить(СтрокаОбъектаАдресации("1038", "Шахта",        1, 6, 6));
	Результат.Добавить(СтрокаОбъектаАдресации("1039", НаименованиеЗемельногоУчастка(), 1, 9, 9));
	...
	Результат.Добавить(СтрокаОбъектаАдресации("1090", "Литер",      2, 6, 3));
	...
	Результат.Добавить(СтрокаОбъектаАдресации("2060", "Этаж",      3, 6));
	Результат.Добавить(СтрокаОбъектаАдресации("2070", "А/я",       3, 7));
	Результат.Добавить(СтрокаОбъектаАдресации("2080", "В/ч",       3, 8));
	Результат.Добавить(СтрокаОбъектаАдресации("2090", "П/о",       3, 9));
...
Функция ПредставленияОбъектовАдресации(Язык = Неопределено) Экспорт
	
	Если Язык = Неопределено Тогда
		Язык = Локализация.КодЯзыкаИнтерфейса();
	КонецЕсли;
	
	Представления = Новый Соответствие;
	Представления.Вставить("Дом", 			НСтр("ru='Дом';uk='Будинок'",Язык));
	Представления.Вставить("Владение", 		НСтр("ru='Владение';uk='Володіння'",Язык));
	Представления.Вставить("Домовладение", 	НСтр("ru='Домовладение';uk='Домоволодіння'",Язык));
	Представления.Вставить("Гараж", 		НСтр("ru='Гараж';uk='Гараж'",Язык));
	Представления.Вставить("Здание", 		НСтр("ru='Здание';uk='Будівля'",Язык));
	Представления.Вставить("Шахта", 		НСтр("ru='Шахта';uk='Шахта'",Язык));
	Представления.Вставить(НаименованиеЗемельногоУчастка(), ПредставлениеЗемельногоУчастка(Язык));
	
	Представления.Вставить("Корпус", 		НСтр("ru='Корпус';uk='Корпус'",Язык));
	Представления.Вставить("Строение", 		НСтр("ru='Строение';uk='Будівля'",Язык));
	Представления.Вставить("Литера", 		НСтр("ru='Литера';uk='Літера'",Язык));
	Представления.Вставить("Литер", 		НСтр("ru='Литер';uk='Літер'",Язык));
	Представления.Вставить("Сооружение", 	НСтр("ru='Сооружение';uk='Споруда'",Язык));
	Представления.Вставить("Участок", 		НСтр("ru='Участок';uk='Ділянка'",Язык));
	
	Представления.Вставить("Квартира", 		НСтр("ru='Квартира';uk='Квартира'",Язык));
	Представления.Вставить("Офис", 			НСтр("ru='Офис';uk='Офіс'",Язык));
	Представления.Вставить("Бокс", 			НСтр("ru='Бокс';uk='Бокс'",Язык));
	Представления.Вставить("Помещение", 	НСтр("ru='Помещение';uk='Приміщення'",Язык));
	Представления.Вставить("Комната", 		НСтр("ru='Комната';uk='Кімната'",Язык));
	Представления.Вставить("Этаж", 			НСтр("ru='Этаж';uk='Поверх'",Язык));
	Представления.Вставить("А/я", 			НСтр("ru='А/я';uk='А/с'",Язык));
	Представления.Вставить("В/ч", 			НСтр("ru='В/ч';uk='В/ч'",Язык));
	Представления.Вставить("П/о", 			НСтр("ru='П/о';uk='П/в'",Язык));
	//  Наши сокращения для поддержки обратной совместимости при парсинге
	Представления.Вставить("кв.", 			НСтр("ru='кв.';uk='кв.'",Язык));
	Представления.Вставить("оф.", 			НСтр("ru='оф.';uk='оф.'",Язык));
	
	// Уточняющие объекты
	Представления.Вставить("Почтовый индекс", НСтр("ru='Почтовый индекс';uk='Поштовий індекс'",Язык));
	Представления.Вставить("Адресная точка", НСтр("ru='Адресная точка';uk='Адресна точка'",Язык));
	Представления.Вставить("Садовое товарищество", НСтр("ru='Садовое товарищество';uk='Садове товариство'",Язык));
	Представления.Вставить("Элемент улично-дорожной сети, планировочной структуры дополнительного адресного элемента", НСтр("ru='Элемент улично-дорожной сети, планировочной структуры дополнительного адресного элемента';uk='Елемент вулично-дорожньої мережі, планувальної структури додаткового адресного елемента'",Язык));
	Представления.Вставить("Промышленная зона", НСтр("ru='Промышленная зона';uk='Промислова зона'",Язык));
	Представления.Вставить("Гаражно-строительный кооператив", НСтр("ru='Гаражно-строительный кооператив';uk='Гаражно-будівельний кооператив'",Язык));
	Представления.Вставить("Территория", НСтр("ru='Территория';uk='Територія'",Язык));
...
//     * AddressType - Строка - установленный пользователем тип адреса(только для национальных адресов).
//                              Варианты: "Муниципальный", "Административно-территориальный".
//     * AreaCode - Строка - код региона.
...
Функция СокращенияОбъектовАдресацииАдреса() Экспорт
	...
	Результат.Вставить(НСтр("ru='А/я';uk='А/с'"), НСтр("ru='а/я';uk='а/с'"));
	Результат.Вставить(НСтр("ru='П/о';uk='П/в'"), НСтр("ru='п/о';uk='п/в'"));
	Результат.Вставить(НСтр("ru='В/ч';uk='В/ч'"), НСтр("ru='в/ч';uk='в/ч'"));
...
Функция ПредставлениеАдреса(Адрес, ВключатьСтрануВПредставление, ТипАдреса = Неопределено) Экспорт
	...
	Если ТипЗнч(Адрес) <> Тип("Структура") Тогда
		ВызватьИсключение НСтр("ru='Для формирования представления адреса передан некорректный тип адреса';uk='Для формування представлення адреси переданий некоректний тип адреси'");
	КонецЕсли;
	...
	Если Адрес.Свойство("ZipCode") И НЕ ПустаяСтрока(Адрес.ZipCode) Тогда
		СписокЗаполненныхУровней.Добавить(СокрЛП(Адрес.ZipCode));
	КонецЕсли;
	...
	ПредставленияДопЭлементов = ПредставленияОбъектовАдресации(Локализация.КодЯзыкаИнформационнойБазы());
	
	Если Адрес.Свойство("HouseNumber") И НЕ ПустаяСтрока(Адрес.HouseNumber) Тогда
		СписокЗаполненныхУровней.Добавить(НРег(ПредставленияДопЭлементов.Получить(Адрес.HouseType)) + " № " + Адрес.HouseNumber);
	ИначеЕсли Адрес.Свойство("stead") И Не ПустаяСтрока(Адрес.stead) Тогда
		СписокЗаполненныхУровней.Добавить(НСтр("ru='участок';uk='ділянка'") + " " + Адрес.stead);
	КонецЕсли;
	
	Если Адрес.Свойство("Buildings") И Адрес.Buildings.Количество() > 0 Тогда
		
		Для каждого Строение Из Адрес.Buildings Цикл
			СписокЗаполненныхУровней.Добавить(НРег(ПредставленияДопЭлементов.Получить(Строение.Type)) + " " + Строение.Number);
		КонецЦикла;
...
Функция ПредставлениеЗемельногоУчастка(Язык) Экспорт
	Возврат НСтр("ru='Зем. участок';uk='Зем. ділянка'",Язык);
КонецФункции
