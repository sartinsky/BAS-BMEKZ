...
Процедура ПродолжитьВыполнениеКоманды(Контекст)
	...
	Если Контекст.ТребуетсяРаботаСФайлами Тогда
		...
		ТекстСообщения = НСтр("ru='Для продолжения необходимо установить расширение для веб-клиента платформы.';uk='Для продовження необхідно встановити розширення для веб-клієнта платформи.'");
		...
		Если ИнформацияОДокументах.Непроведенные.Количество() > 0 Тогда
			Если ИнформацияОДокументах.ДоступноПравоПроведения Тогда
				Если ИнформацияОДокументах.Непроведенные.Количество() = 1 Тогда
					ТекстВопроса = НСтр("ru='Для выполнения команды необходимо предварительно провести документ. Выполнить проведение документа и продолжить?';uk='Для виконання команди необхідно попередньо провести документ. Виконати проведення документа і продовжити?'");
				Иначе
					ТекстВопроса = НСтр("ru='Для выполнения команды необходимо предварительно провести документы. Выполнить проведение документов и продолжить?';uk='Для виконання команди необхідно попередньо провести документи. Виконати проведення документів та продовжити?'");
				КонецЕсли;
			...
			Иначе
				Если ИнформацияОДокументах.Непроведенные.Количество() = 1 Тогда
					ТекстПредупреждения = НСтр("ru='Для выполнения команды необходимо предварительно провести документ. Недостаточно прав для проведения документа.';uk='Для виконання команди необхідно попередньо провести документ. Недостатньо прав для проведення документа.'");
				Иначе
					ТекстПредупреждения = НСтр("ru='Для выполнения команды необходимо предварительно провести документы. Недостаточно прав для проведения документов.';uk='Для виконання команди необхідно попередньо провести документи. Недостатньо прав для проведення документів.'");
				КонецЕсли;
