...
Процедура ПроверитьВозможностьОткрытияДочернейФормыРегламентиованногоОтчета(ЭтаФорма, ВыполняемоеОповещение) Экспорт	
	...
	Если НЕ РегламентированнаяОтчетностьВызовСервера.ИспользуютсяВстроенныеРегламентированныеОтчеты() Тогда
		...
		ТекстВопроса = НСтр("ru='Внимание! Для формирования регламентированных отчетов используется ""FREDO Звіт"".';uk= 'Увага! Для формування регламентованих звітів використовується ""FREDO Звіт"".'");
