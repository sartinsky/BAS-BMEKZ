        ...
        Попытка
            ...
            Если ОбрабатыватьСообщенияВНеразделенныхДанных И РаботаВМоделиСервиса.РазделениеВключено() И РаботаВМоделиСервиса.ДоступноИспользованиеРазделенныхДанных() Тогда
                ...
                ТекстСообщенияОбОшибке = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
                    НСтр("ru='После обработки сообщения канала %1 не было выключено разделение сеанса.';uk='Після обробки повідомлення каналу %1 не був вимкнений поділ сеансу.'"),
...
Функция СобытиеЖурналаРегистрацииУстановкаВедущейКонечнойТочки() Экспорт
	...
	Возврат НСтр("ru='Обмен сообщениями.Установка ведущей конечной точки';uk='Обмін повідомленнями.Встановлення ведучою кінцевої точки'",ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка());
