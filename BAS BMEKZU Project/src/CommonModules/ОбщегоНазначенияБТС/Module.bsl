...
Процедура ЗаписьТехнологическогоЖурнала(Событие, Контекст) Экспорт
	...
	Попытка
		...
		Запрос.УстановитьПараметр("Событие", НСтр("ru='СобытиеТЖ.';uk='СобытиеТЖ.'") + Событие);
	...
	Исключение
		...
		ЗаписьЖурналаРегистрации(НСтр("ru='ЗаписьТехнологическогоЖурнала';uk='ЗаписьТехнологическогоЖурнала'",ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()), УровеньЖурналаРегистрации.Ошибка,,, ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
