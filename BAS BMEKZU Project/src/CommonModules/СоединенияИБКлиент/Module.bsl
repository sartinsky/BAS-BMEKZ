...
Процедура ПередЗавершениемРаботыСистемы(Отказ, Предупреждения) Экспорт
	...
	Если РаботаПользователейЗавершается() Тогда
		...
		ПараметрыПредупреждения.ТекстГиперссылки = НСтр("ru='Блокировка работы пользователей';uk='Блокування роботи користувачів'");
		ПараметрыПредупреждения.ТекстПредупреждения = НСтр("ru='Из текущего сеанса выполняется завершение работы пользователей';uk='З поточного сеансу виконується завершення роботи користувачів'");
...
Процедура ПоказатьПредупреждениеПриЗавершенииРаботы(ТекстСообщения) Экспорт
	...
	Если ПараметрыПриложения[ИмяПараметра] <> Истина Тогда
		ПоказатьОповещениеПользователя(НСтр("ru='Работа программы будет завершена';uk='Робота програми буде завершена'"),, ТекстСообщения,, 
...
Процедура ЗадатьВопросПриЗавершенииРаботы(ТекстСообщения) Экспорт
	...
	ИмяПараметра = "СтандартныеПодсистемы.ПоказаноПредупреждениеПередЗавершениемРаботы";
	Если ПараметрыПриложения[ИмяПараметра] <> Истина Тогда
		ПоказатьОповещениеПользователя(НСтр("ru='Работа программы будет завершена';uk='Робота програми буде завершена'"),, ТекстСообщения,, СтатусОповещенияПользователя.Важное);
