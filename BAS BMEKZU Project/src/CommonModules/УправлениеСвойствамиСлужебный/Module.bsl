...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Комментарий = НСтр("ru='Заполняет уникальное имя дополнительных реквизитов и сведений.
        ...
        |;uk='Заповнює унікальне ім''я додаткових реквізитів і відомостей.
        |Редагування додаткових реквізитів і відомостей буде недоступне до завершення оновлення.'");
	Обработчик.РежимВыполнения = "Отложенно";
...
Функция ВидыСвойствНабора(Ссылка, УчитыватьПометкуУдаления = Истина) Экспорт
	...
	ВидыСвойствНабора.Вставить(
		"ДополнительныеСведения",
			...
			ИЛИ (Метаданные.ОбщиеКоманды.Найти("ИНАГРО_ДополнительныеСведенияКоманднаяПанель") <> Неопределено // ИНАГРО
			И Метаданные.ОбщиеКоманды.ИНАГРО_ДополнительныеСведенияКоманднаяПанель.ТипПараметраКоманды.СодержитТип(ТипСсылки)));
	Возврат ВидыСвойствНабора;
