...
Функция ПолучитьМесяц(СтрокаПредставленияМесяца)
	...
	СписокМесяцев.Добавить(1, "січ");
	СписокМесяцев.Добавить(2, "лют");
	СписокМесяцев.Добавить(3, "бер");
	СписокМесяцев.Добавить(4, "кві");
	СписокМесяцев.Добавить(5, "тра");
	СписокМесяцев.Добавить(6, "чер");
	СписокМесяцев.Добавить(7, "лип");
	СписокМесяцев.Добавить(8, "сер");
	СписокМесяцев.Добавить(9, "вер");
	СписокМесяцев.Добавить(10, "жов");
	СписокМесяцев.Добавить(11, "лис");
	СписокМесяцев.Добавить(12, "гру");
