...
// 
// Возвращаемое значение:
//   - ОписаниеПередаваемогоФайла - описание для сохранения или открытия файла.
//
...
//  УстановитьВременныйПриПолучении - Неопределено - ожидается флаг установки признака временного при получении.
...
Функция НовыйОписаниеФайла()
    ...
    ОписаниеФайла.Вставить("УстановитьВременныйПриПолучении");
...
Функция УдалитьФайлТома(Знач ФайлДляУдаления)
	...
	Если СвойстваФайла.Существует() Тогда 
        Попытка
            ...
            Возврат Истина;
		Исключение
			Событие = Словарь.УдалениеФайлаТома();
			Комментарий = ПодробноеПредставлениеОшибки(ИнформацияОбОшибке());
			ЗаписьЖурналаРегистрации(Событие, УровеньЖурналаРегистрации, , , Комментарий);
        КонецПопытки;
    КонецЕсли;
	Возврат Ложь;
