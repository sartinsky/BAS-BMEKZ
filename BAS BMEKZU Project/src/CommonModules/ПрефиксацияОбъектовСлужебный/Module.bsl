...
Процедура ИзменитьПрефиксИБ(Параметры, АдресРезультата = "") Экспорт
	...
	Исключение
		...
		ВызватьИсключение НСтр("ru='Не удалось изменить префикс.';uk='Не вдалося змінити префікс.'");
			...
			Если Характеристики.ДлинаКода = 0 И Характеристики.ДлинаНомера = 0 Тогда
				...
				Если Не РежимДиагностики Тогда
					...
					ВызватьИсключение СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
						НСтр("ru='Ошибка внедрения подсистемы ""%1"" для объекта метаданных ""%2"".';uk='Помилка впровадження підсистеми ""%1"" для об''єкта метаданих ""%2"".'"),
