...
//       Чтобы получить идентификатор нужно в режиме клиентского приложения выполнить метод платформы:
...
Процедура ПриЗаполненииРазделовДатЗапретаИзменения(Разделы) Экспорт
	...
	Раздел.Представление = НСтр("ru='Бухгалтерский учет';uk= 'Бугалтерський облік'", Локализация.КодЯзыкаИнформационнойБазы());
...
Процедура ЗаполнитьИсточникиДанныхДляПроверкиЗапретаИзменения(ИсточникиДанных) Экспорт
	...
	ДатыЗапретаИзмененияБП.ИНАГРО_ЗаполнитьИсточникиДанныхДляПроверкиЗапретаИзменения(ИсточникиДанных); // ИНАГРО
