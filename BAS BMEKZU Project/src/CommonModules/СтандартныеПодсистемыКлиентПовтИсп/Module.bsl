	...
	Если ПараметрыПриложения[ИмяПараметра] = Неопределено Тогда
		ВызватьИсключение
			НСтр("ru='Ошибка порядка запуска программы.
                       ...
                       |;uk='Помилка порядку запуску програми.
                       |Першою процедурою, яка викликається з обробника події ПередНачаломРаботыСистемы
                       |повинна бути процедура БСП СтандартныеПодсистемыКлиент.ПередНачаломРаботыСистемы.'");
	КонецЕсли;
	...
	Если Не СтандартныеПодсистемыКлиент.ЗапускПрограммыЗавершен() Тогда
		ВызватьИсключение
			НСтр("ru='Ошибка порядка запуска программы.
                       ...
                       |;uk='Помилка порядку запуску програми.
                       |Перед отриманням параметрів роботи клієнта запуск програми повинен бути завершений.'");
	КонецЕсли;
