...
Функция СообщенияОбОшибках() Экспорт
	...
	СообщенияОбОшибках.Вставить(8,  НСтр("ru='Некорректно указано имя файла для выгрузки данных';uk='Некоректно вказано ім''я файлу для вивантаження даних'"));
...
Функция ИспользуемыеТранспортыСообщенийОбмена(УзелИнформационнойБазы, Знач ВариантНастройки = "") Экспорт
	...
	//  - если сервер платформы запущен на ОС Linux.
	//
