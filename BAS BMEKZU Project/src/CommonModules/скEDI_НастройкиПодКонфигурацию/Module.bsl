			...
			Если ПрикреплятьИзображениеДокументаPDF Тогда
				...
				Если СодержаниеЭлектронногоДокумента <> Неопределено Тогда
					...
					//Если ЗначениеЗаполнено(ТелоДокумента) Тогда
						...
						скEDI_ОбщегоНазначения.ПолучитьСодержимоеПоЭлектронномуДокументу(ЭлектронныйДокумент.Организация, ЭлектронныйДокумент, СодержаниеЭлектронногоДокумента, Истина, Ложь, Ложь, пПредставлениеЭлектронногоДокументаPDF, пОтображениеМассивКартинок, Неопределено, Неопределено, "");
