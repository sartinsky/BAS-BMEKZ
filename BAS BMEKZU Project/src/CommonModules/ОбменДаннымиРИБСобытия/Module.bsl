...
Процедура ПолныйЗарегистрироватьИзменениеРегистровРасчетаПередЗаписью(Источник, Отказ, Замещение) Экспорт
...
Процедура ПоОрганизацииЗарегистрироватьИзменениеРегистровРасчетаПередЗаписью(Источник, Отказ, Замещение) Экспорт
