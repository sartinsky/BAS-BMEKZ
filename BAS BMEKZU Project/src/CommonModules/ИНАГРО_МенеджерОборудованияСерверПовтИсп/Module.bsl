...
// НЕОПРЕДЕЛЕНО - компоненту не удалось загрузить
...
// Функция возвращает типы оборудования подключенные к текущему рабочему месту.
// Если НЕОПРЕДЕЛЕНО - нет подключенного оборудования.
Функция ТипыПодключенногоОборудованияБезУдаленных() Экспорт
