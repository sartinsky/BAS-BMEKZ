...
Процедура ТранслироватьСообщениеВВерсиюКорреспондентаПриНеобходимости(Сообщение, Знач ИнформацияПодключения, Знач ПредставлениеПолучателя)
	...
	Если Не ИнформацияПодключения.Свойство("URL") 
		...
		ВызватьИсключение СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='Не задан URL сервиса обмена сообщениями с информационной базой %1';uk='Не задано URL сервісу обміну повідомленнями з інформаційною базою %1'"), ПредставлениеПолучателя);
	КонецЕсли;
	...
	Если ВерсияКорреспондента = Неопределено Тогда
		ВызватьИсключение СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru='Корреспондент %1 не поддерживает получение версий сообщений интерфейса %2, поддерживаемых текущей информационной базой.';uk='Кореспондент %1 не підтримує отримання версій повідомлень користувача %2, що підтримуються поточною інформаційною базою.'"),
