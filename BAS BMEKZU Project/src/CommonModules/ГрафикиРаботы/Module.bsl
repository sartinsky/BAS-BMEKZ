...
Процедура СоздатьКалендарьПятидневкаУкраины() Экспорт
	...
	НовыйГрафикРаботы.Наименование =  НСтр("ru='Пятидневка';uk='П''ятиденка'")+" "+ОбщегоНазначения.ЗначениеРеквизитаОбъекта(ПроизводственныйКалендарь, "Наименование");
