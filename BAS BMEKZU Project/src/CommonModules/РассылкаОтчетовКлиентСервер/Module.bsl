...
Функция ШаблонТемы(ЯзыкШаблона = "ru") Экспорт
	...
	КонецЕсли;
	Возврат НСтр("ru='[НаименованиеРассылки] от [ДатаВыполнения(ДЛФ=''D'')]';uk='[НаименованиеРассылки] від [ДатаВыполнения(ДЛФ=''D'')]'",ЯзыкШаблона);
КонецФункции
...
Функция ШаблонТекста(ЯзыкШаблона = "ru") Экспорт
	...
	Возврат НСтр("ru='Сформированы отчеты:
        ...
        |
        |[ЗаголовокСистемы]
        |[ДатаВыполнения(ДЛФ=''DD'')]'",ЯзыкШаблона);
КонецФункции
