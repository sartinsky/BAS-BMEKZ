...
Функция ЭтоРазделительСлов(КодСимвола, РазделителиСлов = Неопределено) Экспорт
	...
	Диапазоны.Добавить(Новый Структура("Мин,Макс", 1030, 1031)); 	// символы "І""Ї"
	Диапазоны.Добавить(Новый Структура("Мин,Макс", 1108, 1108)); 	// символ "є"
	Диапазоны.Добавить(Новый Структура("Мин,Макс", 1110, 1111)); 	// символы "і""ї"
	Диапазоны.Добавить(Новый Структура("Мин,Макс", 1168, 1169)); 	// символы "ґ""Ґ"
...
Функция СоответствиеНациональногоАлфавитаИЛатиницы()
	...
	Соответствие.Вставить("ї","yi");
	Соответствие.Вставить("є","e");
