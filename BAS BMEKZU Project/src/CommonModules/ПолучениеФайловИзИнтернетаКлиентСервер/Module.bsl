...
#Если ВебКлиент Тогда
	ВызватьИсключение НСтр("ru='Прокси не доступен в веб-клиенте.';uk='Проксі не доступний у веб-клієнті.'");
#Иначе
...
#Если ВебКлиент Тогда
	...
	Результат.Вставить("Представление", НСтр("ru='Прокси не доступен в веб-клиенте.';uk='Проксі не доступний у веб-клієнті.'"));
	Возврат Результат;
...
#Иначе
	...
	Иначе
		Журнал.Добавить(НСтр("ru='Соединение выполняется без использования прокси-сервера.';uk='З''єднання виконується без використання проксі-сервера.'"));
	КонецЕсли;
