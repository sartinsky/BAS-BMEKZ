...
Процедура ПодключитьТестовыйПериод(
	...
	Состояние(, , НСтр("ru='Получение информации о доступных тестовых периодах';uk='Отримання інформації про доступні тестові періоди'"));
...
Процедура ПроверитьСостояниеЗапроса() Экспорт
	...
	Для Каждого ОписательОповещения Из ДанныеОповещений.Оповещения Цикл
		...
		ПоказатьОповещениеПользователя(
			НСтр("ru='Подключение тестового периода';uk='Підключення тестового періоду'"),
