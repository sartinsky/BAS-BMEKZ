...
Функция ПолучитьСведенияОбОрганизации(Знач Организация, Знач ДатаЗначения = Неопределено, Знач СписокПоказателей = Неопределено) Экспорт
	...
	ИначеЕсли ИДКонфигурации = "БСП" Тогда
		Возврат РегламентированнаяОтчетностьПереопределяемый.ПолучитьСведенияОбОрганизацииБП(Организация, ДатаЗначения, СписокПоказателей);
	КонецЕсли;	
...
Функция ИспользуютсяВстроенныеРегламентированныеОтчеты() Экспорт

	Результат = Истина;
	
	Если Метаданные.ФункциональныеОпции.Найти("ИспользоватьВстроенныеРегламентированныеОтчеты") <> Неопределено Тогда
		Результат = ПолучитьФункциональнуюОпцию("ИспользоватьВстроенныеРегламентированныеОтчеты");
	КонецЕсли;
