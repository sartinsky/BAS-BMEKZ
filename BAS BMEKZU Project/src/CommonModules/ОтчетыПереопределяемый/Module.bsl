...
Процедура ПередЗагрузкойВариантаНаСервере(Форма, НовыеНастройкиКД) Экспорт
	...
	Если Форма.Элементы.Найти("ОтчетТабличныйДокумент") <> Неопределено
		И ТипЗнч(Форма.Элементы.ОтчетТабличныйДокумент) = Тип("ПолеФормы")
		И Форма.Элементы.ОтчетТабличныйДокумент.Вид = ВидПоляФормы.ПолеТабличногоДокумента Тогда
