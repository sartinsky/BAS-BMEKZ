...
// Определяет общие параметры функциональности Монитора Портала ИТС.
//
// Параметры:
...
// Вызывается при создании формы Монитора Портала ИТС.
...
// Вызывается при получении данных Монитора Портала ИТС для получения дополнительных
