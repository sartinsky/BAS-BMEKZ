	...
	Если Не ВходВОбластьДанных
	 ...
	 Или ВходВОбластьДанных
	   И Не ПравоДоступа("АдминистрированиеДанных", Метаданные) Тогда
		...
		ВызватьИсключение НСтр("ru='Недостаточно прав для работы с отключенной логикой работы системы.';uk='Недостатньо прав для роботи з відключеною логікою роботи системи.'");
	КонецЕсли;
