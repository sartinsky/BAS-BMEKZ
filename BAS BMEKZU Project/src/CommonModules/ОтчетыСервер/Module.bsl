...
Процедура ВывестиКоманду(ФормаОтчета, КомандаИлиКоманды, ТипГруппы, ВНачалоГруппы = Ложь, ТолькоВоВсехДействиях = Ложь, 
	...
	Иначе
		ВызватьИсключение СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru='При вызове процедуры ""%1"" передано недопустимо значение параметра ""%2"".';uk='При виклику процедури ""%1"" передано неприпустиме значення параметра ""%2"".'"),
...
//
Процедура ОчиститьДеревоЗначений(Знач Дерево) Экспорт
...
Процедура ЗаполнитьПредставлениеИСостояниеНастройки(СвойстваНастройки, НастройкаВариантаКД, ПользовательскаяНастройкаКД, ДоступнаяНастройкаКД)
	...
	ИначеЕсли СвойстваНастройки.Тип = "АвтоЭлементПорядка" Тогда
		ПредставлениеПоУмолчанию = НСтр("ru='Авто (сортировки родителя)';uk='Авто (сортування батька)'");
	...
	ИначеЕсли СвойстваНастройки.Тип = "АвтоВыбранноеПоле" Тогда
		ПредставлениеПоУмолчанию = НСтр("ru='Авто (поля родителя)';uk='Авто (поля батька)'");
