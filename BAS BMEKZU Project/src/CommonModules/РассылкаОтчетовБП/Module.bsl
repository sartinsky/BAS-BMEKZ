...
//
// Параметры:
//  Форма - УправляемаяФорма - форма, в которой необходимо разместить команду настройки рассылки отчета.
//
...
//
// Параметры:
//  Форма - УправляемаяФорма - форма отчета, из которой открывается форма настройки рассылки отчета.
//
...
Процедура СформироватьПредставлениеОтчетовДляПолучателя(ПараметрыДоставки, СтрокаПолучатель)
	...
	ШаблонПредставлениеОтчета = НСтр("ru='%1%2 %3';uk='%1%2 %3'");
	ЗнакМаркера = "-";
