	...
	Если ПоискВТоме Тогда
		ТекстОшибки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru='Не удалось открыть файл:
                ...
                |який приєднаний до:
                |%2
                |з причини: двійкові дані файлу були вилучені. Можливо, файл очищений як непотрібний або вилучений антивірусною програмою.
                |Зверніться до адміністратора.'"),
			ИмяФайла,
			ВладелецФайла);
	...
	Иначе
		ТекстОшибки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru='Не удалось открыть файл:
                ...
                |який приєднаний до:
                |%2
                |з причини: двійкові дані файлу були вилучені. Можливо, файл очищений як непотрібний.
                |Зверніться до адміністратора.'"),
			ИмяФайла,
			ВладелецФайла);
	КонецЕсли;
