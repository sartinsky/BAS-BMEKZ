...
Функция УслугаПоИдентификаторуИИдентификаторуПоставщика(Знач ИдентификаторУслуги, Знач ИдентификаторПоставщика, ВызыватьИсключение = Истина) Экспорт
	...
	Иначе
		ШаблонОшибки = НСтр("ru='Не найдена услуга по следующим полям:
                                        ...
                                        |;uk='Не знайдена послуга по наступних полях:
                                        |- Ідентифікатор постачальника: %1
                                        |- Ідентифікатор послуги: %2'");
...
Функция ЗарегистрированаЛицензияУникальнойУслуги(ИдентификаторПоставщика, ИдентификаторУслуги, ИмяЛицензии, КонтекстЛицензии = "") Экспорт
	...
	Попытка
		...
		ИмяСобытия = ИмяСобытияЖР() + НСтр("ru='Проверка наличия лицензии уникальной услуги из приложения';uk='Перевірка наявності ліцензії унікальної послуги з програми'");
...
Функция ЗанятьЛицензиюУникальнойУслуги(ИдентификаторПоставщика, ИдентификаторУслуги, ИмяЛицензии, ИдентификаторОперации, КонтекстЛицензии = "") Экспорт
	...
	Попытка
		...
		ИмяСобытия = ИмяСобытияЖР() + НСтр("ru='Заем лицензии уникальной услуги из приложения';uk='Позика ліцензії унікальної послуги з програми'");
		ЗаголовокКомментария = ЗаголовокКомментария(ИдентификаторПоставщика,
			ИдентификаторУслуги,
			ИмяЛицензии,
			,
		...
		Если Ответ.КодСостояния = 200 Тогда
			...
			ЗаписатьИнформацию(ИмяСобытия, ЗаголовокКомментария, НСтр("ru='Успех';uk='Успіх'"));
			Возврат ОтветЗанятияУслуги;
		ИначеЕсли Ответ.КодСостояния = 400 Тогда
			ВызватьИсключение СтруктураОтветаHTTP.ErrorMessage;
		Иначе
			ВызватьИсключение НСтр("ru='Код возврата веб-сервера:';uk='Код повернення веб-сервера:'") + Строка(Ответ.КодСостояния);
		КонецЕсли;
...
Функция ОсвободитьЛицензиюУникальнойУслуги(ИдентификаторПоставщика, ИдентификаторУслуги, ИмяЛицензии, ИдентификаторОперации, КодОбластиДанных = Неопределено,
	...
	Попытка
		...
		ИмяСобытия = ИмяСобытияЖР() + НСтр("ru='Освобождение лицензии уникальной услуги из приложения';uk='Звільнення ліцензії унікальної послуги з програми'");
		ЗаголовокКомментария = ЗаголовокКомментария(ИдентификаторПоставщика,
			ИдентификаторУслуги,
			ИмяЛицензии,
			,
		...
		ИначеЕсли Ответ.КодСостояния = 410 Тогда
			ЗаписатьИнформацию(ИмяСобытия, ЗаголовокКомментария, НСтр("ru='Не найдена лицензия';uk='Не знайдена ліцензія'"));
			СнятьРазделительСеанса(КодОбластиДанных);
			Возврат Ложь;
		ИначеЕсли Ответ.КодСостояния = 400 Тогда
			ВызватьИсключение СтруктураОтветаHTTP.ErrorMessage;
...
Функция ЗанятьЛицензииЛимитированнойУслуги(ИдентификаторПоставщика, ИдентификаторУслуги, КоличествоЛицензий, КодОбластиДанных = Неопределено) Экспорт
	...
	Попытка
		...
		ИмяСобытия = ИмяСобытияЖР() + НСтр("ru='Заем лицезний лимитированной услуги из приложения';uk='Позика лицезний лімітованої послуги з програми'");
		ЗаголовокКомментария = ЗаголовокКомментария(ИдентификаторПоставщика,
			ИдентификаторУслуги,
			,
			КоличествоЛицензий,
...
Функция ОсвободитьЛицензииЛимитированнойУслуги(ИдентификаторПоставщика, ИдентификаторУслуги, КоличествоЛицензий, КодОбластиДанных = Неопределено) Экспорт
	...
	Попытка
		...
		ИмяСобытия = ИмяСобытияЖР() + НСтр("ru='Освобождение лицезний лимитированной услуги из приложения';uk='Звільнення ліцезній лімітованої послуги з програми'");
		ЗаголовокКомментария = ЗаголовокКомментария(ИдентификаторПоставщика,
			ИдентификаторУслуги,
...
Функция ПодтвердитьОперацию(ИдентификаторОперации) Экспорт
	...
	Попытка
		...
		ИмяСобытия = ИмяСобытияЖР() + НСтр("ru='Фиксация операции';uk='Фіксація операції'");
		ЗаголовокКомментария = НСтр("ru='Идентификатор операции:';uk='Ідентифікатор операції:'") + Строка(ИдентификаторОперации);
...
Функция ОтменитьОперацию(ИдентификаторОперации) Экспорт
	...
	Попытка
		...
		ИмяСобытия = ИмяСобытияЖР() + НСтр("ru='Отмена операции';uk='Скасування операції'");
		ЗаголовокКомментария = НСтр("ru='Идентификатор операции:';uk='Ідентифікатор операції:'") + Строка(ИдентификаторОперации);
...
Функция КоличествоЛицензийУникальнойУслуги(ИдентификаторПоставщика, ИдентификаторУслуги) Экспорт
	...
	Попытка
		...
		ИмяСобытия = ИмяСобытияЖР() + НСтр("ru='Получение количества свободных лицензий уникальной услуги из приложения';uk='Отримання кількості вільних ліцензій унікальної послуги з програми'");
		ЗаголовокКомментария = ЗаголовокКомментария(ИдентификаторПоставщика,
			ИдентификаторУслуги,
			ИмяЛицензии,
			,
...
Функция КоличествоЛицензийЛимитированнойУслуги(ИдентификаторПоставщика, ИдентификаторУслуги, КодОбластиДанных = Неопределено) Экспорт
	...
	Попытка
		...
		ИмяСобытия = ИмяСобытияЖР() + НСтр("ru='Получение количества доступных лицензий лимитированной услуги из приложения';uk='Отримання кількості доступних ліцензій лімітованої послуги з програми'");
		ЗаголовокКомментария = ЗаголовокКомментария(ИдентификаторПоставщика,
			ИдентификаторУслуги,
			,
			КоличествоЛицензий,
...
Функция ИмяСобытияЖР() Экспорт
	...
	Возврат ТарификацияСлужебный.ИмяСобытияТарификации() + НСтр("ru='Операции с лицензиями.';uk='Операції з ліцензіями.'");
...
Функция ОбновитьПоставщикаУслуг(Знач Код, Знач Наименование, Знач Идентификатор, Знач ПометкаУдаления) Экспорт
	...
	Иначе
		...
		Если Код = Неопределено Тогда 
			ВызватьИсключение НСтр("ru='При обновлении поставщика поле ""Код"" должно быть установлено';uk='При оновленні постачальника поле ""Код"" має бути встановлено'");
		КонецЕсли;
	КонецЕсли;
...
Функция ТипУслугиПоИдентификатору(Знач ИдентификаторТипаУслуги) Экспорт
	...
	ВызватьИсключение НСтр("ru='Неизвестный код услуги:';uk='Невідомий код послуги:'") + ИдентификаторТипаУслуги;
...
Функция РезультатПредопределенныхПроверокОперацийСЛицензиями() Экспорт
	...
	Если Не Результат Тогда
		ЗаголовокКомментария = НСтр("ru='Менеджер сервиса не поддерживает версию тарификации ""1.0.1.2""';uk='Менеджер сервісу не підтримує версію тарифікації ""1.0.1.2""'");
...
Функция ЗаголовокКомментария(ИдентификаторПоставщика, ИдентификаторУслуги, ИдентификаторЛицензии = Неопределено, 
	...
	Шаблон = НСтр("ru='Идентификатор поставщика: %1
                                              ...
                                              |Контекст лицензии: %7'
                                              |;uk='Ідентифікатор постачальника: %1
                                              |Ідентифікатор послуги: %2
                                              |Ідентифікатор ліцензії: %3
                                              |Кількість ліцензій: %4
                                              |Ідентифікатор операції: %5
                                              |Код області даних: %6
                                              |Контекст ліцензії: %7'");
...
Функция СтруктураОтветаHTTP(ОтветСтрокой)
	...
	Если ПустаяСтрока(ОтветСтрокой) Тогда
		ВызватьИсключение(НСтр("ru='Пустое тело ответа системы тарификации';uk='Порожнє тіло відповіді системи тарифікації'"));
	КонецЕсли;
...
Функция ЗначениеРазделителя(КодОбластиДанных)
	...
	Иначе
		Если Не ЗначениеЗаполнено(КодОбластиданных) Тогда
			ВызватьИсключение НСтр("ru='Для получения данных в неразделенном сеансе не указан код области данных';uk='Для отримання даних в нерозділеному сеансі не зазначено код області даних'",КодЯзыка());
		Иначе
