...
Процедура ПриОпределенииВидовПодключаемыхКоманд(ВидыПодключаемыхКоманд) Экспорт
	...
	Вид.Заголовок   = НСтр("ru='Настройка порядка элементов';uk='Настройка порядку елементів'");
...
Процедура ПриОпределенииКомандПодключенныхКОбъекту(НастройкиФормы, Источники, ПодключенныеОтчетыИОбработки, Команды) Экспорт
	...
	Команда.Представление = НСтр("ru='Переместить элемент вверх';uk='Перемістити елемент вверх'");
	Команда.Порядок = 1;
	...
	Команда.Представление = НСтр("ru='Переместить элемент вниз';uk='Перемістити елемент униз'");
	Команда.Порядок = 2;
