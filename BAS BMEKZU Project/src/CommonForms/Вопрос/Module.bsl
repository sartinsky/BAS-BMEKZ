...
Процедура ДобавитьКомандыИКнопкиНаФорму(Кнопки)
	...
	Для Каждого ЭлементОписаниеКнопки Из КнопкиСписокЗначений Цикл
		...
		Кнопка= Элементы.Добавить(ИмяКоманды, Тип("КнопкаФормы"), ЭлементРазмещенияКоманд);
...
Процедура УстановитьКнопкуПоУмолчанию(КнопкаПоУмолчанию, ВыделятьКнопкуПоУмолчанию)
	...
	Если Кнопка = Неопределено Тогда
		...
		ЭлементРазмещенияКоманд = ?(ОбщегоНазначенияКлиентСервер.ЭтоМобильныйКлиент(), Элементы.ФормаКоманднаяПанель, Элементы.КоманднаяПанель);
		Кнопка = ЭлементРазмещенияКоманд.ПодчиненныеЭлементы[0];
