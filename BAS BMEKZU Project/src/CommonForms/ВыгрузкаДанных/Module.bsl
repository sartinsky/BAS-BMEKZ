...
Процедура ПолучитьЧастьФайла(ДополнительныеПараметры)
	...
	Состояние(НСтр("ru='Получение файла...';uk='Отримання файлу...'"), ДополнительныеПараметры.ПолученоЧастейФайла * 100 / ДополнительныеПараметры.ВсегоЧастейФайла);
...
Процедура ПоместитьВоВременноеХранилищеЧастьФайла(Знач ОписаниеЧастиФайла, АдресХранилища)
	...
	Если ХешированиеДанных.ХешСумма <> ОписаниеЧастиФайла.ХешСумма Тогда
		...
		ВызватьИсключение НСтр("ru='Ошибка при получении части файла.';uk='Помилка при отриманні частини файлу.'");
...
Процедура ОбработатьОшибку(Знач КраткоеПредставление, Знач ПодробноеПредставление)
	...
	ЗаписьЖурналаРегистрации(
		НСтр("ru='Выгрузка данных';uk='Вивантаження даних'",ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
		УровеньЖурналаРегистрации.Ошибка,
		,
		,
		ТекстЗаписиЖР);
