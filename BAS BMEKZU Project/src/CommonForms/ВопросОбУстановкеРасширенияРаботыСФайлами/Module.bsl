...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ИначеЕсли Не Параметры.ВозможноПродолжениеБезУстановки Тогда
		Элементы.ДекорацияПояснение.Заголовок =
			НСтр("ru='Для выполнения действия требуется установить расширение для веб-клиента платформы.
                       |Установить?'
                       |;uk='Для виконання дії потрібно встановити розширення для веб-клієнта платформи.
                       |Встановити?'");
	КонецЕсли;
