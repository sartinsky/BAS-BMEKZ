...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ТестНовее = " (" + НСтр("ru='новее';uk='новіше'") + ")";
	...
	Если ОбщегоНазначенияКлиентСервер.ЭтоМобильныйКлиент() Тогда
		...
		Элементы.ФормаПоместить.ТолькоВоВсехДействиях = Истина;
		Элементы.ФормаВзятьИзХранилища.ТолькоВоВсехДействиях = Истина;
		Элементы.ФормаНеПомещать.ТолькоВоВсехДействиях = Истина;
		Элементы.Отменить.ТолькоВоВсехДействиях = Истина;
