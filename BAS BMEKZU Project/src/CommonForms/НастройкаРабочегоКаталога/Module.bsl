...
Процедура РабочийКаталогПользователяНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	Заголовок = НСтр("ru='Выберите рабочий каталог';uk='Виберіть робочий каталог'");
...
Процедура ОчиститьЛокальныйКэшФайлов(Команда)
	...
	ТекстВопроса =
		НСтр("ru='Из рабочего каталога будут удалены все файлы,
                   ...
                   |
                   |Продолжить?'
                   |;uk='З робочого каталогу будуть видалені файли,
                   |крім зайнятих для редагування.
                   |
                   |Продовжити?'");
...
Процедура ОчиститьЛокальныйКэшФайловЗавершение(Результат, ПараметрыВыполнения) Экспорт
	...
	ПоказатьОповещениеПользователя(НСтр("ru='Рабочий каталог';uk='Робочий каталог'"),, НСтр("ru='Очистка рабочего каталога успешно завершена.';uk='Очищення робочого каталогу успішно завершена.'"));
