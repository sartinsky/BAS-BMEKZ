...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Заголовок = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='Установка ведущей конечной точки для ""%1""';uk='Встановлення ведучою кінцевої точки для ""%1""'"),
...
Процедура Установить(Команда)
	...
	Если Отказ Тогда
        ...
        |;uk='При установці  ведучої кінцевої точки виникли помилки.
	...
	ПоказатьОповещениеПользователя(,, НСтр("ru='Установка ведущей конечной точки успешно завершена.';uk='Встановлення ведучою кінцевої точки успішно завершена.'"));
