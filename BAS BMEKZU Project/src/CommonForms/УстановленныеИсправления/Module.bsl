...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если СтандартныеПодсистемыСервер.ЭтоБазоваяВерсияКонфигурации() Тогда
		ВызватьИсключение НСтр("ru='Текущий режим работы не поддерживается.';uk='Поточний режим роботи не підтримується.'");
	КонецЕсли;
...
Процедура ДекорацияЖурналРегистрацииНажатие(Элемент)
	...
	МассивСобытий.Добавить(НСтр("ru='Исправления. Установка';uk='Виправлення. Встановлення'"));
	МассивСобытий.Добавить(НСтр("ru='Исправления. Изменение';uk='Виправлення. Зміна'"));
	МассивСобытий.Добавить(НСтр("ru='Исправления. Удаление';uk='Виправлення. Вилучення'"));
...
Процедура УдалитьРасширения(ВыделенныеСтроки)
	...
	Если ВыделенныеСтроки.Количество() > 1 Тогда
		ТекстВопроса = НСтр("ru='Удалить выделенные исправления?';uk='Видалити виділені виправлення?'","ru");
	Иначе
		ТекстВопроса = НСтр("ru='Удалить исправление?';uk='Видалити виправлення?'","ru");
	КонецЕсли;
