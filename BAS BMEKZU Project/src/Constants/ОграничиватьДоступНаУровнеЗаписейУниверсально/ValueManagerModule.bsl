...
Процедура ПриЗаписи(Отказ)
	...
	Если Значение И Не СтароеЗначение Тогда // Включено.
		Если Не Константы.ОграничиватьДоступНаУровнеЗаписей.Получить() Тогда
			ТекстОшибки =
				НСтр("ru='Чтобы включить константу ""Ограничивать доступ на уровне записей универсально""
                           ...
                           |;uk='Щоб включити константу ""Обмежувати доступ на рівні записів універсально""
                           |спочатку потрібно включити константу ""Обмежувати доступ на рівні записів"".'");
		...
		УправлениеДоступомСлужебный.ЗапланироватьОбновлениеДоступа();
