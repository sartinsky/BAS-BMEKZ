...
Процедура ПередЗаписью(Отказ)
	...
	Если ЗначениеИзменено
	   ...
	   И Не ПользователиСлужебный.ВнешниеПользователиВнедрены() Тогда
		ВызватьИсключение НСтр("ru='Использование внешних пользователей не предусмотрено в программе.';uk='Використання зовнішніх користувачів не передбачено у програмі.'");
	КонецЕсли;
