...
Процедура Выбрать(Команда)
	...
	Результат.Вставить("ПерсональныеНастройкиЭлеватор", ВыбранныеПрочиеНастройкиСтруктура.МассивПерсональныхНастроекЭлеватор); // ИНАГРО
...
Функция ВыбранныеНастройки(ДеревоНастроек)
	...
	МассивПерсональныхНастроекЭлеватор = Новый Массив; // ИНАГРО
	...
	Для Каждого Настройка Из ДеревоНастроек.ПолучитьЭлементы() Цикл
		...
		Если Настройка.Пометка = 1 Тогда
			...
			ИначеЕсли Настройка.Тип = "ПерсональныеНастройкиЭлеватор" Тогда // ИНАГРО
				МассивПерсональныхНастроекЭлеватор.Добавить(Настройка.Ключи);
	...
	СтруктураНастроек.Вставить("МассивПерсональныхНастроекЭлеватор", МассивПерсональныхНастроекЭлеватор); // ИНАГРО
