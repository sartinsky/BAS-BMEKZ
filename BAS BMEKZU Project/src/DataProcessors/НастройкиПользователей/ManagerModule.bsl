...
Функция ФормыОбъектовМетаданных()
	...
	ЗаполнитьФормыОбъектовМетаданных(Метаданные.КритерииОтбора, "КритерийОтбора", НСтр("ru='Критерий отбора';uk='Критерій відбору'"),
		ИменаСтандартныхФорм, БиблиотекаКартинок.КритерийОтбора, СписокФорм);
		
	ИменаСтандартныхФорм = Новый СписокЗначений;
	ЗаполнитьФормыОбъектовМетаданных(Метаданные.ХранилищаНастроек, "ХранилищеНастроек", НСтр("ru='Хранилище настроек';uk='Сховище настройок'"),
	...
	ЗаполнитьФормыОбъектовМетаданных(Метаданные.Справочники, "Справочник", НСтр("ru='Справочник';uk='Довідник'"),
	...
	ИменаСтандартныхФорм.Добавить("ФормаСписка");
	ИменаСтандартныхФорм.Добавить("ФормаДляВыбора", "ФормаВыбора");
	ЗаполнитьФормыОбъектовМетаданных(Метаданные.Документы, "Документ", НСтр("ru='Документ';uk='Документ'"),
		ИменаСтандартныхФорм, БиблиотекаКартинок.Документ, СписокФорм);
	
	ИменаСтандартныхФорм = Новый СписокЗначений;
	ИменаСтандартныхФорм.Добавить("Форма");
	ЗаполнитьФормыОбъектовМетаданных(Метаданные.ЖурналыДокументов, "ЖурналДокументов", НСтр("ru='Журнал документов';uk='Журнал документів'"),
		ИменаСтандартныхФорм, БиблиотекаКартинок.ЖурналДокументов, СписокФорм);
	
	ИменаСтандартныхФорм = Новый СписокЗначений;
	ИменаСтандартныхФорм.Добавить("ФормаСписка");
	ИменаСтандартныхФорм.Добавить("ФормаДляВыбора", "ФормаВыбора");
	ЗаполнитьФормыОбъектовМетаданных(Метаданные.Перечисления, "Перечисление", НСтр("ru='Перечисление';uk='Перелічення'"),
	...
	ЗаполнитьФормыОбъектовМетаданных(Метаданные.Отчеты, "Отчет", НСтр("ru='Отчет';uk='Звіт'"),
		ИменаСтандартныхФорм, БиблиотекаКартинок.Отчет, СписокФорм);
	
	ИменаСтандартныхФорм = Новый СписокЗначений;
	ИменаСтандартныхФорм.Добавить("Форма");
	ЗаполнитьФормыОбъектовМетаданных(Метаданные.Обработки, "Обработка", НСтр("ru='Обработка';uk='Обробка'"),
	...
	ИменаСтандартныхФорм.Добавить("ФормаДляВыбора", "ФормаВыбора");
	ИменаСтандартныхФорм.Добавить("ФормаДляВыбораГруппы", "ФормаВыбораГруппы");
	ЗаполнитьФормыОбъектовМетаданных(Метаданные.ПланыВидовХарактеристик, "ПланВидовХарактеристик", НСтр("ru='План видов характеристик';uk='План видів характеристик'"),
	...
	ИменаСтандартныхФорм.Добавить("ФормаСписка");
	ИменаСтандартныхФорм.Добавить("ФормаДляВыбора", "ФормаВыбора");
	ЗаполнитьФормыОбъектовМетаданных(Метаданные.ПланыСчетов, "ПланСчетов", НСтр("ru='План счетов';uk='План рахунків'"),
	...
	ИменаСтандартныхФорм.Добавить("ФормаСписка");
	ИменаСтандартныхФорм.Добавить("ФормаДляВыбора", "ФормаВыбора");
	ЗаполнитьФормыОбъектовМетаданных(Метаданные.ПланыВидовРасчета, "ПланВидовРасчета", НСтр("ru='План видов расчета';uk='План видів розрахунку'"),
		ИменаСтандартныхФорм, БиблиотекаКартинок.ПланВидовРасчета, СписокФорм);
	
	ИменаСтандартныхФорм = Новый СписокЗначений;
	ИменаСтандартныхФорм.Добавить("ФормаЗаписи");
	ИменаСтандартныхФорм.Добавить("ФормаСписка");
	ЗаполнитьФормыОбъектовМетаданных(Метаданные.РегистрыСведений, "РегистрСведений", НСтр("ru='Регистр сведений';uk='Регістр відомостей'"),
		ИменаСтандартныхФорм, БиблиотекаКартинок.РегистрСведений, СписокФорм);
	
	ИменаСтандартныхФорм = Новый СписокЗначений;
	ИменаСтандартныхФорм.Добавить("ФормаСписка");
	ЗаполнитьФормыОбъектовМетаданных(Метаданные.РегистрыНакопления, "РегистрНакопления", НСтр("ru='Регистр накопления';uk='Регістр накопичення'"),
		ИменаСтандартныхФорм, БиблиотекаКартинок.РегистрНакопления, СписокФорм);
	
	ИменаСтандартныхФорм = Новый СписокЗначений;
	ИменаСтандартныхФорм.Добавить("ФормаСписка");
	ЗаполнитьФормыОбъектовМетаданных(Метаданные.РегистрыБухгалтерии, "РегистрБухгалтерии", НСтр("ru='Регистр бухгалтерии';uk='Регістр бухгалтерії'"),
		ИменаСтандартныхФорм, БиблиотекаКартинок.РегистрБухгалтерии, СписокФорм);
	
	ИменаСтандартныхФорм = Новый СписокЗначений;
	ИменаСтандартныхФорм.Добавить("ФормаСписка");
	ЗаполнитьФормыОбъектовМетаданных(Метаданные.РегистрыРасчета, "РегистрРасчета", НСтр("ru='Регистр расчета';uk='Регістр розрахунку'"),
	...
	ИменаСтандартныхФорм.Добавить("ФормаСписка");
	ИменаСтандартныхФорм.Добавить("ФормаДляВыбора", "ФормаВыбора");
	ЗаполнитьФормыОбъектовМетаданных(Метаданные.БизнесПроцессы, "БизнесПроцесс", НСтр("ru='Бизнес-процесс';uk='Бізнес-процес'"),
	...
	ИменаСтандартныхФорм.Добавить("ФормаСписка");
	ИменаСтандартныхФорм.Добавить("ФормаДляВыбора", "ФормаВыбора");
	ЗаполнитьФормыОбъектовМетаданных(Метаданные.Задачи, "Задача", НСтр("ru='Задача';uk='Задача'"),
		ИменаСтандартныхФорм, БиблиотекаКартинок.Задача, СписокФорм);
	
	ИменаСтандартныхФорм = Новый СписокЗначений;
	ИменаСтандартныхФорм.Добавить("ФормаЗаписи");
	ИменаСтандартныхФорм.Добавить("ФормаСписка");
	ЗаполнитьФормыОбъектовМетаданных(Метаданные.ВнешниеИсточникиДанных, "ВнешнийИсточникДанных", НСтр("ru='Внешние источники данных';uk='Зовнішні джерела даних'"),
...
Процедура УдалитьНастройкиПользователей(ОчищаемыеНастройки, Источники, ТаблицаПользовательскихВариантовОтчетов = Неопределено) Экспорт
	...
	СоответствиеНастройкаХранилище.Вставить("ПерсональныеНастройкиЭлеватор", ХранилищеОбщихНастроек); // ИНАГРО	
...
Функция ПользовательскиеВариантыОтчетов(ПользовательИнформационнойБазы)
	...
	Для Каждого ОтчетМетаданные Из Метаданные.Отчеты Цикл
		...
		ИнтеграцияПодсистемБСП.ПриПолученииПользовательскихВариантовОтчетов(ОтчетМетаданные,
...
Процедура ЗаполнитьСписокПрочихНастроек(Параметры)
	...
	Ключи = Новый СписокЗначений;
	КлючиЭлеватор = Новый СписокЗначений; // ИНАГРО
	ПрочиеКлючи = Новый СписокЗначений;
	                                                                         
	// Заполнение персональных настроек 
	Для Каждого Настройка Из Настройки Цикл		
			
		Если Настройка.КлючНастроек = "Элеватор" Тогда // ИНАГРО
			КлючиЭлеватор.Добавить(Настройка.КлючОбъекта, Настройка.КлючНастроек);
		Иначе			
	...
	Если Ключи.Количество() > 0 Тогда
		...
		Если Не ПустаяСтрока(Параметры.Поиск) Тогда
			Если СтрНайти(ВРег(НСтр("ru='Персональные настройки';uk='Персональні настройки'")), ВРег(Параметры.Поиск)) = 0 Тогда
	...
	// ИНАГРО++
	ВыводитьНастройку = Истина;
	Если КлючиЭлеватор.Количество() > 0 Тогда
		
		Если Не ПустаяСтрока(Параметры.Поиск) Тогда
			Если Найти(ВРег(НСтр("ru='Персональные настройки (элеватор)';uk='Персональні настройки (елеватор)'")), ВРег(Параметры.Поиск)) = 0 Тогда
				ВыводитьНастройку = Ложь;
			КонецЕсли;
		КонецЕсли;
		
		Если ВыводитьНастройку Тогда
			Настройка = НСтр("ru='Персональные настройки (элеватор)';uk='Персональні настройки (елеватор)'");
			ТипНастройки = "ПерсональныеНастройкиЭлеватор";
			Картинка = БиблиотекаКартинок.ИНАГРО_АрендаЗемли;
			ДобавитьСтрокуДерева(Параметры.ПрочиеНастройкиДерево, Настройка, Картинка, КлючиЭлеватор, ТипНастройки);
		КонецЕсли;
	...
	Если Не ПустаяСтрока(Параметры.Поиск) Тогда
		...
		Если СтрНайти(ВРег(НСтр("ru='Настройки печати табличных документов';uk='Настройки друку табличних документів'")), ВРег(Параметры.Поиск)) = 0 Тогда
			ВыводитьНастройку = Ложь;
		КонецЕсли;
	...
	Если Не ПустаяСтрока(Параметры.Поиск) Тогда
		...
		Если СтрНайти(ВРег(НСтр("ru='Избранное';uk='Вибране'")), ВРег(Параметры.Поиск)) = 0 Тогда
			ВыводитьНастройку = Ложь;
		КонецЕсли;
	...
	Если Не ПустаяСтрока(Параметры.Поиск) Тогда
		...
		Если СтрНайти(ВРег(НСтр("ru='Прочие настройки';uk='Інші настройки'")), ВРег(Параметры.Поиск)) = 0 Тогда
			ВыводитьНастройку = Ложь;
		КонецЕсли;
...
Процедура ДобавитьНастройкиРабочегоСтолаИКомандногоИнтерфейса(Параметры, ДеревоНастроек)
	...
	Если Не ПустаяСтрока(Параметры.Поиск) Тогда
		Если СтрНайти(ВРег(НСтр("ru='Командный интерфейс и начальная страница';uk='Командний інтерфейс і початкова сторінка'")), ВРег(Параметры.Поиск)) = 0 Тогда
			Возврат;
		КонецЕсли;
	КонецЕсли;
