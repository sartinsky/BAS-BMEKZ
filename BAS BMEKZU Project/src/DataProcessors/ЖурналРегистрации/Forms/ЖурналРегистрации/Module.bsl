...
Функция ПрочитатьЖурнал()
	...
	ПараметрыВыполнения.НаименованиеФоновогоЗадания = НСтр("ru='Обновление журнала регистрации';uk='Оновлення журналу реєстрації'");
...
Процедура ВыгрузитьЖурналПродолжение(Подключено, ДополнительныеПараметры) Экспорт
	...
	Если Подключено Тогда
		...
		ДиалогСохранения.Фильтр = НСтр("ru='Данные журнала регистрации';uk='Дані журналу реєстрації'") + "(*.xml)|*.xml";
