...
Функция ОбъектМетаданных(Знач ПолноеИмя)
	...
	Если ОбъектМетаданных = Неопределено Тогда
		...
		ВызватьИсключение СтрШаблон(НСтр("ru='В текущей конфигурации отсутствует объект метаданных %1, присутствующих в файле данных.';uk='У поточній конфігурації відсутній об''єкт метаданих %1, присутніх у файлі даних.'"),
			ПолноеИмя);
