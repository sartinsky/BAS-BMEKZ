...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ОбщегоНазначения.РазделениеВключено() Тогда
		ВызватьИсключение НСтр("ru='Управление итогами и агрегатами недоступно в модели сервиса.';uk='Управління підсумками і агрегатами недоступне в моделі сервісу.'");
	КонецЕсли;
...
Процедура ОбработкаВыбора(ВыбранноеЗначение, ИсточникВыбора)
	...
	Если ВРег(ИсточникВыбора.ИмяФормы) = ВРег("Обработка.УправлениеИтогамиИАгрегатами.Форма.ФормаВыбораПериода") Тогда
		...
		ПараметрыИтогов.Вставить("ОбрабатыватьЗаголовок",  НСтр("ru='Установка периода рассчитанных итогов ...';uk='Встановлення періоду розрахованих підсумків ...'"));
		ПараметрыИтогов.Вставить("ПослеПроцесса",          НСтр("ru='Установка периода рассчитанных итогов завершена';uk='Встановлення періоду розрахованих підсумків завершене'"));
		...
		ПараметрыИтогов.Вставить("ТекстСообщенияОбОшибке", НСтр("ru='Не удалось установить период рассчитанных итогов.';uk='Не вдалося встановити період розрахованих підсумків.'"));
	...
	ИначеЕсли ВРег(ИсточникВыбора.ИмяФормы) = ВРег("Обработка.УправлениеИтогамиИАгрегатами.Форма.ФормаПараметровПерестроения") Тогда
		...
		Если КонтекстВыбора = "ПерестроитьАгрегаты" Тогда
			...
			ПараметрыИтогов.Вставить("ТекстСообщенияОбОшибке", НСтр("ru='Не удалось перестроить агрегаты.';uk='Не вдалося перебудувати агрегати.'"));
...
Процедура ВключитьИспользованиеИтогов(Команда)
	...
	ПараметрыИтогов.Вставить("ТекстСообщенияОбОшибке", НСтр("ru='Не удалось включить использование итогов.';uk='Не вдалося включити використання підсумків.'"));
...
Процедура ВключитьИспользованиеТекущихИтогов(Команда)
	...
	ПараметрыИтогов.Вставить("Значение1",              Истина);
	ПараметрыИтогов.Вставить("Значение2",              Неопределено);
	ПараметрыИтогов.Вставить("ТекстСообщенияОбОшибке", НСтр("ru='Не удалось включить использование текущих итогов.';uk='Не вдалося включити використання поточних підсумків.'"));
...
Процедура ВыключитьИспользованиеИтогов(Команда)
	...
	ПараметрыИтогов.Вставить("Значение2",              Неопределено);
	ПараметрыИтогов.Вставить("ТекстСообщенияОбОшибке", НСтр("ru='Не удалось выключить использование итогов.';uk='Не вдалося вимкнути використання підсумків.'"));
...
Процедура ВыключитьИспользованиеТекущихИтогов(Команда)
	...
	ПараметрыИтогов.Вставить("Значение1",              Ложь);
	ПараметрыИтогов.Вставить("Значение2",              Неопределено);
	ПараметрыИтогов.Вставить("ТекстСообщенияОбОшибке", НСтр("ru='Не удалось выключить использование текущих итогов.';uk='Не вдалося вимкнути використання поточних підсумків.'"));
...
Процедура ВключитьРазделениеИтогов(Команда)
	...
	ПараметрыИтогов.Вставить("Значение1",              Истина);
	ПараметрыИтогов.Вставить("Значение2",              Неопределено);
	ПараметрыИтогов.Вставить("ТекстСообщенияОбОшибке", НСтр("ru='Не удалось включить разделение итогов.';uk='Не вдалося включити поділ підсумків.'"));
...
Процедура ВыключитьРазделениеИтогов(Команда)
	...
	ПараметрыИтогов.Вставить("Значение1",              Ложь);
	ПараметрыИтогов.Вставить("Значение2",              Неопределено);
	ПараметрыИтогов.Вставить("ТекстСообщенияОбОшибке", НСтр("ru='Не удалось выключить разделение итогов.';uk='Не вдалося вимкнути поділ підсумків.'"));
...
Процедура ВключитьРежимАгрегатов(Команда)
	...
	ПараметрыИтогов.Вставить("Значение1",              Истина);
	ПараметрыИтогов.Вставить("Значение2",              Неопределено);
	ПараметрыИтогов.Вставить("ТекстСообщенияОбОшибке", НСтр("ru='Не удалось включить режим агрегатов.';uk='Не вдалося включити режим агрегатів.'"));
...
Процедура ВключитьРежимИтогов(Команда)
	...
	ПараметрыИтогов.Вставить("Значение1",              Ложь);
	ПараметрыИтогов.Вставить("Значение2",              Неопределено);
	ПараметрыИтогов.Вставить("ТекстСообщенияОбОшибке", НСтр("ru='Не удалось включить режим итогов.';uk='Не вдалося включити режим підсумків.'"));
...
Процедура ВключитьИспользованиеАгрегатов(Команда)
	...
	ПараметрыИтогов.Вставить("Значение1",              Истина);
	ПараметрыИтогов.Вставить("Значение2",              Неопределено);
	ПараметрыИтогов.Вставить("ТекстСообщенияОбОшибке", НСтр("ru='Не удалось включить использование агрегатов.';uk='Не вдалося включити використання агрегатів.'"));
...
Процедура ВыключитьИспользованиеАгрегатов(Команда)
	...
	ПараметрыИтогов.Вставить("Значение1",              Ложь);
	ПараметрыИтогов.Вставить("Значение2",              Неопределено);
	ПараметрыИтогов.Вставить("ТекстСообщенияОбОшибке", НСтр("ru='Не удалось выключить использование агрегатов.';uk='Не вдалося вимкнути використання агрегатів.'"));
...
Процедура ЗаполнитьАгрегатыПоРегистрам(Команда)
	...
	ПараметрыИтогов.Вставить("Значение2",              Неопределено);
	ПараметрыИтогов.Вставить("ТекстСообщенияОбОшибке", НСтр("ru='Не удалось заполнить агрегаты.';uk='Не вдалося заповнити агрегати.'"));
...
Процедура ПересчитатьИтоги(Команда)
	...
	ПараметрыИтогов.Вставить("Значение1",              Ложь);
	ПараметрыИтогов.Вставить("Значение2",              Неопределено);
	ПараметрыИтогов.Вставить("ТекстСообщенияОбОшибке", НСтр("ru='Не удалось пересчитать итоги.';uk='Не вдалося перерахувати підсумки.'"));
...
Процедура ПересчитатьТекущиеИтоги(Команда)
	...
	ПараметрыИтогов.Вставить("Значение1",              Ложь);
	ПараметрыИтогов.Вставить("Значение2",              Неопределено);
	ПараметрыИтогов.Вставить("ТекстСообщенияОбОшибке", НСтр("ru='Не удалось пересчитать текущие итоги.';uk='Не вдалося перерахувати поточні підсумки.'"));
...
Процедура ОчиститьАгрегатыПоРегистрамЗавершение(Ответ, ДополнительныеПараметры) Экспорт
	...
	Если Ответ = КодВозвратаДиалога.Да Тогда
		...
		ПараметрыИтогов.Вставить("Значение1",              Неопределено);
		ПараметрыИтогов.Вставить("Значение2",              Неопределено);
		ПараметрыИтогов.Вставить("ТекстСообщенияОбОшибке", НСтр("ru='Не удалось очистить агрегаты.';uk='Не вдалося очистити агрегати.'"));
...
Процедура ПересчитатьИтогиЗаПериодЗавершение(ВыбранноеЗначение, ДополнительныеПараметры) Экспорт
	...
	ПараметрыИтогов.Вставить("ПослеПроцесса",          НСтр("ru='Пересчет итогов за период завершен.';uk='Перерахунок підсумків за період завершено.'"));
	...
	ПараметрыИтогов.Вставить("ТекстСообщенияОбОшибке", НСтр("ru='Не удалось пересчитать итоги за период.';uk='Не вдалося перерахувати підсумки за період.'"));
...
Процедура ПолучитьОптимальныеАгрегатКлиентЗавершение(ПустойПараметр, РезультатВыполнения) Экспорт
	...
	Иначе
		ПоказатьОповещениеПользователя(НСтр("ru='Агрегаты успешно получены.';uk='Агрегати успішно отримані.'"),,
...
Процедура УправлениеИтогами(Знач ПараметрыИтогов)
	...
	ТекстСостояния = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		НСтр("ru='Пересчитаны (%1 из %2)';uk='Перераховані (%1 з %2)'"),
...
Функция ПолучитьОптимальныеАгрегатыСервер()
	...
	Для НомерСтроки = 1 По Всего Цикл
		...
		Исключение
			...
			ПодробныйТекстОшибок = ПодробныйТекстОшибок
				...
				+ СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='%1: %2';uk='%1: %2'"), ИмяРегистраНакопления, 
		...
		Если Результат.ЕстьОшибки Тогда
			Результат.ТекстСообщения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru='Не удалось получить оптимальные агрегаты регистра накопления ""%1"" по причине:
                    |%2'
                    |;uk='Не вдалося отримати оптимальні агрегати регістру накопичення ""%1"" з причини:
                    |%2'"), ИмяРегистра, ПодробныйТекстОшибок);
		Иначе
			Результат.ТекстСообщения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru='%1 (регистр накопления)';uk='%1 (регістр накопичення)'"),	ИмяРегистра);
		КонецЕсли;
	...
	ИначеЕсли Успешно = 0 Тогда
		...
		Результат.ТекстСообщения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
            ...
            |%1'
            |;uk='Не вдалося отримати оптимальні агрегати регістрів накопичення через:
	...
	Иначе
		...
		// Полностью успешно.
		Результат.ТекстСообщения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru='Регистры накопления (%1)';uk='Регістри накопичення (%1)'"), Успешно);
...
Процедура ПрочитатьИнформациюПоРегистрам()
	...
	Для Каждого Регистр Из Метаданные.РегистрыНакопления Цикл
		...
		Если Регистр.ВидРегистра = Метаданные.СвойстваОбъектов.ВидРегистраНакопления.Обороты Тогда
			...
			Постфикс = НСтр("ru='регистр накопления, только обороты';uk='регістр накопичення, тільки обороти'");
		Иначе
			ОстаткиИОбороты = Истина;
			Постфикс = НСтр("ru='регистр накопления, остатки и обороты';uk='регістр накопичення, залишки і обороти'");
		КонецЕсли;
