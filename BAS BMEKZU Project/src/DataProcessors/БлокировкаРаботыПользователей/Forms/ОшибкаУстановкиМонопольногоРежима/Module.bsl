...
Процедура УстановитьБлокировкуФайловойБазы()
	...
	Если УдалениеПомеченныхОбъектов Тогда
		...
		Объект.СообщениеДляПользователей = НСтр("ru='Программа заблокирована для удаления помеченных объектов.';uk='Програма заблокована для вилучення відмічених об''єктів.'");
	Иначе
		Объект.НачалоДействияБлокировки = ТекущаяДатаСеанса() + 2*60;
