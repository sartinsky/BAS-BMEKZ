...
|
|Перенести?';uk='Підібрані нематеріальні активи не перенесені в документ.
|
...
Процедура СформироватьИнформационнуюНадпись(Форма)
	...
	ШаблонНадписи = НСтр("ru='Всего подобрано %1 позиции(ия)';uk='Всього підібрано %1 позиції(ія)'");
