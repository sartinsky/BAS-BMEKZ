...
Функция НовоеОписаниеПрофиляБезопасности(Знач ТипПрограммногоМодуля, Знач ИдентификаторПрограммногоМодуля)
	...
	Если ПустаяСтрока(ИмяИБ) Тогда
		ВызватьИсключение НСтр("ru='Строка соединения информационной базы должна содержать информационной базы';uk='Рядок з''єднання інформаційної бази повинна містити інформаційної бази'");
	КонецЕсли;
