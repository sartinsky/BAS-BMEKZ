...
Функция РезультатСопоставленияОбъектов(Параметры)
	...
	Если Параметры.РеквизитыФормы.ТолькоПрименитьТаблицуНеутвержденныхЗаписей Тогда
		...
		Если Отказ Тогда
			ВызватьИсключение НСтр("ru='Возникли ошибки в процессе сопоставления объектов.';uk='Виникли помилки в процесі співставлення об''єктів.'");
		КонецЕсли;
...
Функция РезультатАвтоматическогоСопоставленияОбъектов(Параметры)
	...
	Если Отказ Тогда
		ВызватьИсключение НСтр("ru='Возникли ошибки в процессе автоматического сопоставления объектов.';uk='Виникли помилки в процесі автоматичного співставлення об''єктів.'");
	КонецЕсли;
