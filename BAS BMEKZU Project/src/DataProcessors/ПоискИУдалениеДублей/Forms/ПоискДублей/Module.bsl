...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ШагПоиск.КнопкаДалее.Заголовок = НСтр("ru='Найти дубли >';uk='Знайти дублі >'");
	ШагПоиск.КнопкаДалее.Подсказка = НСтр("ru='Найти дубли по указанным критериям';uk='Знайти дублі за вказаними критеріями'");
	ШагПоиск.КнопкаОтмена.Заголовок = НСтр("ru='Закрыть';uk='Закрити'");
	ШагПоиск.КнопкаОтмена.Подсказка = НСтр("ru='Отказаться от поиска и замены дублей';uk='Відмовитися від пошуку і заміни дублів'");
	
	// 2. Длительный поиск.
	Шаг = ДобавитьШагМастера(Элементы.ШагВыполнениеПоиска);
	Шаг.КнопкаНазад.Видимость = Ложь;
	Шаг.КнопкаДалее.Видимость = Ложь;
	Шаг.КнопкаОтмена.Заголовок = НСтр("ru='Прервать';uk='Перервати'");
	Шаг.КнопкаОтмена.Подсказка = НСтр("ru='Прервать поиск дублей';uk='Перервати пошук дублів'");
	
	// 3. Обработка результатов поиска, выбор основных элементов.
	Шаг = ДобавитьШагМастера(Элементы.ШагВыборОсновногоЭлемента);
	Шаг.КнопкаНазад.Видимость = Ложь;
	Шаг.КнопкаДалее.Заголовок = НСтр("ru='Удалить дубли >';uk='Вилучити дублі >'");
	Шаг.КнопкаДалее.Подсказка = НСтр("ru='Удалить дубли';uk='Вилучити дублі'");
	Шаг.КнопкаОтмена.Заголовок = НСтр("ru='Закрыть';uk='Закрити'");
	Шаг.КнопкаОтмена.Подсказка = НСтр("ru='Отказаться от поиска и замены дублей';uk='Відмовитися від пошуку і заміни дублів'");
	...
	Шаг.КнопкаДалее.Видимость = Ложь;
	Шаг.КнопкаОтмена.Заголовок = НСтр("ru='Прервать';uk='Перервати'");
	Шаг.КнопкаОтмена.Подсказка = НСтр("ru='Прервать удаление дублей';uk='Перервати вилучення дублів'");
	
	// 5. Успешное удаление.
	Шаг = ДобавитьШагМастера(Элементы.ШагУспешноеУдаление);
	Шаг.КнопкаНазад.Заголовок = НСтр("ru='< Новый поиск';uk='< Новий пошук'");
	Шаг.КнопкаНазад.Подсказка = НСтр("ru='Начать новый поиск с другими параметрами';uk='Почати новий пошук з іншими параметрами'");
	Шаг.КнопкаДалее.Видимость = Ложь;
	...
	Шаг.КнопкаНазад.Видимость = Ложь;
	Шаг.КнопкаДалее.Заголовок = НСтр("ru='Повторить удаление >';uk='Повторити вилучення >'");
	Шаг.КнопкаДалее.Подсказка = НСтр("ru='Удалить дубли';uk='Вилучити дублі'");
	Шаг.КнопкаОтмена.Заголовок = НСтр("ru='Закрыть';uk='Закрити'");
	...
	Шаг.КнопкаНазад.Видимость = Ложь;
	Шаг.КнопкаДалее.Заголовок = НСтр("ru='Найти дубли >';uk='Знайти дублі >'");
	Шаг.КнопкаДалее.Подсказка = НСтр("ru='Найти дубли по указанным критериям';uk='Знайти дублі за вказаними критеріями'");
	Шаг.КнопкаОтмена.Заголовок = НСтр("ru='Закрыть';uk='Закрити'");
...
Функция ДобавитьШагМастера(Знач Страница)
	...
	ОписаниеШага.КнопкаНазад.Заголовок = НСтр("ru='< Назад';uk='< Назад'");
	ОписаниеШага.КнопкаДалее = КнопкаМастера();
	ОписаниеШага.КнопкаДалее.КнопкаПоУмолчанию = Истина;
	ОписаниеШага.КнопкаДалее.Заголовок = НСтр("ru='Далее >';uk='Далі >'");
	ОписаниеШага.КнопкаОтмена = КнопкаМастера();
	ОписаниеШага.КнопкаОтмена.Заголовок = НСтр("ru='Отмена';uk='Відмінити'");
	...
	Иначе
		...
		Если Не ШагНайден Тогда
			ВызватьИсключение СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru='Не найден шаг ""%1"".';uk='Не знайдено крок ""%1"".'"),
				ИмяИскомойСтраницы);
		КонецЕсли;
	КонецЕсли;
...
Процедура ШагМастераДалее()
	...
	Если ТекущаяСтраница = Элементы.ШагПоискНеВыполнялся Тогда
		...
		Если ПустаяСтрока(ОбластьПоискаДублей) Тогда
			ПоказатьПредупреждение(, НСтр("ru='Необходимо выбрать область поиска дублей';uk='Необхідно вибрати область пошуку дублів'"));
			Возврат;
		КонецЕсли;
...
Процедура ОбновитьОписаниеСостоянияНайденныхДублей(Форма)
	...
	Форма.ОписаниеСостоянияНайденныхДублей = Новый ФорматированнаяСтрока(
		СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru='Найдено дублей: %2 (среди элементов: %1). Все отмеченные элементы будут помечены на удаление и заменены во всех местах использования на оригиналы (отмечены стрелкой).';uk='Знайдено дублів: %2 (серед елементів: %1). Всі відмічені елементи будуть позначені на вилучення та замінені у всіх місцях використання на оригінали (відмічені стрілками).'"),
...
Функция ЗапуститьФоновоеЗадание()
	...
	ИначеЕсли ТекущаяСтраница = Элементы.ШагВыполнениеУдаления Тогда
		...
		ПараметрыПроцедуры.Вставить("ЗаменаПарыВТранзакции", Ложь);
		
	Иначе
		ВызватьИсключение НСтр("ru='Некорректное имя процедуры.';uk='Некоректне ім''я процедури.'");
	КонецЕсли;
...
Процедура ПослеЗавершенияФоновогоЗадания(Задание, ДополнительныеПараметры) Экспорт
	...
	Если Задание.Статус <> "Выполнено" Тогда
		...
		Если ТекущаяСтраница = Элементы.ШагВыполнениеПоиска Тогда
			Кратко = НСтр("ru='При поиске дублей возникла ошибка:';uk='При пошуці дублів виникла помилка:'");
		ИначеЕсли ТекущаяСтраница = Элементы.ШагВыполнениеУдаления Тогда
			Кратко = НСтр("ru='При удалении дублей возникла ошибка:';uk='При вилученні дублів виникла помилка:'");
		КонецЕсли;
