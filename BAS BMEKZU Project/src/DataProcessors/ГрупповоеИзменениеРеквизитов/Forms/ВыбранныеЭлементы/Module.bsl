...
Процедура ОбновитьСписокВыбранныхНаСервере()
	...
	Если КоличествоВыбранных > 1000 Тогда
		КоличествоВыбранных = НСтр("ru='> 1000';uk='> 1000'");
	...
	КонецЕсли;
	Элементы.ГруппаВыбранныеОбъекты.Заголовок = ПодставитьПараметрыВСтроку(НСтр("ru='Выбранные элементы (%1)';uk='Обрані елементи (%1)'"), КоличествоВыбранных);
