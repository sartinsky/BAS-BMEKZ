...
Процедура ПриОткрытии(Отказ)
	...
	#Если МобильныйКлиент Тогда
		...
		ПоказатьПредупреждение(, НСтр("ru='Для корректной работы необходим режим толстого, тонкого или ВЕБ-клиента.';uk='Для коректної роботи необхідний режим товстого, тонкого або ВЕБ-клієнта.'"));
		Отказ = Истина;
		Возврат;
