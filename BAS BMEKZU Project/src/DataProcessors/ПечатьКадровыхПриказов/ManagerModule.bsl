...
Процедура ВывестиДанныеКадровогоПриказаВТабличныйДокумент(Макет, ТабличныйДокумент, МассивДанныхЗаполнения, ОбъектыПечати)
	Если Макет <> Неопределено Тогда
		...
		Для каждого ПараметрыМакета из МассивДанныхЗаполнения Цикл
			...
			Макет.Параметры.ФИОРуководителя = ФизическиеЛицаКлиентСервер.ИмяФамилияВФорматеДСТУ(Макет.Параметры.ФИОРуководителя);
			Макет.Параметры.НазваниеОрганизации = ВРег(Макет.Параметры.НазваниеОрганизации);
