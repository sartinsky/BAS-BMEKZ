...
Функция ЗапуститьПроцедурыЗаполненияОтложенныхОбработчиков()
	...
	ПараметрыВыполнения.НаименованиеФоновогоЗадания = НСтр("ru='Управление многопоточной регистрацией данных отложенного обновления';uk='Управління многопоточной реєстрацією даних відкладеного оновлення'");
