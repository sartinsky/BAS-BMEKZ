...
Функция ЗапуститьИзменениеПрефиксаИБВФоновомЗадании()
	...
	ПараметрыВыполнения.НаименованиеФоновогоЗадания = НСтр("ru='Изменение префикса';uk='Зміна префікса'");
...
Процедура ПослеИзмененияПрефикса(ФоновоеЗадание, ДополнительныеПараметры) Экспорт
	...
	Если ФоновоеЗадание <> Неопределено
		...
		ПоказатьОповещениеПользователя(НСтр("ru='Префикс изменен.';uk='Префікс змінено.'"));
	...
	Иначе
		...
		Если ФоновоеЗадание <> Неопределено Тогда
			ТекстОшибки = НСтр("ru='Не удалось изменить префикс.
                ...
                |;uk='Не вдалося змінити префікс.
                |Див. подробиці в журналі реєстрації.'");
...
Процедура УстановитьВидимость()
	...
	Если РазделениеВключено Тогда
		Элементы.ОписаниеРаздела.Заголовок = НСтр("ru='Синхронизация данных с моими приложениями.';uk='Синхронізація даних з моїми додатками.'");
	КонецЕсли;
