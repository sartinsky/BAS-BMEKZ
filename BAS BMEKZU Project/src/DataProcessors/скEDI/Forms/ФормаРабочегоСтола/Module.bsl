			...
			Если ЧтоСохраняем = "СписокЭлектронныхДокументов" Тогда
				...
				Если ИзображениеДокументаPDF или ИзображениеДокументаPNG Тогда
					...
					//Если ЗначениеЗаполнено(ТелоДокумента) Тогда
						...
						скEDI_ОбщегоНазначения.ПолучитьСодержимоеПоЭлектронномуДокументу(ЭлектронныйДокумент.Организация, ЭлектронныйДокумент, СодержаниеЭлектронногоДокумента, ИзображениеДокументаPDF, ИзображениеДокументаPNG, СохранятьВложенныеФайлы, пПредставлениеЭлектронногоДокументаPDF, пОтображениеМассивКартинок, Неопределено, пДанныеДляОтображенияЭлектронногоДокументаСоответствие, "");
