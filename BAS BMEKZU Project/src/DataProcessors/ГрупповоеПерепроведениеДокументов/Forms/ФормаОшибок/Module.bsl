...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	// В ПерепроведениеДокументов() модуля менеджера обработки 
	// заполняется струткура с информацией об ошибках перепроведения 
	// с ключами:
	//	- ОтчетПоОшибкам - табличный документ
	//	- ТаблицаСообщенийПользователю - таблица значений с колонками 
	//		- КлючДанных - ссылка на документ
