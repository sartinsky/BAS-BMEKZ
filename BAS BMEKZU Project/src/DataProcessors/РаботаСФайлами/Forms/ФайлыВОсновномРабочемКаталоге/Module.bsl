...
Процедура УдалитьИзЛокальногоКэшаФайловВыполнить()
	...
	ТекстВопроса = НСтр("ru='Удалить выбранные файлы из рабочего каталога?';uk='Видалити вибрані файли з робочого каталогу?'");
	...
	Если ПараметрыВыполнения.ЕстьЗанятыеФайлы Тогда
		ПоказатьПредупреждение(,
			НСтр("ru='Нельзя удалять из рабочего каталога файлы,
                       ...
                       |;uk='Не можна видаляти з робочого каталогу файли,
