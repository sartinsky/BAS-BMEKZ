...
Процедура ПередЗакрытием(Отказ, ЗавершениеРаботы, ТекстПредупреждения, СтандартнаяОбработка)
	...
	Если ЗавершениеРаботы Тогда
		ТекстПредупреждения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru='Изменения в файле ""%1"" будут потеряны.';uk='Зміни у файлі ""%1"" будуть втрачені.'"), ИмяИРасширение);
		Возврат;
	КонецЕсли;
	...
	ТекстНапоминания = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		НСтр("ru='Файл ""%1"" был изменен.
            |Сохранить изменения?'
            |;uk='Файл ""%1"" був змінений.
            |Зберегти зміни?'"), 
		ИмяИРасширение);
	Кнопки = Новый СписокЗначений;
	Кнопки.Добавить("Сохранить", НСтр("ru='Сохранить';uk='Зберегти'"));
	Кнопки.Добавить("НеСохранять", НСтр("ru='Не сохранять';uk='Не зберігати'"));
	...
	ПараметрыНапоминания.Вставить("Заголовок", НСтр("ru='Внимание';uk='Увага'"));
...
Процедура СохранитьКак(Команда)
	...
	Если ВыборФайла.Выбрать() Тогда
		...
		ПоказатьОповещениеПользователя(НСтр("ru='Файл успешно сохранен';uk='Файл успішно збережений'"), , ВыбранноеПолноеИмяФайла);
...
#Если ВебКлиент Тогда
	ПоказатьПредупреждение(, НСтр("ru='Сравнение версий файлов в веб-клиенте недоступно.';uk='Порівняння версій файлів у веб-клієнті недоступно.'"));
	Возврат;
#ИначеЕсли МобильныйКлиент Тогда
	ПоказатьПредупреждение(, НСтр("ru='Сравнение версий файлов в мобильном клиенте недоступно.';uk='Порівняння версій файлів на мобільному клієнті недоступне.'"));
	Возврат;
#Иначе
