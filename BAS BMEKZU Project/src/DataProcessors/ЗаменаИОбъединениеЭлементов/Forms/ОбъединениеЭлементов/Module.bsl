...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ШагПоиск.КнопкаОтмена.Заголовок = НСтр("ru='Прервать';uk='Перервати'");
	ШагПоиск.КнопкаОтмена.Подсказка = НСтр("ru='Отказаться от объединения элементов';uk='Відмовитися від об''єднання елементів'");
	...
	Шаг.КнопкаДалее.Заголовок = НСтр("ru='Объединить >';uk='Об''єднати >'");
	Шаг.КнопкаДалее.Подсказка = НСтр("ru='Начать объединение элементов';uk='Почати об''єднання елементів'");
	Шаг.КнопкаОтмена.Заголовок = НСтр("ru='Отмена';uk='Відмінити'");
	Шаг.КнопкаОтмена.Подсказка = НСтр("ru='Отказаться от объединения элементов';uk='Відмовитися від об''єднання елементів'");
	...
	Шаг.КнопкаОтмена.Подсказка = НСтр("ru='Прервать объединение элементов';uk='Перервати об''єднання елементів'");
	...
	Шаг.КнопкаОтмена.Подсказка = НСтр("ru='Закрыть результаты объединения';uk='Закрити результати об''єднання'");
	
	// 5. Проблемы замены ссылок.
	Шаг = ДобавитьШагМастера(Элементы.ШагПовторОбъединения);
	Шаг.КнопкаНазад.Заголовок = НСтр("ru='< В начало';uk='< На початок'");
	Шаг.КнопкаНазад.Подсказка = НСтр("ru='Вернутся к выбору основного элемента';uk='Повернутися до вибору основного елемента'");
	Шаг.КнопкаДалее.КнопкаПоУмолчанию = Истина;
	Шаг.КнопкаДалее.Заголовок = НСтр("ru='Повторить';uk='Повторити'");
	Шаг.КнопкаДалее.Подсказка = НСтр("ru='Повторить объединение';uk='Повторити об''єднання'");
	Шаг.КнопкаОтмена.Заголовок = НСтр("ru='Отмена';uk='Відмінити'");
	Шаг.КнопкаОтмена.Подсказка = НСтр("ru='Закрыть результаты объединения';uk='Закрити результати об''єднання'");
		...
		Если Не ПустаяСтрока(ТекстОшибки) Тогда
			СтандартныеПодсистемыКлиент.ПоказатьВопросПользователю(Неопределено, 
				СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='Невозможно объединить элементы по причине:
                    |%1'
                    |;uk='Неможливо об''єднати елементи з причини:
...
Функция СообщениеОЗавершении()
	Возврат СтроковыеФункцииКлиентСервер.СтрокаСЧисломДляЛюбогоЯзыка(
		НСтр("ru=';%1 элемент объединен в:;;%1 элемента объединено в:;%1 элементов объединено в:;%1 элемента объединено в:';uk=';%1 елемент об''єднаний в:;;%1 елементи об''єднано у:;%1 елементів об''єднано у:;%1 елементи об''єднано в:'"),
...
Функция ЗапуститьФоновоеЗадание()
	...
	ИначеЕсли ТекущаяСтраница = Элементы.ШагОбъединение Тогда
		...
		ПараметрыМетода.Параметры.Вставить("ЗаменаПарыВТранзакции", Ложь);
...
Процедура ПослеЗавершенияФоновогоЗадания(Задание, ДополнительныеПараметры) Экспорт
	...
	Если Задание.Статус <> "Выполнено" Тогда
		Кратко = НСтр("ru='При замене элементов возникла ошибка:';uk='При заміні елементів виникла помилка:'") + Символы.ПС + Задание.КраткоеПредставлениеОшибки;
...
Процедура ЗаполнитьМестаИспользования(Знач АдресРезультата)
	...
	Заголовок = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='Объединение элементов %1 в один';uk='Об''єднання елементів %1 в один'"), Представление);
КонецПроцедуры
