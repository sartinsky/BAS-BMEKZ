...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ШагВыбор.КнопкаДалее.Заголовок = НСтр("ru='Заменить >';uk='Замінити >'");
	ШагВыбор.КнопкаДалее.Подсказка = НСтр("ru='Начать замену элементов';uk='Почата заміна елементів'");
	ШагВыбор.КнопкаОтмена.Заголовок = НСтр("ru='Отмена';uk='Відмінити'");
	ШагВыбор.КнопкаОтмена.Подсказка = НСтр("ru='Отказаться от замены элементов';uk='Відмовитися від заміни елементів'");
	...
	Шаг.КнопкаОтмена.Подсказка = НСтр("ru='Прервать замену элементов';uk='Перервати заміну елементів'");
	
	// 3. Проблемы замены ссылок.
	Шаг = ДобавитьШагМастера(Элементы.ШагПовторЗамены);
	Шаг.КнопкаНазад.Заголовок = НСтр("ru='< Назад';uk='< Назад'");
	Шаг.КнопкаНазад.Подсказка = НСтр("ru='Вернутся к выбору целевого элемента';uk='Повернутися до вибору цільового елемента'");
	Шаг.КнопкаДалее.Заголовок = НСтр("ru='Повторить замену >';uk='Повторити заміну >'");
	Шаг.КнопкаДалее.Подсказка = НСтр("ru='Повторить замену элементов';uk='Повторити заміну елементів'");
	Шаг.КнопкаОтмена.Заголовок = НСтр("ru='Закрыть';uk='Закрити'");
	Шаг.КнопкаОтмена.Подсказка = НСтр("ru='Закрыть результаты замены элементов';uk='Закрити результати заміни елементів'");
...
Функция ЗапуститьФоновоеЗадание(Знач ПараметрыМетода, Знач УникальныйИдентификатор)
	...
	НастройкиЗапуска.НаименованиеФоновогоЗадания = НСтр("ru='Поиск и удаление дублей: Замена ссылок';uk='Пошук і вилучення дублів: Заміна посилань'");
