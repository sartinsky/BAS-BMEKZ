...
Процедура ПриОткрытии(Отказ)
	...
	Если Не ОбщегоНазначенияКлиентСервер.ЭтоWindowsКлиент() Тогда
		Отказ = Истина;
		ТекстСообщения = НСтр("ru='Резервное копирование поддерживается только в клиенте под управлением ОС Windows.';uk='Резервне копіювання підтримується тільки в клієнта під управлінням ОС Windows.'");
