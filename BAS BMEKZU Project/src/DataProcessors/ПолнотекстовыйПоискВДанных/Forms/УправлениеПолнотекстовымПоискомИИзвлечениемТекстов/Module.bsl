...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("СтандартныеПодсистемы.РаботаСФайлами")
	   И Пользователи.ЭтоПолноправныйПользователь() Тогда
		...
		Элементы.ГруппаАвтоматическоеИзвлечениеТекстов.Видимость =
			...
			И НЕ ОбщегоНазначенияКлиентСервер.ЭтоМобильныйКлиент();
	...
	Если Элементы.ГруппаАвтоматическоеИзвлечениеТекстов.Видимость Тогда
		...
		Если ОбщегоНазначения.ИнформационнаяБазаФайловая() Тогда
			...
			СписокВыбора[0].Представление = НСтр("ru='Одна или несколько рабочих станций работают под управлением ОС Linux';uk='Одна або декілька робочих станцій, що працюють під управлінням ОС Linux'");
		КонецЕсли;
...
Процедура ОбновитьИндекс(Команда)
	...
	ПоказатьОповещениеПользователя(НСтр("ru='Полнотекстовый поиск';uk='Повнотекстовий пошук'"),, НСтр("ru='Индекс успешно обновлен';uk='Індекс успішно оновлений'"));
КонецПроцедуры

&НаКлиенте
Процедура ОчиститьИндекс(Команда)
	ОчиститьИндексСервер();
	ПоказатьОповещениеПользователя(НСтр("ru='Полнотекстовый поиск';uk='Повнотекстовий пошук'"),, НСтр("ru='Индекс успешно очищен';uk='Індекс успішно очищений'"));
КонецПроцедуры
...
Процедура ПроверитьИндекс(Команда)
	...
	ПоказатьОповещениеПользователя(НСтр("ru='Полнотекстовый поиск';uk='Повнотекстовий пошук'"),, НСтр("ru='Индекс содержит корректные данные';uk='Індекс містить коректні дані'"));
КонецПроцедуры
