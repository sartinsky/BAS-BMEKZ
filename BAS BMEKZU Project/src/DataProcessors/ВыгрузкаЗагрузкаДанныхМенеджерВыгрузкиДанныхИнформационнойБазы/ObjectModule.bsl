...
Процедура ВыгрузитьДанныеОбъектаМетаданных()
	...
	ЗаписьЖурналаРегистрации(
		НСтр("ru='ВыгрузкаЗагрузкаДанных.ВыгрузкаОбъектаМетаданных';uk='ВыгрузкаЗагрузкаДанных.ВыгрузкаОбъектаМетаданных'",ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
		УровеньЖурналаРегистрации.Информация,
		ТекущийОбъектМетаданных,
		,
		СтрШаблон(НСтр("ru='Начало выгрузки данных объекта метаданных: %1';uk='Початок вивантаження даних об''єкта метаданих: %1'",ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
	...
	ЗаписьЖурналаРегистрации(
        ...
        |;uk='Закінчення вивантаження даних об''єкта метаданих: %1
        |Вивантажено об''єктів: %2'",ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
