	...
	Для Каждого ОбъектМетаданных Из ВыгружаемыеТипы Цикл
		...
		Если ИсключаемыеТипы.Найти(ОбъектМетаданных) <> Неопределено Тогда
			...
			ЗаписьЖурналаРегистрации(
				НСтр("ru='ВыгрузкаЗагрузкаДанных.ВыгрузкаОбъектаПропущена';uk='ВыгрузкаЗагрузкаДанных.ВыгрузкаОбъектаПропущена'",ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
