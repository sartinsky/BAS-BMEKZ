...
Процедура Сохранить(Команда)
	...
	Результат.ТекстОшибки = НСтр("ru='Не удалось сохранить отсканированный файл.';uk='Не вдалося зберегти відсканований файл.'");
	ПринятьЗавершение(Результат, ПараметрыВыполнения);
КонецПроцедуры
		...
		Если КоличествоОшибок = 1 Тогда
			ТекстПредупреждения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru='Не удалось сохранить файл по причине:
                    |%1'
                    |;uk='Не вдалося зберегти файл з причини:
                    |%1'"),
				ПолныйТекстВсехОшибок);
		Иначе
			ТекстПредупреждения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru='Не удалось сохранить некоторые файлы (%1):
                    |%2'
                    |;uk='Не вдалося зберегти деякі файли (%1):
                    |%2'"),
