...
Процедура ПриПолученииНастроек(Настройки) Экспорт
	...
	Настройки.ИмяКонфигурацииПриемника.Вставить("УправлениеТорговымПредприятиемДляУкраины");
...
Процедура ПриПолученииОписанияВариантаНастройки(ОписаниеВарианта, ИдентификаторНастройки, ПараметрыКонтекста) Экспорт
	...
	ОписаниеВарианта.ИмяФайлаНастроекДляПриемника = "Настройки обмена для BAS БЭМКЗ-УТП";
	...
	ОписаниеВарианта.ЗаголовокКомандыДляСозданияНовогоОбменаДанными = "BAS AGRO. Accounting of Elevator, Mill and Feed mill, edition 2.1 --> УТП ред. 1.2(рахунки/накладні)";
	ОписаниеВарианта.ОбщиеДанныеУзлов = ОбщиеДанныеУзлов();
	ОписаниеВарианта.ПутьКФайлуКомплектаПравилВКаталогеШаблонов = "";
	
	ОписаниеВарианта.ИмяКонфигурацииКорреспондента = "УправлениеТорговымПредприятиемДляУкраины";
	ОписаниеВарианта.ЗаголовокКомандыДляСозданияНовогоОбменаДанными = "BAS AGRO. Accounting of Elevator, Mill and Feed mill, edition 2.1 --> УТП ред. 1.2(рахунки/накладні)";
	ОписаниеВарианта.ЗаголовокПомощникаСозданияОбмена =               НСтр("ru='Настройка синхронизации с программой ""УТП ред. 1.2"" документами счета/накладные';uk='Настройка синхронізації з програмою ""УТП ред. 1.2"" документами рахунки/накладні'");
	ОписаниеВарианта.ЗаголовокУзлаПланаОбмена =                       НСтр("ru='Настройка синхронизации с программой ""УТП ред. 1.2"" документами счета/накладные';uk='Настройка синхронізації з програмою ""УТП ред. 1.2"" документами рахунки/накладні'");
	ОписаниеВарианта.НаименованиеКонфигурацииКорреспондента =         "Управление торговым предприятием для Украины";
...
Функция ПодробнаяИнформацияПоОбмену(ИдентификаторНастройки) Экспорт
	...
	Иначе
		ПутьКИнформацииПоОбмену = "ПланОбмена.СМС_Обмен_СчетаРасходные_ПоОрганизации.Форма.ПодробнаяИнформация";
	КонецЕсли;
