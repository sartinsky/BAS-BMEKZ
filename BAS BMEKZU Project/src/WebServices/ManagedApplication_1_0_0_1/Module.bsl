	...
	Попытка
		...
		Если ОбщегоНазначенияПовтИсп.РазделениеВключено() Тогда
			...
			Если ОбщегоНазначенияПовтИсп.ДоступноИспользованиеРазделенныхДанных() Тогда
				...
				ВызватьИсключение НСтр("ru='Операция не может быть вызвана в сеансе, который запущен с указанием разделителей. Проверьте правильность публикации веб-сервиса!';uk='Операція не може бути викликана у сеансі, який запущений із зазначенням роздільників. Перевірте правильність публікації веб-сервісу!'");
			...
			Иначе
				...
				Если КлючОбластиДанных <> Константы.КлючОбластиДанных.Получить() Тогда
					ВызватьИсключение НСтр("ru='Некорректный ключ области данных!';uk='Некоректний ключ області даних!'");
				КонецЕсли;
		...
		Иначе
			ВызватьИсключение НСтр("ru='Операция не может быть выполнена для информационной базы, в которой отключено разделение по областям данных!';uk='Операція не може бути виконана для інформаційної бази, в якій відключено поділ по областях даних!'");
		КонецЕсли;
