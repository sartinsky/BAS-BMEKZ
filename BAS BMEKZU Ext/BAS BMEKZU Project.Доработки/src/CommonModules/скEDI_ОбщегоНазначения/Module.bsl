...
&Вместо("ОтправитьКвитанцииFreeПоЭлектроннымДокументам")
...
&Вместо("ПодписатьОтправитьFreeЭлектронныеДокументыСервер")
...
&Вместо("ОтправитьКвитанцииПоЭлектроннымДокументам")
...
&Вместо("ОтправитьЭлектронныеДокументыКвитанцииПовторно")
...
&Вместо("ОтправитьЭлектронныеДокументы")
...
&Вместо("ПолучитьТаблицуНеобходимыхПодписейДляДокумента")
Функция СМС_ПолучитьТаблицуНеобходимыхПодписейДляДокумента(ТаблицаНакладываемыхНаДокументПодписей, ДанныеПодписываемогоДокумента, ПодписиПолученыИзЭлектронногоДокумента, ОшибкаПолученияПодписей)
	
	Если ЗначениеЗаполнено(ДанныеПодписываемогоДокумента.ЭлектронныйДокумент) Тогда
		Запрос = Новый Запрос;
		Запрос.Текст =
		"ВЫБРАТЬ
